...
`.trim());const c=`${a}${n}${o}${l}`,h=c!==""?`<div class="msg-footer">${c}</div>`:"",u=document.createElement("div");u.id=this.parentName,u.innerHTML=`
        ...
        `.trim(),this.applyCss(),document.body.appendChild(u),this.AuthVisible&&(document.getElementById(this.authName1).focus(),this.authText="",window.addEventListener("keydown",this.onWindowKeyboard))}applyCss(){const e=`${this.parentName}-style`;if(document.getElementById(e))return;const t=document.createElement("style");t.id=e,t.textContent=`
...
`.trim()}}class Wt{constructor(){this.htmlMaker=new v,this.table=new W,this.gridElem=null,this.headerElem=null,this.footerElem=null}makeKeyCell(e,t,s){const i=new kt;return i.typeInfo.setLabel(e,!1),i.className=t,i.typeInfo.toolTip=s,i}makePair(){return new Map}setPair(e){if(e.size===0)return!1;this.table.makeDim(2,e.size),e.forEach((s,i)=>{this.table.growCell(1,s.items.length)});let t=-1;return e.forEach((s,i)=>{t++,this.table.getCell(0,t).typeInfo.setLabel(i.typeInfo.using.label,!1),this.table.getCell(0,t).className=i.className;let n=-1;for(const o of s.items)n++,this.table.getCell(1,t,n).typeInfo=o.typeInfo,this.table.getCell(1,t,n).className=o.className}),!0}setListener(e,t,s,i="",n=""){this.dispose(),this.table.makeRowTemplate(t);const o=document.getElementById(s);if(o===null)return console.log(`[setListener] cannot found ${s}`),!1;const l=this.table.ToScrollHTML(e,e),a=new V;a.props.name="",a.props.id=e,a.props.className=e,a.props.option.setTable(l),a.props.option.onSelect=async h=>{console.log(`classify = ${h.classify} targetId = ${h.targetId}`),this.onSelect!==void 0&&await this.onSelect(h)},this.htmlMaker=new v,this.htmlMaker.add(a);const r=this.htmlMaker.ToHTML();let c=document.createElement("div");return c.className=e,c.innerHTML=r,this.gridElem=c.children[0],i!==""&&(this.headerElem=document.createElement("div"),this.headerElem.className=i,this.headerElem.id=i,o.appendChild(this.headerElem)),o.appendChild(this.gridElem),c.remove(),c=null,n!==""&&(this.footerElem=document.createElement("div"),this.footerElem.className=n,this.footerElem.id=n,o.appendChild(this.footerElem)),!0}getSelectedRow(){return this.table.getSelectedRow()}enableEvents(e){return this.gridElem===null?!1:(this.htmlMaker.enableTableEvents(this.gridElem.className),this.onSelect=e,!0)}disableEvents(){return this.gridElem===null?!1:(this.htmlMaker.disableTableEvents(this.gridElem.className),!0)}setVisible(e){return this.gridElem===null?!1:(this.gridElem.hidden=!e,!0)}dispose(){this.headerElem!==null&&(this.headerElem.parentElement?.removeChild(this.headerElem),this.headerElem.remove()),this.footerElem!==null&&(this.footerElem.parentElement?.removeChild(this.footerElem),this.footerElem.remove()),this.gridElem!==null&&(this.gridElem.parentElement?.removeChild(this.gridElem),this.gridElem.remove()),this.disableEvents(),this.headerElem=null,this.footerElem=null,this.gridElem=null}getCssText(e,t,s){return this.table.getCssText(e,t,s)}}class lt{constructor(){this.ctlName="",this.ovElem=null}firstAction(e,t){const s=document.getElementById(t);return s===null?(console.log(`[firstAction] cannot found ${t}`),null):(this.createOverlay(s),this.ctlName=e,s)}createOverlay(e){const t=document.createElement("div");t.id=`${this.ovCssName()}`,t.style.position="absolute",t.style.inset="0",t.style.zIndex=this.zIndexOv(),t.style.background="transparent",t.style.background="rgba(0,0,0,0.1)",e.appendChild(t),this.ovElem=t}getBaseElem(){return this.ovElem!==null?this.ovElem.parentElement:null}getOuterCssText(){return`
.${this.ctlName} {
  position: absolute;
  inset: auto;
...
width: 100%;
        ...
        `.trim(),document.head.appendChild(t)}enableEvents(e,t,s){return this.ctlElem===null?!1:(this.htmlMaker.enableTableEvents(this.ctlElem.className),this.onApply=e,this.onUp=t,this.onDown=s,!0)}disableEvents(){return this.ctlElem===null?!1:(this.htmlMaker.disableTableEvents(this.ctlElem.className),!0)}setVisible(e){return this.ctlElem===null?!1:(this.ctlElem.hidden=!e,!0)}dispose(){super.dispose(),this.ctlElem!==null&&(this.ctlElem.parentElement?.removeChild(this.ctlElem),this.ctlElem.remove()),this.disableEvents(),this.ctlElem=null}updateValueElemByKeyValue(e){if(this.ctlElem===null)return;let t="";const s=e.split(this.delimiter);s.length>=2&&(t=s[0]),this.updateValueElemByText(t)}updateValueElemByText(e){if(this.ctlElem===null)return;const t=this.ctlElem.querySelectorAll(`.${this.valCssName()}`);t!==null&&(t[0].textContent=e)}tblCssName(){return`${this.ctlName}-tbl`}upCssName(){return`${this.ctlName}-upBtn`}dwCssName(){return`${this.ctlName}-dwBtn`}valCssName(){return`${this.ctlName}-values`}}class We{constructor(){this.key="",this.text=""}}class Yt extends lt{constructor(){super(...arguments),this.callerName="",this.htmlMaker=new v,this.table=new W,this.ctlElem=null}setChoiceItems(e){this.items=e}setListener(e,t,s){if(this.items===void 0)return!1;this.dispose(),this.callerName=s,this.ctlName=e;const i=this.items.length,n=new W;n.makeDim(1,i);let o=0;for(const f of this.items)n.getCell(0,o).typeInfo.setButton(`${f.text}`),n.getCell(0,o).className=`${e}-${f.key}`,n.getCell(0,o).typeInfo.using.itemId=o,o++;const l=this.firstAction(e,t);if(l===null)return!1;const a=n.ToScrollHTML(e,e),r=new V;r.props.name="",r.props.id=this.tblCssName(),r.props.className=this.tblCssName(),r.props.option.setTable(a),r.props.option.onSelect=async f=>{if(console.log(`classify = ${f.classify} targetId = ${f.targetId}`),this.onSelect!==void 0){const $=parseInt(f.targetId),k=new Ne;k.callerName=this.callerName,k.result=0<=$&&$<this.items.length?this.items[$].key:"",await this.onSelect(k)}},this.htmlMaker=new v,this.htmlMaker.add(r);const c=this.htmlMaker.ToHTML();let h=document.createElement("dialog");h.className=e,h.innerHTML=c,this.ctlElem=h;let u=h.children[0],d=u.children[0];return d.className=`${this.tblCssName()}`,d.id=`${this.tblCssName()}`,this.ctlElem.appendChild(d),u.remove(),u=null,l.appendChild(this.ctlElem),this.table=n,!0}show(e,t){this.ctlElem!==null&&(this.ctlElem.style.left=`${e}px`,this.ctlElem.style.top=`${t}px`,this.ctlElem.show())}applyCss(){const e=`${this.getBaseElem().className}-updn-style`;if(document.getElementById(e))return;const t=document.createElement("style");t.id=e,t.textContent=`
${this.getOuterCssText()}
.${this.tblCssName()} {
  ${this.getBaseCssText()}
}
...
width: 100%;
        ...
        `.trim(),document.head.appendChild(t)}enableEvents(e){return this.ctlElem===null?!1:(this.htmlMaker.enableTableEvents(this.ctlElem.className),this.onSelect=e,!0)}disableEvents(){return this.ctlElem===null?!1:(this.htmlMaker.disableTableEvents(this.ctlElem.className),!0)}setVisible(e){return this.ctlElem===null?!1:(this.ctlElem.hidden=!e,!0)}dispose(){super.dispose(),this.ctlElem!==null&&(this.ctlElem.parentElement?.removeChild(this.ctlElem),this.ctlElem.remove()),this.disableEvents(),this.ctlElem=null}tblCssName(){return`${this.ctlName}-tbl`}}class Xt{constructor(){this.key="",this.text=""}}class Qt extends lt{constructor(){super(...arguments),this.callerName="",this.htmlMaker=new v,this.table=new W,this.ctlElem=null,this.headerElem=null,this.footerElem=null}setGridtems(e){this.items=e}setListener(e,t,s,i="",n=""){if(this.items===void 0)return!1;this.dispose(),this.callerName=s,this.ctlName=e;const o=this.items.length,l=new W;l.makeDim(2,o);let a=0;for(const R of this.items)l.getCell(0,a).typeInfo.setLabel(`${R.text}`,!1),l.getCell(0,a).className=this.keyCssName(),l.getCell(0,a).typeInfo.using.itemId=a,l.getCell(1,a).typeInfo=R.value.items[0].typeInfo,l.getCell(1,a).className=this.valueCssName(),l.getCell(1,a).typeInfo.using.itemId=a,a++;const r=this.firstAction(e,t);if(r===null)return!1;const c=l.ToScrollHTML(e,this.tblCssName()),h=new V;h.props.name="",h.props.id=this.tblCssName(),h.props.className=this.tblCssName(),h.props.option.setTable(c),h.props.option.onSelect=async R=>{if(this.onSelect!==void 0){const A=new Ne;A.callerName=R.classify,A.result=R.selectedValue,await this.onSelect(A)}},this.htmlMaker=new v,this.htmlMaker.add(h);const u=this.htmlMaker.ToHTML();let d=document.createElement("dialog");d.className=e,d.innerHTML=u,this.ctlElem=d;let f=d.children[0];const $=this.divCssName();f.className=$,f.id=$;let k=f.children[0];return k.className=`${this.tblCssName()}`,k.id=`${this.tblCssName()}`,i!==""&&(this.headerElem=document.createElement("div"),this.headerElem.className=i,this.headerElem.id=i,d.appendChild(this.headerElem)),r.appendChild(this.ctlElem),n!==""&&(this.footerElem=document.createElement("div"),this.footerElem.className=n,this.footerElem.id=n,d.appendChild(this.footerElem)),this.table=l,!0}show(e,t){this.ctlElem!==null&&(this.ctlElem.style.left=`${e}px`,this.ctlElem.style.top=`${t}px`,this.ctlElem.show())}setFontConfig(e="0.9"){this.table.setFontConfig(e)}applyCss(){const e=`${this.getBaseElem().className}-flgrd-style`;if(document.getElementById(e))return;const t=document.createElement("style");t.id=e,t.textContent=`
${this.getOuterCssText()}
...
width: 100%;
        ...
        `.trim(),document.head.appendChild(t)}enableEvents(e){return this.ctlElem===null?!1:(this.htmlMaker.enableTableEvents(this.ctlElem.className),this.onSelect=e,!0)}disableEvents(){return this.ctlElem===null?!1:(this.htmlMaker.disableTableEvents(this.ctlElem.className),!0)}setVisible(e){return this.ctlElem===null?!1:(this.ctlElem.hidden=!e,!0)}dispose(){super.dispose(),this.headerElem!==null&&(this.headerElem.parentElement?.removeChild(this.headerElem),this.headerElem.remove()),this.footerElem!==null&&(this.footerElem.parentElement?.removeChild(this.footerElem),this.footerElem.remove()),this.ctlElem!==null&&(this.ctlElem.parentElement?.removeChild(this.ctlElem),this.ctlElem.remove()),this.disableEvents(),this.ctlElem=null}divCssName(){return`${this.ctlName}-div`}tblCssName(){return`${this.ctlName}-tbl`}keyCssName(){return`${this.ctlName}-key`}valueCssName(){return`${this.ctlName}-value`}}class _t{constructor(){this.itemType=x.Img,this.itemId=-1,this.label="",this.innerHTML=""}}class St{constructor(){this.toolTip="",this.using=new _t}setButton(e){this.using.itemType=x.Btn,this.using.label=e}setLabel(e,t){this.using.itemType=t?x.Label:x.LabelRO,this.using.label=e}setCombo(e){this.using.itemType=x.Combo,this.using.combo=e}setInput(e){this.using.itemType=x.Input,this.using.input=e}setImg(e){this.using.itemType=x.Img,this.using.img=e}setPlain(e){this.using.itemType=x.Plain,this.using.innerHTML=e}setTable(e){this.using.itemType=x.Table,this.using.innerHTML=e}ToButtonHTML(e){const t=this.using.itemId>=0?` item-id="${this.using.itemId}"`:"";return`
...
`.trim(),document.head.appendChild(o);const l=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,l)}}class se{constructor(){this.ns=H.None,this.id=0,this.name="",this.contentURL="",this.iconURL=""}static toJsonText(e){const t=se.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new se;return t.ns=e.ns,t.id=e.id,t.name=e.name,t.contentURL=e.contentURL,t.iconURL=e.iconURL,t}static fromJsonInst(e){const t=new le;return t.ns=e.ns,t.id=e.id,t.name=e.name,t.contentURL=e.contentURL,t.iconURL=e.iconURL,t}}class Te{constructor(){this.title="",this.key="",this.selectionPair=[],this.selectedVal="",this.initScoreVal=0,this.mulScoreVal=0,this.available=!1}get stdScore(){const e=this.selectedVal.length>=1?this.selectedVal:"1",t=parseInt(e);return this.initScoreVal+t*this.mulScoreVal}get selectedText(){if(this.selectionPair.length!==0&&this.selectedVal!=="")for(const e of this.selectionPair){const t=e.split("/");if(t[1]===this.selectedVal)return t[0]}}}class F{constructor(){this.items=new Array,this.allow=new Map,this.roleText="",this.comboText=""}makeDemoLvText(e){let t="";for(let s=1;s<=100;s++)t+=`"${e}${s}/${s}",`;return t=t.substring(0,t.length-1),t}load(){const e=this.makeDemoLvText("Lv"),t=this.makeDemoLvText("Lv"),s=this.makeDemoLvText(""),i=`
[
    {
        "title": "Ch.Lv",
        "key": "chLvId",
...
${this.htmlMaker.MakeDefaultButtonsCss()}
`.trim(),document.head.appendChild(s);const i=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,i)}}const ie={None:"None",Add:"Add",Delete:"Delete",Update:"Update"};class vt{constructor(){this.logType=ie.None}}class Ze extends vt{constructor(){super(...arguments),this.inst=new Array}static toJsonText(e){return JSON.stringify(e,null,2)}static fromJsonText(e){return JSON.parse(e)}}class et extends vt{constructor(){super(...arguments),this.gameType=z.none,this.inst=new Array}static toJsonText(e){return JSON.stringify(e,null,2)}static fromJsonText(e){return JSON.parse(e)}}class Je{constructor(){this.fileNames=null,this.minMap=new Map,this.maxMap=new Map,this.rangeMap=new Map,this.digLenMax=0,this.nMul=0,this.table=[{key:w.pqStatusHP,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,120)}},{key:w.pqStatusATK,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,120)}},{key:w.pqStatusREC,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,120)}},{key:w.pqTokkunHP,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,5)}},{key:w.pqTokkunATK,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,5)}},{key:w.pqTokkunREC,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,5)}},{key:w.pqTokuSp1,scoreFunc:(e,t)=>this.scoreFunc(this.puyoToku(t),10)},{key:w.pqTokuSp2,scoreFunc:(e,t)=>this.scoreFunc(this.puyoToku(t),10)},{key:w.mmStatusFGT,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusATK,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusPDF,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusACC,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusEVA,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusCRI,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusMDF,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusHP,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusCRD,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusDEF,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmStatusSPD,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmAbilityDEX,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmAbilityMGC,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmAbilityDUR,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}},{key:w.mmRole,scoreFunc:(e,t)=>{const s=this.toScoreMaxNum(e,t);return this.scoreFunc(s,240)}}],this.rolePriolity=[{roleKey:Le.RlAttacker,priority:He.priHi,statusKey:[w.mmAbilitySTR,w.mmStatusATK,w.mmStatusSPD]},{roleKey:Le.RlHealer,priority:He.priHi,statusKey:[w.mmAbilityMGC,w.mmStatusMDF,w.mmStatusHP]},{roleKey:Le.RlDebuffer,priority:He.priHi,statusKey:[w.mmAbilityDEX,w.mmStatusACC,w.mmStatusHP]},{roleKey:Le.RlBuffer,priority:He.priHi,statusKey:[w.mmStatusPDF,w.mmStatusHP,w.mmStatusDEF]}]}async loadDB(e){const t=new Se,s=await t.loadBinFile(e);if(t.isWebRunning)this.zip=await window.JSZip.loadAsync(s);else{const{loadZipNode:i}=await import(t.nodeToolsImportFilename);this.zip=await i(s)}return this.fileNames=Object.keys(this.zip.files),!0}async enumStatus(e){if(this.fileNames!==null)for(const t of this.fileNames){const s=await this.getFileContent(t);if(s===null||e===void 0)continue;if(!e(t,s))break}}async debugCombo(){await this.enumStatus((e,t)=>{for(const s of t)s.useCombo&&console.log(`${e}:[${s.value}]`);return!0})}async loadAuxScoreSet(e){const t=new Mt;await t.load(ae.ScoreUI,e);const s=new F;for(const i of t.itemList){const n=i.scItem;if(!i.isScoreAvail)continue;const o=new Te;switch(o.title=n.text,o.key=n.key,o.available=!1,n.selectType){case fe.Sequence:const l=this.auxScoreTextToValue(n.start),a=this.auxScoreTextToValue(n.end),r=this.auxScoreTextToValue(n.step),c=new Array;for(let d=l;d<=a;d+=r)c.push(`${d}/${d}`);o.selectionPair=c,o.selectedVal=`${l}`,o.initScoreVal=l,o.mulScoreVal=r,c.length>=1&&(o.available=!1);break;case fe.Text:const h=n.keyValue.split(",");let u="";for(const d of h){const f=d.split("/");if(f.length>=2){u=f[1];break}}o.selectionPair=h,o.selectedVal=u,o.initScoreVal=0,o.mulScoreVal=0,h.length>=1&&(o.available=!1);break}s.items.push(o)}return console.log(s),s}auxScoreTextToValue(e){const t=e.split("/"),s=t.length===1?t[0]:t[1];return parseInt(s)}async getMinMax(){await this.enumStatus((e,t)=>{for(const s of t){if(s.useCombo)continue;let i=parseInt(this.itemValue(s));if(!this.minMap.has(s.key))this.minMap.set(s.key,i);else{const n=this.minMap.get(s.key);n===void 0?this.minMap.set(s.key,i):n>i&&this.minMap.set(s.key,i)}if(!this.maxMap.has(s.key))this.maxMap.set(s.key,i);else{const n=this.maxMap.get(s.key);n===void 0?this.maxMap.set(s.key,i):n<i&&this.maxMap.set(s.key,i)}}return!0})}async getRanges(){await this.getMinMax(),this.digLenMax=0;for(const[e,t]of this.minMap){const s=t,i=this.maxMap.get(e);let n=0;if(s!==void 0&&i!==void 0&&(n=i-s),n<=0&&(n=1),this.rangeMap.set(e,n),i!==void 0){const o=Math.log10(i);o>this.digLenMax&&(this.digLenMax=o)}}this.nMul=this.digLenMax>0?Math.pow(10,Math.ceil(this.digLenMax)):1;for(const[e,t]of this.minMap)console.log(`[${e}] = ${this.minMap.get(e)},${this.maxMap.get(e)} ${this.rangeMap.get(e)}`);console.log(`digLenMax=[${this.digLenMax}] nMul=[${this.nMul}]`)}stdBy(e,t){let s,i;if(this.rangeMap.has(e)&&(s=this.rangeMap.get(e)),this.minMap.has(e)&&(i=this.minMap.get(e)),s===void 0||i===void 0||this.isNumeric(t)===!1)return null;s<=0&&(s=1);const n=(parseInt(t)-i)*s;return this.nMul*n}getFilename(e){let t=null;for(let s of this.fileNames){let i=s.indexOf("_");if(i>=0){let n=s.substring(i+1);if(i=n.indexOf("."),i>=0&&(n=n.substring(0,i)),n===e){t=s;break}}}return t}async getFileContent(e){if(e===null)return null;const t=this.zip.file(e);if(t){const s=await t.async("string");return JSON.parse(s)}return null}async getStatus(e){this.digLenMax===0&&await this.getRanges();const t=this.getFilename(e);if(t===null)return null;const s=await this.getFileContent(t);if(s===null)return null;let i=null;for(const o of s)if(!o.useCombo){for(const l of this.rolePriolity)if(l.statusKey.find(r=>r===o.key)){i=l,console.log(`find role : ${i.roleKey}`);break}if(i!==null)break}const n=new F;if(i!==null)for(const o of s){if(o.useCombo)continue;if(i.statusKey.find(a=>a===o.key)){const a=this.table.find(r=>r.key===o.key);if(a){const r=a.scoreFunc(o.key,this.itemValue(o));r.title=o.disp,r.key=o.key,r.selectedVal="1",n.items.push(r)}}}else for(const o of s){if(o.useCombo)continue;const l=this.table.find(a=>a.key===o.key);if(l){const a=l.scoreFunc(o.key,this.itemValue(o));a.title=o.disp,a.key=o.key,a.selectedVal="1",n.items.push(a)}}return n}async getComboKeywords(e){let t=0;const s=new Map,i=new Map;for(const n of e){const o=this.getFilename(n);if(o===null)return null;const l=await this.getFileContent(o);if(l===null)return null;const a=new Map;for(const r of l){if(!r.useCombo)continue;const c=r.value.split(",");for(const h of c)if(a.has(h)===!1)a.set(h,1);else{const u=a.get(h);a.set(h,u+1)}}if(a.size===0){t=0,i.clear();continue}for(const[r,c]of a)if(i.has(r)===!1)i.set(r,c);else{const h=i.get(r);i.set(r,h+c)}if(t++,!(t<=2))for(const[r,c]of i)c>=3&&s.set(r,c)}}async debugCheckCombo(){const e=new Array;e.push("119599"),e.push("119603"),e.push("119624"),await this.getComboKeywords(e)}isNumeric(e){return e.trim()===""?!1:!isNaN(Number(e))}itemValue(e){return e.converted===""?e.value:e.converted}toScoreMaxNum(e,t){return this.isNumeric(t)===!1?null:Je.useStdConv?this.stdBy(e,t):t!==""?parseInt(t):1}scoreFunc(e,t){const s=new Te;if(e===null)return s;s.mulScoreVal=e/t;for(let i=1;i<=t;i++){const n=Math.ceil(e/t*i);s.selectionPair.push(`Lv${i}/${i}`),i===1&&(s.initScoreVal=n)}return s.available=!0,s}scoreFuncOld(e,t){const s=new Te;if(this.isNumeric(e)===!1)return s;let i=e!==""?parseInt(e):1;s.mulScoreVal=i/t;for(let n=1;n<=t;n++){const o=Math.ceil(i/t*n);s.selectionPair.push(`Lv${n}/${n}`),n===1&&(s.initScoreVal=o)}return s.available=!0,s}puyoToku(e){return e==="enable"?10:1}}Je.useStdConv=!1;const He={priHi:0},ee={None:"None",UI:"UI",Menu:"Menu"};class Y{constructor(){this.dockType=ee.None,this.iconFileName="",this.toolTip="",this.idAttributeForHTML=""}get labelWrap(){let e=this.toolTip,t=this.toolTip.length;if(t>3){const s=t%2===0?t/2:t/2+1,i=e.substring(0,s),n=e.substring(s);e=i+`
`+n}return e}setAsDlg(e,t){this.dockType=ee.UI,this.dlg=e,this.toolTip=t}setAsMenu(e){this.dockType=ee.Menu,this.toolTip=e}get isUIType(){return this.dockType==ee.UI}get isMenuType(){return this.dockType==ee.Menu}ToggleStatus(){this.dlg===void 0||this.dlg===null||(this.dlg.hidden=!this.dlg.hidden)}}class qe{constructor(){this.items=new Array,this.parentName="",this.listName="",this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new b().SaveSetting(e,!1)}}add(e){return e.dockType==ee.UI&&(e.dlgParent=e.dlg.parentElement),this.items.push(e),!0}async toHTML(e,t=null){if(!this.items)return"";this.listName=e,this.htmlMaker=new v;let s=0;for(const i of this.items){s++;const n=`dock-uid${s}`;i.idAttributeForHTML=n;const o=new V,l=i.labelWrap;o.props.name=this.itemCssClassName(),o.props.id=n,o.props.className=this.imgCssClassName(),o.props.option.toolTip=i.toolTip,o.props.option.setLabel(l,!0),o.props.option.onSelect=a=>{const r=this.items.find(c=>a.item.props.id===c.idAttributeForHTML);if(r&&(this.selectedItem=r,this.onApply!==void 0)){const c=new ns;c.item=this.selectedItem,this.onApply(c)}},this.htmlMaker.add(o)}return this.htmlMaker.MakeScrollableList(this.listCssClassName())}createDockBox(e,t,s=!0){this.parentName=e;const i=`<div class="${this.parentName}-dlg-content">
    ${t}
</div>`,n=new j;n.SetB3Type(we.Hide);const o=n.NewDialog(e,this.dlgCssClassName());return n.SetContent(e,i,s),this.applyCss(),n.EnableEventHandlers(),n.onMoveDone=this.moverOnMoveDone,o}addItemClickHandlers(e){this.onApply=e,this.htmlMaker.SelectByID(this.itemCssClassName(),this.htmlMaker.GetIdByIndex(0)),this.htmlMaker.enableEvents(this.itemCssClassName())}stdApplyAction(e){return e.item.dlgParent===null?(e.cancel=!0,!1):(console.log(`selected item = [${e.item.toolTip}::${e.item.dockType}]`),e.item.isUIType&&(new b().MoveHiestLayer(e.item.dlgParent),e.item.dlgParent.hidden&&(e.item.dlgParent.hidden=!1)),!0)}enableLazyImages(e){this.htmlMaker.initObserver(this.dlgCssClassName(),e)}applyCss(){const e=this.listCssClassName(),t=this.itemCssClassName(),s=this.imgCssClassName(),i=48,n=this.items.length,o=document.createElement("style");o.textContent=`
...
`.trim(),document.head.appendChild(o);const l=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,l)}itemCssClassName(){return`${this.listName}-item`}imgCssClassName(){return`${this.listName}-img`}listCssClassName(){return`${this.listName}-list`}dlgCssClassName(){return`${this.parentName}-dlg`}static GetDialogInfo(e){return j.GetDialogInfo(e)}static SetDialogInfo(e){return j.SetDialogInfo(e)}async InitZOrder(e){await e.ForEachAsync(t=>{const s=qe.GetDialogInfo(t),i=e.FindByName(t);return s!==null&&(s.zindex=i!==null?i.style.zIndex:""),console.log(s),!0})}}class ns{constructor(){this.cancel=!1}}class Ue{constructor(){this.dockType=ee.None,this.iconFileName="",this.toolTip="",this.dlgName="",this.hidden=!1,this.zIndex="",this.topPx="",this.leftPx=""}static toJsonText(e){const t=Ue.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new Ue;return t.dockType=e.dockType,t.iconFileName=e.iconFileName,t.toolTip=e.toolTip,e.isUIType&&(t.dlgName=e.dlgParent.id,t.hidden=typeof e.dlgParent.hidden=="string"?!1:e.dlgParent.hidden,t.zIndex=e.dlgParent.style.zIndex,t.leftPx=e.dlgParent.style.left,t.topPx=e.dlgParent.style.top),t}}class ze{static toJsonText(e){const t=ze.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new ze;t.items=new Array;for(const s of e.items)t.items.push(Ue.toJsonInst(s));return t}restore(e,t){for(const s of this.items){const i=e.items.find(n=>n.dlg.id===s.dlgName);i&&(i.dockType=s.dockType,i.iconFileName=s.iconFileName,i.toolTip=s.toolTip,i.isUIType&&(i.dlgParent.hidden=typeof s.hidden=="string"?!1:s.hidden,i.dlgParent.style.zIndex=s.zIndex,i.dlgParent.style.left=s.leftPx,i.dlgParent.style.top=s.topPx))}t.ReOrder()}}class os{convTitle(e){if(e.length<=8)return e;const t="スキル";return e.endsWith(t)?`${e.substring(0,e.length-t.length)}<br>${t}`:e}}let Ke=null;function Lt(){return Ke||(Ke=new os,console.log("ConvertTools instance created (Singleton)")),Ke}class Ye{constructor(){this.chUuid="",this.ch=new le}}class ls{constructor(){this.chList=new Array,this.uiInfo=new pe,this.parentName="",this.editingRowIndex=-1,this.scoreGrid=new Wt,this.gridHeaderName=`${this.dlgCssClassName()}-headerName`,this.gridFooterName=`${this.dlgCssClassName()}-footerName`,this.gridName=`${this.dlgCssClassName()}-gridName`,this.gridRowName=`${this.dlgCssClassName()}-gridRowName`,this.keyClassName=`${this.dlgCssClassName()}-keyClassName`,this.valueClassName=`${this.dlgCssClassName()}-valueClassName`,this.onSelect=async e=>{console.log(`classify = ${e.classify} selectedValue = ${e.selectedValue} targetId = ${e.targetId}`);const t=this.editingCh;if(t===null)return;const i=t.scoreSet.items.find(n=>n.key===e.classify);i&&(i.selectedVal=e.selectedValue)},this.savedScoreSet=new F,this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new b().SaveSetting(e)}}async load(){const t=await(await oe()).get(ue.CharSummaryAction);if(t===null)return;const s=new Map,i=new Array;this.usingLog(t,s,i),this.chList=new Array;for(const[n,o]of s){const l=Fe.fromJsonText(o.log),a=new le;a.ns=l.ch.ns,a.id=l.ch.id,a.name=l.ch.name,a.contentURL=l.ch.contentURL,a.iconURL=l.ch.iconURL,a.idAsText=l.ch.idAsText,a.idAttributeForHTML=l.ch.idAttributeForHTML;const r=new F;F.copy(l.scoreSet,r,!0);const c=new Ye;c.chUuid=l.chUuid,c.ch=a,c.scoreSet=r,this.chList.push(c)}}usingLog(e,t,s){for(const i of e){const n=Fe.fromJsonText(i.log);if(n.chUuid==="")continue;let o=!1,l=!1;switch(n.logType){case K.None:break;case K.Add:o=!0;break;case K.Update:t.has(n.chUuid)?o=!0:o=!1;break;case K.Delete:o=!0,l=!0;break}if(o)if(l){if(t.has(n.chUuid)){t.delete(n.chUuid);const a=t.get(n.chUuid);s.push(a)}}else{if(t.has(n.chUuid)){const a=t.get(n.chUuid);s.push(a),t.delete(n.chUuid)}t.set(n.chUuid,i)}}}sortByScore(){return this.chList.length===0?null:this.chList.sort((t,s)=>s.scoreSet.stdScore-t.scoreSet.stdScore)}async updateCharInfos(e){let t=this.table.firstRowIndex-1;for(const s of this.chList){t++;const i=await e.getImageUrlBy(s.ch.iconFileName,s.ch.ns);i!==null&&this.table.updateRowImage(t,i),this.updateChScoreInfo(t)}this.table.redimAllRows(),t=this.table.firstRowIndex,this.table.selectRow(t),this.table.scroll(t)}setRow(e,t,s){let i=0;const n=new it;n.imgFile=e.iconFileName,s.getCell(i,t).typeInfo.setImg(n),s.getCell(i,t).className=this.itemIconCssClassName();const o=`${e.name}`;s.getCell(i,t,1).typeInfo.setLabel(o,!1),s.getCell(i,t,1).className=this.itemStatusCssClassName(),i++,s.getCell(i,t).typeInfo.setButton("更新"),s.getCell(i,t).className=this.itemUpdateCssClassName(),s.getCell(i,t).typeInfo.using.itemId=t,s.getCell(i,t,1).typeInfo.setButton("削除"),s.getCell(i,t,1).className=this.itemDeleteCssClassName(),s.getCell(i,t,1).typeInfo.using.itemId=t}toHTML(){if(!this.chList)return"";const e=new W;if(this.chList.length>=1)e.makeDim(2,this.chList.length),e.growCell(0,2),e.growCell(1,2),this.chList.forEach((n,o)=>{const l=n.ch;this.setRow(l,o,e)}),e.makeRowTemplate(this.tableRowCssClassName()),this.table=e;else{e.makeDim(2,1),e.growCell(0,2),e.growCell(1,2);const n=new le;this.setRow(n,0,e),e.makeRowTemplate(this.tableRowCssClassName()),e.clearRows(),this.table=e}const t=this.tableCssClassName(),s=this.table.ToScrollHTML(t,"");this.htmlMaker=new v;const i=new V;return i.props.name="",i.props.id="0",i.props.className=t,i.props.option.setTable(s),i.props.option.onSelect=async n=>{switch(console.log(`classify = ${n.classify} targetId = ${n.targetId}`),n.classify){case this.itemUpdateCssClassName():await this.onItemEdit(n);break;case this.itemDeleteCssClassName():await this.onItemDelete(n);break}},this.htmlMaker.add(i),this.htmlMaker.ToHTML()}createSummaryBox(e,t,s){this.parentName=t;let i=`
...
`.trim();const r=this.htmlMakerChSel.MakeDefaultToolButtonsHTML(a),c="";let h="";i!==""?h=`<div class="${this.dlgContentCssClassName()}" id="${this.dlgContentCssClassName()}">
    ...
    ${s}
    ${c}
</div>`;const u=new j;u.title="<"+e+">",u.SetB2Type(he.CopyPaste,this.onCopyPaste),u.SetB4Type(me.DialogHide);const d=u.NewDialog(t,this.dlgCssClassName());return u.SetContent(t,h),this.applyCss(),u.EnableEventHandlers(),u.onMoveDone=this.moverOnMoveDone,d}addEventHandlers(e){const t=document.getElementById(`${this.dlgCssClassName()}-auto`);t!==null&&(t.onclick=async()=>{await this.onAutoPut()});const s=document.getElementById(`${this.dlgCssClassName()}-tbput`);s!==null&&(s.onclick=async()=>{await this.onCharPut()});const i=document.getElementById(`${this.dlgCssClassName()}-tbempty`);i!==null&&(i.onclick=async()=>{await this.onCharEmpty()});const n=document.getElementById(`${this.dlgCssClassName()}-tbLeft`);n!==null&&(n.onclick=async()=>{await this.onCharLeft()});const o=document.getElementById(`${this.dlgCssClassName()}-tbRight`);o!==null&&(o.onclick=async()=>{await this.onCharRight()});const l=document.getElementById(`${this.dlgCssClassName()}-stock`);l!==null&&(l.onclick=async()=>{if(this.onStock!==void 0){if(this.selectedItem.ch.ns===H.None)return;const a=this.htmlMakerChSel.FindImgByID(this.itemCssClassName(),this.selectedItem.ch.idAttributeForHTML),r=new Xe;r.item=this.selectedItem,r.selectedImg=a===null?"":a.src;const c=this.findPropSelectedPos();c!==-1&&(r.scoreSet=this.scsList[c]),await this.onStock(r)}})}addItemEventkHandlers(e,t,s,i){this.onStock=s,this.onPut=e,this.onEmpty=t,this.onPropChanged=i;const n=this.htmlMakerChSel.GetIdByIndex(0);if(this.htmlMakerChSel.SelectByID(this.itemCssClassName(),n),this.htmlMakerChSel.enableEvents(this.itemCssClassName()),this.enableScoreEvent===!0){let o=0;for(const l of this.formation.items){o++;const a=`${this.propItemCssClassName()}-${o}`;this.htmlMakerProp.EnableId(a,!1)}this.htmlMakerProp.enableEvents(this.propCssClassName())}this.setSelectedItem(n)}async onAutoPut(){this.autoFormation(),await this.Setup(this.formation,this.imgLoader),await this.notifyChangeForm()}async notifyChangeForm(){for(const e of this.formation.items)await this.notifyChangeFormItem(e)}async notifyChangeFormItem(e){e.isEmpty?await this.notiftyOnEmpty(e):await this.notiftyOnPut(e,e.ch.iconFileName)}async notiftyOnPut(e,t){const s=new Xe;return s.uiName=this.formation.uiInfo.name,s.item=e,s.selectedImg=t,await this.onPut(s),s}async notiftyOnEmpty(e){const t=new Xe;return t.uiName=this.formation.uiInfo.name,t.item=e,t.selectedImg=this.emptyFile,await this.onEmpty(t),t}async onCharPut(){if(this.onPut!==void 0){this.selectedItem.isEmpty=!1;const e=await this.notiftyOnPut(this.selectedItem,"");this.formation.put(this.selectedItem,e.selectCh),this.replaceCharImg(this.selectedItem.ch.idAttributeForHTML,e.selectedImg,this.selectedItem.ch.name),this.propSelectedEnabled(!0)}}async onCharEmpty(){if(this.onEmpty!==void 0){this.selectedItem.isEmpty=!0;const e=await this.notiftyOnEmpty(this.selectedItem);this.formation.empty(this.selectedItem),this.replaceCharImg(this.selectedItem.ch.idAttributeForHTML,e.selectedImg,""),this.propSelectedEnabled(!1);const t=this.findPropSelectedPos();t!==-1&&(this.scsList[t]=new F)}}async onCharLeft(){this.canSwap(1)&&await this.formSwap(-1)}async onCharRight(){this.canSwap(this.formation.nFormationItem)&&await this.formSwap(1)}canSwap(e){return!(this.selectedItem===void 0||this.selectedItem.isEmpty===!0||this.selectedItem.itemID===e)}async formSwap(e){const t=this.selectedItem,s=t.itemID-1,i=s+e,n=this.formation.items[i],o=t.ch.idAttributeForHTML,l=n.ch.idAttributeForHTML,a=this.scsList[s],r=this.scsList[i],c=this.itemCssClassName(),h=this.htmlMakerChSel.FindImgByID(c,o),u=this.htmlMakerChSel.FindImgByID(c,l);if(h!==null&&u!==null){this.htmlMakerChSel.SwapImgSrcToolTip(h,u);const d=`${n.itemKey}${n.itemID}`;this.htmlMakerChSel.UnselectAll(c),this.htmlMakerChSel.SelectByID(c,d),this.formation.items[s]=n,this.formation.items[i]=t,this.formation.items[s].ch.idAttributeForHTML=o,this.formation.items[i].ch.idAttributeForHTML=l,this.scsList[s]=r,this.scsList[i]=a,this.setSelectedItem(d);const f=this.formation.items[s],$=this.formation.items[i];this.propAutoEnabled(f),this.propAutoEnabled($),await this.notifyChangeFormItem(f),await this.notifyChangeFormItem($)}}async charPutItem(e){const t=await this.notiftyOnPut(e,e.ch.iconFileName);this.replaceCharImg(e.ch.idAttributeForHTML,t.selectedImg,e.ch.name)}async charEmptyItem(e){const t=await this.notiftyOnEmpty(e);this.replaceCharImg(e.ch.idAttributeForHTML,t.selectedImg,"")}replaceCharImg(e,t,s){this.htmlMakerChSel.ReplaceImg(this.itemCssClassName(),e,t),this.htmlMakerChSel.ReplaceDivToolTip(this.itemCssClassName(),e,s)}propSelectedEnabled(e){const t=this.findPropSelectedPos();if(t!==-1){const s=`${this.propItemCssClassName()}-${t+1}`;this.htmlMakerProp.EnableId(s,e)}}propAutoEnabled(e){const t=!e.isEmpty,s=`${this.propItemCssClassName()}-${e.itemID}`;this.htmlMakerProp.EnableId(s,t)}makeFlyoutGrid(e,t){if(this.scoreGrid!==null)return;this.editingIndex=t,this.savedScoreSet=new F,F.copy(e,this.savedScoreSet,!0);const s=Lt(),i=new Array;for(const u of e.items){const d=new nt;d.selectionPair=u.selectionPair,d.selectedItem=u.selectedVal,d.classify=u.key;const f=new Oe;f.makeItems(),f.items[0].typeInfo.setCombo(d),f.items[0].className="";const $=new Xt;$.key=u.key,$.text=s.convTitle(u.title),$.value=f,i.push($)}const n=t+1,o=new Qt;if(o.setGridtems(i),o.setListener(`${this.gridName}-${n}`,`${this.propItemCssClassName()}-${n}`,this.dlgContentCssClassName(),`${this.gridHeaderName}-${n}`,`${this.gridFooterName}-${n}`),o.setVisible(!0),o.setFontConfig("0.8"),o.applyCss(),o.enableEvents(this.onScoreValueSelect),this.scoreGrid=o,this.scoreGrid.footerElem!==null){let u=`
<button id="${this.gridFooterName}-okBtn">OK</button>
<button id="${this.gridFooterName}-canBtn">CANCEL</button>
`.trim();this.scoreGrid.footerElem.innerHTML=u,document.getElementById(`${this.gridFooterName}-okBtn`).onclick=this.onOkClickScoreGrid,document.getElementById(`${this.gridFooterName}-canBtn`).onclick=this.onCancelClickScoreGrid}const l=document.getElementById(this.dlgContentCssClassName()),a=this.htmlMakerChSel.GetRect(l),r=this.htmlMakerChSel.FindDivByClassName(this.parentName,this.propCssClassName());this.htmlMakerChSel.GetRect(r);const c=this.htmlMakerChSel.FindDivByClassName(this.parentName,this.listCssClassName()),h=this.htmlMakerChSel.GetRect(c);o.show(`${parseInt(h.left)-parseInt(a.left)+t*100+5}`,`${parseInt(h.top)-parseInt(a.top)+parseInt(h.height)+5}`)}disposeScorGrid(){this.scoreGrid!==null&&(this.scoreGrid.dispose(),this.scoreGrid=null),this.editingIndex=-1}findPropSelectedPos(){const e=this.htmlMakerChSel.FindDivByClassName(this.dlgContentCssClassName(),this.propCssClassName());if(e!==null&&e.className.startsWith(this.propCssClassName())){let t=-1;for(const s of this.formation.items)if(t++,s===this.selectedItem)return console.log(`pos=${t}`),t}return-1}setSelectedItem(e){const t=this.formation.items.find(s=>e===s.ch.idAttributeForHTML);t&&(this.selectedItem=t)}enableLazyImages(e){this.htmlMakerChSel.initObserver(this.dlgCssClassName(),e)}itemCssClassName(){return`${this.listName}-item`}imgCssClassName(){return`${this.listName}-img`}propCssClassName(){return`${this.listName}-prop`}propItemCssClassName(){return`${this.listName}-prop-item`}lblCssClassName(){return`${this.listName}-lbl`}listCssClassName(){return`${this.listName}-list`}dlgContentCssClassName(){return`${this.parentName}-dlg-content`}dlgCssClassName(){return`${this.parentName}-dlg`}applyCss(){const e=this.listCssClassName(),t=this.itemCssClassName(),s=this.imgCssClassName(),i=this.propCssClassName(),n=this.propItemCssClassName();this.lblCssClassName();const o=parseInt(this.formation.uiInfo.left),l=parseInt(this.formation.uiInfo.top),a=100,r=document.createElement("style");r.textContent=`
...
`.trim(),document.head.appendChild(r);const c=document.getElementById(this.parentName);this.htmlMakerChSel.copyCssToInlineStyle(`.${this.parentName}`,c)}}class Xe{constructor(){this.cancel=!1}}class cs{constructor(){this.uiName="",this.cancel=!1}}class ke{constructor(){this.ch=new se,this.isEmpty=!0,this.TextMap=""}static toJsonText(e){const t=se.toJsonInst(e.ch);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new ke;t.ch=se.toJsonInst(e.ch),t.isEmpty=e.isEmpty;const s=Object.fromEntries(e.details.TextMap);return t.TextMap=JSON.stringify(s,null,2),t}static fromJsonInst(e){const t=new Bt;t.ch=se.fromJsonInst(e.ch),t.isEmpty=e.isEmpty;const s=new Map(Object.entries(JSON.parse(e.TextMap)));return t.details.TextMap=s,t}}class X{static toJsonText(e,t){const s=X.toJsonInst(e,t);return JSON.stringify(s,null,2)}static toJsonInst(e,t){const s=new X;s.items=new Array,s.scsList=new Array;for(const i of e.items)s.items.push(ke.toJsonInst(i));for(const i of t)s.scsList.push(i);return s}static fromJsonInst(e){const t=new tt;t.items=new Array;for(const s of e.items)t.items.push(ke.fromJsonInst(s));return t}}class At{constructor(e=0,t="",s=!0,i=0){this.ch=new le,this.isEmpty=!0,this.score=0,this.allAvailable=!1,this.ch.id=e,this.ch.name=t,this.isEmpty=s,this.score=i}}class at{Add(e){if(e===void 0){console.log("[VersusGroupRow::Add] scItem === undefined");return}this.columns===void 0&&(this.columns=[]),this.columns.push(e)}Count(){return this.columns.length}debug(){if(this.columns===void 0){console.log("[VersusGroupRow::debug] this.columns === undefined");return}for(const e of this.columns)console.log(`[${e.ch.name}]	score=[${e.score}]`)}}at.defNumColumn=5;class rt{Add(e){this.groupRows===void 0&&(this.groupRows=[]),this.groupRows.push(e)}Count(){return this.groupRows.length}debug(){if(this.groupRows===void 0)console.log("this.groupRows === undefined");else for(const e of this.groupRows)e.debug()}async loadJson(e){const i=(await new Se().loadJson(e)).groupRows.map(o=>Object.assign(new at,o)),n=new rt;return n.groupRows=i,n}}const Q={None:"None",Player:"Player",Enemy:"Enemy"},G={None:"None",Attr:"Attr",Role:"Role"},Nt={HiLv:"HiLv"},U={Likely:"Likely",Uncertain:"Uncertain",Wishful:"Wishful"};class Ve{}Ve.Likely=.9;Ve.Uncertain=.64;class st{constructor(){this.scoreItems=[],this.formationType=Q.None,this.boost=0}get imgPrefix(){return this.formationType===Q.Player?"ftPlayer":"ftEnemy"}get judgeWidth(){return 48}setScoreItems(e){if(e!==void 0){this.scoreItems=new Array;for(const t of e){const s=new At(t.ch.id,t.ch.name,t.isEmpty,t.score);this.scoreItems.push(s)}}}async toCharHTML(e,t){const s=t.isEmpty?e.demoMaterial:t.ch.iconFileName,i=t.ch.ns===H.None?"":t.ch.ns,n=await e.getImageUrlBy(s,i);let o=this.scoreToolTip(t);return o!==""&&(o=`title="${o}"`),`
<img class=${this.charCssClassName()}
  src="${n}"
  ${o}>
`.trim()}scoreToolTip(e){return e.isEmpty?"":`${e.ch.name}
score=${e.score}`}async toJudgeHTML(e,t){const s=this.toJudgeFileURL(e,t);return`<img class=${this.judgeCssClassName()} src="${s}" width="48">`}async toJudgeFileURL(e,t){let s=null;switch(t){case U.Likely:s=await e.getImageUrlBy("win.png",e.AnyNs);break;case U.Uncertain:s=await e.getImageUrlBy("even.png",e.AnyNs);break;case U.Wishful:s=await e.getImageUrlBy("lost.png",e.AnyNs);break;default:return""}return s}charCssClassName(){return"combat-char"}judgeCssClassName(){return"combat-judge"}get combatScore(){if(this.scoreItems===void 0)return 0;const e=this.scoreItems.reduce((s,i)=>i.isEmpty?s:s+i.score,0),t=this.boost===0?1:this.boost;return Math.ceil(e*t/100)}}class hs{constructor(){this.hasCombo=!1,this.winRate=new Map}setPlayer(e){e.formationType=Q.Player,this.player=e}setEnemy(e){e.formationType=Q.Enemy,this.enemy=e}judge(e){const s=this.winRate.get(e);return s>=Ve.Likely?U.Likely:s>=Ve.Uncertain?U.Uncertain:U.Wishful}judgeForEnemy(e){switch(e){case U.Likely:return U.Wishful;case U.Uncertain:return U.Uncertain;case U.Wishful:return U.Likely}}}class ms{constructor(){this.combatPairs=new Map,this.emptyFile="plus.png",this.parentName="",this.uiInfo=new pe,this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new b().SaveSetting(e)}}setPair(e,t){this.combatPairs.set(e,t)}calcCombatScore(){for(const[e,t]of this.combatPairs){if(t.player===void 0||t.enemy===void 0)continue;const s=[G.None,G.Attr,G.Role];for(const i of s){let n=t.player.combatScore,o=t.enemy.combatScore;t.winRate.set(i,o!==0?n/o:1)}}}async replaceChar(e,t,s,i,n){const o=this.combatPairs.get(e);let l;if(t===Q.Player?l=o?.player:t===Q.Enemy&&(l=o?.enemy),l===void 0)return!1;const a=s.itemID;if(a<0)return!1;const r=a-1;l=l;const h=`${l.imgPrefix}${a}`,u=l.scoreItems[r],d=u.ch;let f="";s.isEmpty?(d.id=0,d.name="",f=n.demoMaterial,console.log("[replaceChar] set empty")):(d.id=i.id,d.name=i.name,f=d.iconFileName,console.log(`[replaceChar] set char ${i.id}:${i.name}`)),u.isEmpty=s.isEmpty;const $=d.ns===H.None?"":d.ns,k=await n.getImageUrlBy(f,$);if(k===null)return!1;const R=new v,A=this.outerCssClassName();return R.ReplaceImg(A,h,k),R.ReplaceImgToolTip(A,h,l.scoreToolTip(u)),!0}async replaceJudge(e){async function t(n,o){const l=await n.toJudgeFileURL(e,o);if(l===null)return;const a=n.imgPrefix;for(let r=0;r<n.scoreItems.length;r++){const c=`${a}${r+1}`,h=s.FindImgsByID(i,c);if(h===null||h.length<=1){console.error("fail on judge marker");continue}const u=h[1];s.SetImgSrc(u,l),n.scoreItems[r].isEmpty?s.SetImgSize(u,0,0):s.SetImgSize(u,n.judgeWidth,n.judgeWidth);const d=n.scoreItems[r];s.ReplaceImgToolTip(i,c,n.scoreToolTip(d))}}const s=new v,i=this.outerCssClassName();for(const[n,o]of this.combatPairs){if(o.player===void 0||o.enemy===void 0)continue;const l=[G.None,G.Attr,G.Role];for(const a of l){if(a!==G.None)continue;const r=o.judge(a),c=o.judgeForEnemy(r);await t(o.player,r),await t(o.enemy,c)}}}async toHTML(e,t){const s=document.createElement("table");s.id=e;const i=document.createElement("tbody");s?.appendChild(i);async function n(l,a){const r=document.createElement("tr");i?.appendChild(r);const c=await a.toJudgeHTML(t,l),h=a.imgPrefix;let u=0;for(const d of a.scoreItems){u++;const f=await a.toCharHTML(t,d),$=`
<div class=${o} item-id="${h}${u}">
    ${f}
    ${c}
</div>
`.trim(),k=document.createElement("td");k.innerHTML=$,r.appendChild(k)}}const o=this.outerCssClassName();for(const[l,a]of this.combatPairs){const r=a.judge(G.None),c=a.judgeForEnemy(r);await n(r,a.player),await n(c,a.enemy)}return s.outerHTML}createCombatBox(e,t,s){this.parentName=t,this.htmlMaker=new v;const i=`<div class="${this.parentName}-dlg-content">
    ${s}
</div>`,n=new j;n.title="<"+e+">";const o=n.NewDialog(t,this.dlgCssClassName());return n.SetContent(t,i),this.applyCss(),n.EnableEventHandlers(),n.onMoveDone=this.moverOnMoveDone,o}enableLazyImages(e){this.htmlMaker.initObserver(this.dlgCssClassName(),e)}processResult(e,t,s){async function i(o,l){const a=t(l.formationType),r=await l.toJudgeHTML(e,o),c=l.imgPrefix;let h=0;for(const u of l.scoreItems){h++;const d=await l.toCharHTML(e,u),f=`
<div class=${n} item-id="${c}${h}">
    ${d}
    ${r}
</div>
`.trim();s(a,f)}}const n=this.outerCssClassName();for(const[o,l]of this.combatPairs){const a=l.judge(G.None),r=l.judgeForEnemy(a);i(a,l.player),i(r,l.enemy)}}outerCssClassName(){return"combat-outer"}dlgCssClassName(){return`${this.parentName}-dlg`}applyCss(){const e=new st,t=`.${this.outerCssClassName()}`,s=`.${e.charCssClassName()}`,i=`.${e.judgeCssClassName()}`,n=parseInt(this.uiInfo.left),o=parseInt(this.uiInfo.top),l=document.createElement("style");l.textContent=`
...
`.trim(),document.head.appendChild(l);const a=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,a)}}const be={Unknown:"Unknown",Success:"Success",Fail:"Fail",Cancel:"Cancel"};async function ds(m){const e=m.isWebRunning,t=m.currentUserHome,s=m.chStatusListFile,i=m.chListFile,n=new jt,o=new v,l="splash-screen";o.initFullScreen(l,"エボナ データベース初期化中..."),o.applyFullScreenCss(l);const a=o.getFullScreenMsgElem(l),r=a!==null?a.innerHTML:"";if(t===m.user1Home){const p=[{ns:H.CnsRed,nsName:"赤属性"},{ns:H.CnsBlue,nsName:"青属性"},{ns:H.CnsGreen,nsName:"緑属性"},{ns:H.CnsYellow,nsName:"黄属性"},{ns:H.CnsViolet,nsName:"紫属性"}],M=await new Ie().LoadList(i);for(const C of p)a!==null&&(a.innerHTML=`${r} ${C.nsName}`),await n.setupNs(C.ns,m,M)}if(t===m.user2Home){const p=[{ns:H.CnsBlue,nsName:"藍属性"},{ns:H.CnsRed,nsName:"紅属性"},{ns:H.CnsGreen,nsName:"翠属性"},{ns:H.CnsYellow,nsName:"黄属性"},{ns:H.CnsWhite,nsName:"天属性"},{ns:H.CnsBlack,nsName:"冥属性"}],M=await new Ie().LoadList(i);for(const C of p)a!==null&&(a.innerHTML=`${r} ${C.nsName}`),await n.setupNs(C.ns,m,M)}a!==null&&(a.innerHTML="UI 初期化中 ...");const c=new qe,h=new Je;await h.loadDB(s);const u=await h.loadAuxScoreSet(m.gameType);async function d(){async function p(){return await new Ie().LoadList(i)}const g=await p();g.uiInfo.name="charListArea",g.uiInfo.left="300",g.uiInfo.top="100";const M=g.uiInfo.name,C=await g.toHTML(n);if(e){const y="キャラ選択",S=g.createSelectorBox(y,M,C);g.addEventHandlers(S),g.addItemEventHandlers(),g.enableLazyImages(n),S.show();const T=new Y;T.setAsDlg(S,y),c.add(T)}return g}const f=await d();async function $(){const p=new ls;await p.load(),p.uiInfo.name="CharSummary",p.uiInfo.left="400",p.uiInfo.top="100";const g=p.uiInfo.name,M=await p.toHTML();if(e){const C="キャラ一覧",y=p.createSummaryBox(C,g,M);await p.updateCharInfos(n),p.addEventHandlers(y,async T=>{T.selectCh=f.selectedCh;const P=await n.getImageUrlBy(f.selectedCh.iconFileName,f.selectedCh.ns);if(P===null)T.selectedImg="",T.cancel=!0;else{T.selectedImg=P,T.cancel=!1;const L=await h.getStatus(f.selectedCh.idAsText);console.log(L),T.scoreSet=L,T.scoreSet.items=T.scoreSet.items.concat(u.items)}console.log(`selected ch = ${T.selectCh.name}`)}),p.addItemEventHandlers(),p.enableLazyImages(n),y.show();const S=new Y;S.setAsDlg(y,C),c.add(S)}return p}const k=await $();async function R(p,g,M,C){const y=new rs;p===A&&(y.InitForPlayer(k),y.autoForm=!0,y.editFormEnable=!1,y.saveEnable=!1,y.imgLoader=n),p===J&&(y.InitForEnemy(h),y.SetAuxScoreSet(u),y.autoForm=!1,y.editFormEnable=!0,y.saveEnable=!0),y.formation.uiInfo.name=p,y.formation.uiInfo.left=`${g}`,y.formation.uiInfo.top=`${M}`;const S=y.formation.uiInfo.name,T=await y.toHTML(S),P=p===J?y.toGridHTML():"";if(e){const L=y.createFormationBox(C,S,T,P);y.addEventHandlers(L),y.addItemEventkHandlers(async E=>{let D="",je="";E.selectedImg===""?(D=f.selectedCh.iconFileName,je=f.selectedCh.ns,E.selectCh=f.selectedCh):(D=E.item.ch.iconFileName,je=E.item.ch.ns,E.selectCh=E.item.ch);const Ct=await n.getImageUrlBy(D,je);Ct!==null&&(E.selectedImg=Ct,E.item.isEmpty=!1,yt(E.uiName,E.item,E.selectCh))},async E=>{const D=await n.getImageUrlBy(E.selectedImg,f.selectedCh.ns);D!==null&&(E.selectedImg=D,E.item.isEmpty=!0,yt(E.uiName,E.item,E.selectCh))},async E=>{console.log(`selected ch = ${E.item.ch.name}`);const D=new Rt;D.selectCh=E.item.ch,D.selectedImg=E.selectedImg,D.scoreSet=E.scoreSet,k.charStock(D)},async E=>{const D=gt();console.log(D),await D.replaceJudge(n)}),y.enableLazyImages(n),L.show();const ge=new Y;ge.setAsDlg(L,C),c.add(ge)}return y}const A="playerForm",J="enemyForm",$e=await R(A,100,100,"自編成"),Ee=await R(J,100,200,"敵編成");async function Ht(p,g,M,C){q.uiInfo.name=p,q.uiInfo.left=`${g}`,q.uiInfo.top=`${M}`;const y=await q.toHTML("combatTable",n),S=q.createCombatBox(C,p,y);q.enableLazyImages(n),await q.replaceJudge(n),S.show();const T=new Y;T.setAsDlg(S,C),c.add(T)}const q=gt();await Ht("combatForm",120,300,"対戦予想");const ct="保存";{const p=new Y;p.setAsMenu(ct),c.add(p)}const ht="復帰";{const p=new Y;p.setAsMenu(ht),c.add(p)}let xe=null;const Ft=await c.toHTML("dockForm",n);if(e){const p=c.createDockBox("dockForm",Ft);c.addItemClickHandlers(async g=>{c.stdApplyAction(g)!==!1&&g.item.isMenuType&&(g.item.toolTip===ct&&await Pt(),g.item.toolTip===ht&&await Ot(async C=>{if(console.log(`[loadedResult] ${C}`),C!==be.Success)return;const y=X.fromJsonInst(Me),S=X.fromJsonInst(ve);Me=null,ve=null,await $e.Setup(y,n),await Ee.Setup(S,n)}))}),c.enableLazyImages(n),p.show(),xe=p}const mt="playerForm.json",dt="enemyForm.json",ut="dockForm.json";async function Pt(){c.InitZOrder(_);const p=X.toJsonText($e.formation,$e.scsList),g=X.toJsonText(Ee.formation,Ee.scsList),M=ze.toJsonText(c),C=new window.JSZip;C.file(mt,p),C.file(dt,g),C.file(ut,M);const y=await C.generateAsync({type:"blob"}),S="gameConfig.zip",T=URL.createObjectURL(y),P=document.createElement("a");P.href=T,P.download=S,P.click(),URL.revokeObjectURL(T),console.log("saved!")}let ft=null,Me=null,ve=null;async function Ot(p){const g=document.createElement("input");return g.type="file",g.accept=".zip",g.addEventListener("cancel",()=>(console.log("Cancelled."),be.Cancel)),g.addEventListener("change",async()=>{if(g.files.length==1){console.log("File selected: ",g.files[0].name);const C=await g.files[0].arrayBuffer(),S=await new window.JSZip().loadAsync(C);async function T(L){const ge=S.file(L);if(ge){const E=await ge.async("string"),D=JSON.parse(E);return console.log(D),D}}{const L=await T(ut);L&&(ft=L)}{const L=await T(mt);L&&(Me=L)}{const L=await T(dt);L&&(ve=L)}const P=ft!==null&&Me!==null&&ve!==null?be.Success:be.Fail;p(P)}}),g.click(),be.Unknown}const _=new b;e&&(_.AddDialogs(),_.AssignIndexies(),await _.LoadAllSetting(),await _.loadSetting(xe),c.InitZOrder(_),await _.ForEachAsync(p=>{const g=j.FindDialogParent(p);return g!==null&&(m.isLocal||p==="charListArea"?g.hidden=!1:g.hidden=!0),!0}),xe!==null&&(xe.parentElement.hidden=!m.isLocal)),o.hideFullScreenCss(l);function pt(p){const g=new rt,M=new at,C=p.formation;C.uiInfo.name,C.uiInfo.name,p.scsList===void 0&&console.log(`[${p.formation.uiInfo.name}] 対戦予想結果の作成は工事中です`);let y=0;for(const S of C.items){if(p.scsList===void 0)continue;const T=p.scsList[y];y++;const P=Math.ceil(T.stdScore),L=new At(S.ch.id,S.ch.name,S.isEmpty,P);L.allAvailable=T.allAvailable,M.Add(L)}return g.Add(M),g.debug(),g}function gt(){const p=new ms,g=pt($e),M=pt(Ee),C=new st;C.setScoreItems(g.groupRows[0].columns),C.boost=100;const y=new st;y.setScoreItems(M.groupRows[0].columns),y.boost=100;const S=new hs;S.setPlayer(C),S.setEnemy(y),p.setPair(Nt.HiLv,S),p.calcCombatScore();for(const[T,P]of p.combatPairs){const L=P.judge(G.None);console.log(`judge=[${L}]`)}return p}async function yt(p,g,M){const C=Nt.HiLv;q.combatPairs.get(C),p===A&&await q.replaceChar(C,Q.Player,g,M,n),p===J&&await q.replaceChar(C,Q.Enemy,g,M,n),await q.replaceJudge(n)}}async function us(m){if(!m.isWebRunning)return;const e=m.isWebRunning;console.log(`mode=${m.edit}`);const t=new qe;async function s(){const u=ae.Resource,d=new wt;d.init(),await d.load(u,z.none),d.uiInfo.name="ResourceEdit",d.uiInfo.left="110",d.uiInfo.top="10";const f=d.uiInfo.name,$=await d.toHTML(d.makeResEditItems(),d.makeResLog);if(e){const k=document.createElement("div");k.id=d.uiInfo.name,k.className=d.uiInfo.name,document.body.appendChild(k);const R="文字列リソース",A=d.createEditorBox(R,f,$);d.addEventHandlers(A),d.addItemEventHandlers(),A.show(),d.enableResize();const J=new Y;J.setAsDlg(A,R),t.add(J)}return d}async function i(){const u=ae.ScoreUI,d=new wt;d.init(),await d.load(u,m.edit),d.uiInfo.name="ScoreEdit",d.uiInfo.left="110",d.uiInfo.top="100";const f=d.uiInfo.name,$=await d.toHTML(d.makeScoreEditItems(),d.makeScoreLog);if(e){const k=document.createElement("div");k.id=d.uiInfo.name,k.className=d.uiInfo.name,document.body.appendChild(k);const R="スコア設定",A=d.createEditorBox(R,f,$);d.addEventHandlers(A),d.addItemEventHandlers(),A.show(),d.enableResize();const J=new Y;J.setAsDlg(A,R),t.add(J)}return d}(await s()).startAutoSave(),(await i()).startAutoSave();const l=document.createElement("div"),a="dockEdit";l.id=a,l.className=a,document.body.appendChild(l);let r=null;const c=await t.toHTML(a,null);if(e){const u=t.createDockBox(a,c);t.addItemClickHandlers(async d=>{t.stdApplyAction(d)}),u.show(),r=u}const h=new b;e&&(h.AddDialogs(),h.AssignIndexies(),await h.LoadAllSetting(),await h.loadSetting(r),t.InitZOrder(h),await h.ForEachAsync(u=>{const d=j.FindDialogParent(u);return d!==null&&(m.isLocal||u==="charListArea"?d.hidden=!1:d.hidden=!0),!0}),r!==null&&(r.parentElement.hidden=!m.isLocal))}const B=new Se,Dt=B.isWebRunning;Dt?(ps(),B.parseURLParams(),B.currentUserHome===""&&B.setUser(B.user1Home)):B.setUser(B.user2Home);const Ge=window.EVONA_CONFIG.isLocal;B.setPath();O.encodeEnable=!Ge;B.setImageHome(Ge);const fs=gs(Ge);B.currentUserHome;B.statusJsonPath;B.zipPrefix;B.chListFile;B.chStatusListFile;switch(B.admin){case!0:await qt(B);break;case!1:if(Dt)if(B.edit===z.none){let m=!1,e=!1;const t=new de;t.CheckVisible=!0,t.CheckText="位置情報を初期化",t.SecretEnable=!0;const s=B.setBrowserTitle();if(await t.showWait(`「${s} 」モードで起動します`)===N.Secret&&(e=!0),m=t.Checked,console.log(`secretMode=[${e}]`),console.log(`cleanMode=[${m}]`),!Ge){if(e&&fs){let n="";t.CheckVisible=!1,t.SecretEnable=!1,t.AuthVisible=!0,t.onAuthChecking=h=>(n=h,!0),await t.showWait("認証コードを入力してください");const o=new Date,l=("0"+(o.getMonth()+1)).slice(-2),a=("0"+o.getDate()).slice(-2),c=Math.random()>.5?`${l}${a}`:`${a}${l}`;console.log(n===c?"auth success":"auth fail")}}m&&(await(await zt()).clear(),await(await oe()).clear()),window.EVONA_CONFIG.demo=!1,await ds(B)}else B.setBrowserTitle(),await us(B);break}function ps(){const m=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.hostname.startsWith("192.168."),e=m?"./jszip_dist/jszip.min.js":"https://cdn.jsdelivr.net/npm/jszip@3.10.1/dist/jszip.min.js",t=m?"./jsstore_dist/jsstore.min.js":"https://cdn.jsdelivr.net/npm/jsstore/dist/jsstore.min.js";window.EVONA_CONFIG={isLocal:m,workerFile:"./jsstore_dist/jsstore.worker.min.js",demo:!m};function s(i,n=!1){const o=document.createElement("script");o.src=i,n&&(o.type="module"),o.async=!1,document.head.appendChild(o)}s(e),s(t)}function gs(m){if(m)return!0;const e=document.referrer;console.log(`${e}`);const t="evona_auth",s="granted";return sessionStorage.getItem(t)===s?!0:e.includes("qiita.com")?(sessionStorage.setItem(t,s),!0):!1}
