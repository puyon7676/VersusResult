...
width: 100%;
        ...
        `.trim(),document.head.appendChild(t)}enableEvents(e){return this.ctlElem===null?!1:(this.htmlMaker.enableTableEvents(this.ctlElem.className),this.onSelect=e,!0)}disableEvents(){return this.ctlElem===null?!1:(this.htmlMaker.disableTableEvents(this.ctlElem.className),!0)}setVisible(e){return this.ctlElem===null?!1:(this.ctlElem.hidden=!e,!0)}dispose(){super.dispose(),this.ctlElem!==null&&(this.ctlElem.parentElement?.removeChild(this.ctlElem),this.ctlElem.remove()),this.disableEvents(),this.ctlElem=null}tblCssName(){return`${this.ctlName}-tbl`}}class Xt{constructor(){this.key="",this.text=""}}class Qt extends lt{constructor(){super(...arguments),this.callerName="",this.htmlMaker=new L,this.table=new K,this.ctlElem=null,this.headerElem=null,this.footerElem=null}setGridtems(e){this.items=e}setListener(e,t,s,i="",n=""){if(this.items===void 0)return!1;this.dispose(),this.callerName=s,this.ctlName=e;const o=this.items.length,l=new K;l.makeDim(2,o);let a=0;for(const R of this.items)l.getCell(0,a).typeInfo.setLabel(`${R.text}`,!1),l.getCell(0,a).className=this.keyCssName(),l.getCell(0,a).typeInfo.using.itemId=a,l.getCell(1,a).typeInfo=R.value.items[0].typeInfo,l.getCell(1,a).className=this.valueCssName(),l.getCell(1,a).typeInfo.using.itemId=a,a++;const r=this.firstAction(e,t);if(r===null)return!1;const c=l.ToScrollHTML(e,this.tblCssName()),h=new q;h.props.name="",h.props.id=this.tblCssName(),h.props.className=this.tblCssName(),h.props.option.setTable(c),h.props.option.onSelect=async R=>{if(this.onSelect!==void 0){const B=new Ne;B.callerName=R.classify,B.result=R.selectedValue,await this.onSelect(B)}},this.htmlMaker=new L,this.htmlMaker.add(h);const u=this.htmlMaker.ToHTML();let d=document.createElement("dialog");d.className=e,d.innerHTML=u,this.ctlElem=d;let p=d.children[0];const E=this.divCssName();p.className=E,p.id=E;let S=p.children[0];return S.className=`${this.tblCssName()}`,S.id=`${this.tblCssName()}`,i!==""&&(this.headerElem=document.createElement("div"),this.headerElem.className=i,this.headerElem.id=i,d.appendChild(this.headerElem)),r.appendChild(this.ctlElem),n!==""&&(this.footerElem=document.createElement("div"),this.footerElem.className=n,this.footerElem.id=n,d.appendChild(this.footerElem)),this.table=l,!0}show(e,t){this.ctlElem!==null&&(this.ctlElem.style.left=`${e}px`,this.ctlElem.style.top=`${t}px`,this.ctlElem.show())}setFontConfig(e="0.9"){this.table.setFontConfig(e)}applyCss(){const e=`${this.getBaseElem().className}-flgrd-style`;if(document.getElementById(e))return;const t=document.createElement("style");t.id=e,t.textContent=`
${this.getOuterCssText()}
...
`.trim()}ToComboHTML(e){if(this.using.combo===void 0)return"";const t=this.using.combo;let s=q.makeComboItemsHTML(t);const i=t.classify!==""?` data-classify="${t.classify}"`:"";return`
<select class="${e}" ${i}>
  ${s}
</select>
...
`.trim(),document.head.appendChild(r);const c=document.getElementById(this.parentName);this.htmlMakerChSel.copyCssToInlineStyle(`.${this.parentName}`,c)}}class Ye{constructor(){this.cancel=!1}}class cs{constructor(){this.uiName="",this.cancel=!1}}class ke{constructor(){this.ch=new ie,this.isEmpty=!0,this.TextMap=""}static toJsonText(e){const t=ie.toJsonInst(e.ch);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new ke;t.ch=ie.toJsonInst(e.ch),t.isEmpty=e.isEmpty;const s=Object.fromEntries(e.details.TextMap);return t.TextMap=JSON.stringify(s,null,2),t}static fromJsonInst(e){const t=new Bt;t.ch=ie.fromJsonInst(e.ch),t.isEmpty=e.isEmpty;const s=new Map(Object.entries(JSON.parse(e.TextMap)));return t.details.TextMap=s,t}}class Q{static toJsonText(e,t){const s=Q.toJsonInst(e,t);return JSON.stringify(s,null,2)}static toJsonInst(e,t){const s=new Q;s.items=new Array,s.scsList=new Array;for(const i of e.items)s.items.push(ke.toJsonInst(i));for(const i of t)s.scsList.push(i);return s}static fromJsonInst(e){const t=new tt;t.items=new Array;for(const s of e.items)t.items.push(ke.fromJsonInst(s));return t}}class At{constructor(e=0,t="",s=!0,i=0){this.ch=new ae,this.isEmpty=!0,this.score=0,this.allAvailable=!1,this.ch.id=e,this.ch.name=t,this.isEmpty=s,this.score=i}}class at{Add(e){if(e===void 0){console.log("[VersusGroupRow::Add] scItem === undefined");return}this.columns===void 0&&(this.columns=[]),this.columns.push(e)}Count(){return this.columns.length}debug(){if(this.columns===void 0){console.log("[VersusGroupRow::debug] this.columns === undefined");return}for(const e of this.columns)console.log(`[${e.ch.name}]	score=[${e.score}]`)}}at.defNumColumn=5;class rt{Add(e){this.groupRows===void 0&&(this.groupRows=[]),this.groupRows.push(e)}Count(){return this.groupRows.length}debug(){if(this.groupRows===void 0)console.log("this.groupRows === undefined");else for(const e of this.groupRows)e.debug()}async loadJson(e){const i=(await new Se().loadJson(e)).groupRows.map(o=>Object.assign(new at,o)),n=new rt;return n.groupRows=i,n}}const j={None:"None",Player:"Player",Enemy:"Enemy"},G={None:"None",Attr:"Attr",Role:"Role"},Xe={HiLv:"HiLv"},V={Likely:"Likely",Uncertain:"Uncertain",Wishful:"Wishful"};class Ve{}Ve.Likely=.9;Ve.Uncertain=.64;class st{constructor(){this.scoreItems=[],this.formationType=j.None,this.boost=0}get imgPrefix(){return this.formationType===j.Player?"ftPlayer":"ftEnemy"}get judgeWidth(){return 48}setScoreItems(e){if(e!==void 0){this.scoreItems=new Array;for(const t of e){const s=new At(t.ch.id,t.ch.name,t.isEmpty,t.score);this.scoreItems.push(s)}}}async toCharHTML(e,t){const s=t.isEmpty?e.demoMaterial:t.ch.iconFileName,i=t.ch.ns===H.None?"":t.ch.ns,n=await e.getImageUrlBy(s,i);let o=this.scoreToolTip(t);return o!==""&&(o=`title="${o}"`),`
<img class=${this.charCssClassName()}
  src="${n}"
  ${o}>
`.trim()}scoreToolTip(e){return e.isEmpty?"":`${e.ch.name}
score=${e.score}`}async toJudgeHTML(e,t){const s=this.toJudgeFileURL(e,t);return`<img class=${this.judgeCssClassName()} src="${s}" width="48">`}async toJudgeFileURL(e,t){let s=null;switch(t){case V.Likely:s=await e.getImageUrlBy("win.png",e.AnyNs);break;case V.Uncertain:s=await e.getImageUrlBy("even.png",e.AnyNs);break;case V.Wishful:s=await e.getImageUrlBy("lost.png",e.AnyNs);break;default:return""}return s}charCssClassName(){return"combat-char"}judgeCssClassName(){return"combat-judge"}get combatScore(){if(this.scoreItems===void 0)return 0;const e=this.scoreItems.reduce((s,i)=>i.isEmpty?s:s+i.score,0),t=this.boost===0?1:this.boost;return Math.ceil(e*t/100)}}class hs{constructor(){this.hasCombo=!1,this.winRate=new Map}setPlayer(e){e.formationType=j.Player,this.player=e}setEnemy(e){e.formationType=j.Enemy,this.enemy=e}judge(e){const s=this.winRate.get(e);return s>=Ve.Likely?V.Likely:s>=Ve.Uncertain?V.Uncertain:V.Wishful}judgeForEnemy(e){switch(e){case V.Likely:return V.Wishful;case V.Uncertain:return V.Uncertain;case V.Wishful:return V.Likely}}}class ms{constructor(){this.combatPairs=new Map,this.emptyFile="plus.png",this.parentName="",this.uiInfo=new fe,this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new C().SaveSetting(e)}}setPair(e,t){this.combatPairs.set(e,t)}calcCombatScore(){for(const[e,t]of this.combatPairs){if(t.player===void 0||t.enemy===void 0)continue;const s=[G.None,G.Attr,G.Role];for(const i of s){let n=t.player.combatScore,o=t.enemy.combatScore;t.winRate.set(i,o!==0?n/o:1)}}}async replaceChar(e,t,s,i,n){const o=this.combatPairs.get(e);let l;if(t===j.Player?l=o?.player:t===j.Enemy&&(l=o?.enemy),l===void 0)return!1;const a=s.itemID;if(a<0)return!1;const r=a-1;l=l;const h=`${l.imgPrefix}${a}`,u=l.scoreItems[r],d=u.ch;let p="";s.isEmpty?(d.id=0,d.name="",p=n.demoMaterial,console.log("set empty")):(d.id=i.id,d.name=i.name,p=d.iconFileName,console.log(`set char ${i.id}:${i.name}`)),u.isEmpty=s.isEmpty;const E=d.ns===H.None?"":d.ns,S=await n.getImageUrlBy(p,E);if(S===null)return!1;const R=new L,B=this.outerCssClassName();return R.ReplaceImg(B,h,S),R.ReplaceImgToolTip(B,h,l.scoreToolTip(u)),!0}async replaceJudge(e){async function t(n,o){const l=await n.toJudgeFileURL(e,o);if(l===null)return;const a=n.imgPrefix;for(let r=0;r<n.scoreItems.length;r++){const c=`${a}${r+1}`,h=s.FindImgsByID(i,c);if(h===null||h.length<=1){console.error("fail on judge marker");continue}const u=h[1];s.SetImgSrc(u,l),n.scoreItems[r].isEmpty?s.SetImgSize(u,0,0):s.SetImgSize(u,n.judgeWidth,n.judgeWidth);const d=n.scoreItems[r];s.ReplaceImgToolTip(i,c,n.scoreToolTip(d))}}const s=new L,i=this.outerCssClassName();for(const[n,o]of this.combatPairs){if(o.player===void 0||o.enemy===void 0)continue;const l=[G.None,G.Attr,G.Role];for(const a of l){if(a!==G.None)continue;const r=o.judge(a),c=o.judgeForEnemy(r);await t(o.player,r),await t(o.enemy,c)}}}async toHTML(e,t){const s=document.createElement("table");s.id=e;const i=document.createElement("tbody");s?.appendChild(i);async function n(l,a){const r=document.createElement("tr");i?.appendChild(r);const c=await a.toJudgeHTML(t,l),h=a.imgPrefix;let u=0;for(const d of a.scoreItems){u++;const p=await a.toCharHTML(t,d),E=`
<div class=${o} item-id="${h}${u}">
    ${p}
    ${c}
</div>
`.trim(),S=document.createElement("td");S.innerHTML=E,r.appendChild(S)}}const o=this.outerCssClassName();for(const[l,a]of this.combatPairs){const r=a.judge(G.None),c=a.judgeForEnemy(r);await n(r,a.player),await n(c,a.enemy)}return s.outerHTML}createCombatBox(e,t,s){this.parentName=t,this.htmlMaker=new L;const i=`<div class="${this.parentName}-dlg-content">
    ${s}
</div>`,n=new W;n.title="<"+e+">";const o=n.NewDialog(t,this.dlgCssClassName());return n.SetContent(t,i),this.applyCss(),n.EnableEventHandlers(),n.onMoveDone=this.moverOnMoveDone,o}enableLazyImages(e){this.htmlMaker.initObserver(this.dlgCssClassName(),e)}processResult(e,t,s){async function i(o,l){const a=t(l.formationType),r=await l.toJudgeHTML(e,o),c=l.imgPrefix;let h=0;for(const u of l.scoreItems){h++;const d=await l.toCharHTML(e,u),p=`
...
`.trim(),document.head.appendChild(l);const a=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,a)}}const be={Unknown:"Unknown",Success:"Success",Fail:"Fail",Cancel:"Cancel"};async function Nt(m){const e=m.isWebRunning,t=m.currentUserHome,s=m.chStatusListFile,i=m.chListFile,n=new jt,o=new L,l="splash-screen";o.initFullScreen(l,"エボナ データベース初期化中..."),o.applyFullScreenCss(l);const a=o.getFullScreenMsgElem(l),r=a!==null?a.innerHTML:"";if(t===m.user1Home){const f=[{ns:H.CnsRed,nsName:"赤属性"},{ns:H.CnsBlue,nsName:"青属性"},{ns:H.CnsGreen,nsName:"緑属性"},{ns:H.CnsYellow,nsName:"黄属性"},{ns:H.CnsViolet,nsName:"紫属性"}],A=await new Ie().LoadList(i);for(const w of f)a!==null&&(a.innerHTML=`${r} ${w.nsName}`),await n.setupNs(w.ns,m,A)}if(t===m.user2Home){const f=[{ns:H.CnsBlue,nsName:"藍属性"},{ns:H.CnsRed,nsName:"紅属性"},{ns:H.CnsGreen,nsName:"翠属性"},{ns:H.CnsYellow,nsName:"黄属性"},{ns:H.CnsWhite,nsName:"天属性"},{ns:H.CnsBlack,nsName:"冥属性"}],A=await new Ie().LoadList(i);for(const w of f)a!==null&&(a.innerHTML=`${r} ${w.nsName}`),await n.setupNs(w.ns,m,A)}a!==null&&(a.innerHTML="UI 初期化中 ...");const c=new qe,h=new Je;await h.loadDB(s);const u=await h.loadAuxScoreSet(m.gameType);async function d(){async function f(){return await new Ie().LoadList(i)}const g=await f();g.uiInfo.name="charListArea",g.uiInfo.left="300",g.uiInfo.top="100";const A=g.uiInfo.name,w=await g.toHTML(n);if(e){const y="キャラ選択",$=g.createSelectorBox(y,A,w);g.addEventHandlers($),g.addItemEventHandlers(),g.enableLazyImages(n),$.show();const k=new X;k.setAsDlg($,y),c.add(k)}return g}const p=await d();async function E(){const f=new ls;await f.load(),f.uiInfo.name="CharSummary",f.uiInfo.left="400",f.uiInfo.top="100";const g=f.uiInfo.name,A=await f.toHTML();if(e){const w="キャラ一覧",y=f.createSummaryBox(w,g,A);await f.updateCharInfos(n),f.addEventHandlers(y,async k=>{k.selectCh=p.selectedCh;const O=await n.getImageUrlBy(p.selectedCh.iconFileName,p.selectedCh.ns);if(O===null)k.selectedImg="",k.cancel=!0;else{k.selectedImg=O,k.cancel=!1;const M=await h.getStatus(p.selectedCh.idAsText);console.log(M),k.scoreSet=M,k.scoreSet.items=k.scoreSet.items.concat(u.items)}console.log(`selected ch = ${k.selectCh.name}`)}),f.addItemEventHandlers(),f.enableLazyImages(n),y.show();const $=new X;$.setAsDlg(y,w),c.add($)}return f}const S=await E();async function R(f,g,A,w){const y=new rs;f===B&&(y.InitForPlayer(S),y.autoForm=!0,y.editFormEnable=!1,y.saveEnable=!1,y.imgLoader=n),f===z&&(y.InitForEnemy(h),y.SetAuxScoreSet(u),y.autoForm=!1,y.editFormEnable=!0,y.saveEnable=!0),y.formation.uiInfo.name=f,y.formation.uiInfo.left=`${g}`,y.formation.uiInfo.top=`${A}`;const $=y.formation.uiInfo.name,k=await y.toHTML($),O=f===z?y.toGridHTML():"";if(e){const M=y.createFormationBox(w,$,k,O);y.addEventHandlers(M),y.addItemEventkHandlers(async N=>{let D="",Z="";N.selectedImg===""?(D=p.selectedCh.iconFileName,Z=p.selectedCh.ns,N.selectCh=p.selectedCh):(D=N.item.ch.iconFileName,Z=N.item.ch.ns,N.selectCh=N.item.ch);const Ct=await n.getImageUrlBy(D,Z);if(Ct===null)return;N.selectedImg=Ct,N.item.isEmpty=!1,console.log(`selected ch = ${N.selectCh.name}`);const Ge=Xe.HiLv;P.combatPairs.get(Ge),N.uiName===B&&await P.replaceChar(Ge,j.Player,N.item,N.selectCh,n),N.uiName===z&&await P.replaceChar(Ge,j.Enemy,N.item,N.selectCh,n),await P.replaceJudge(n)},async N=>{const D=await n.getImageUrlBy(N.selectedImg,p.selectedCh.ns);if(D===null)return;N.selectedImg=D,N.item.isEmpty=!0,console.log(`empty ch = ${N.selectedImg}`);const Z=Xe.HiLv;P.combatPairs.get(Z),N.uiName===B&&await P.replaceChar(Z,j.Player,N.item,N.selectCh,n),N.uiName===z&&await P.replaceChar(Z,j.Enemy,N.item,N.selectCh,n),await P.replaceJudge(n)},async N=>{console.log(`selected ch = ${N.item.ch.name}`);const D=new Rt;D.selectCh=N.item.ch,D.selectedImg=N.selectedImg,D.scoreSet=N.scoreSet,S.charStock(D)},async N=>{const D=yt();console.log(D),await D.replaceJudge(n)}),y.enableLazyImages(n),M.show();const ge=new X;ge.setAsDlg(M,w),c.add(ge)}return y}const B="playerForm",z="enemyForm",$e=await R(B,100,100,"自編成"),Ee=await R(z,100,200,"敵編成");async function Ht(f,g,A,w){P.uiInfo.name=f,P.uiInfo.left=`${g}`,P.uiInfo.top=`${A}`;const y=await P.toHTML("combatTable",n),$=P.createCombatBox(w,f,y);P.enableLazyImages(n),await P.replaceJudge(n),$.show();const k=new X;k.setAsDlg($,w),c.add(k)}const P=yt();await Ht("combatForm",120,300,"対戦予想");const ht="保存";{const f=new X;f.setAsMenu(ht),c.add(f)}const mt="復帰";{const f=new X;f.setAsMenu(mt),c.add(f)}let xe=null;const Ft=await c.toHTML("dockForm",n);if(e){const f=c.createDockBox("dockForm",Ft);c.addItemClickHandlers(async g=>{c.stdApplyAction(g)!==!1&&g.item.isMenuType&&(g.item.toolTip===ht&&await Pt(),g.item.toolTip===mt&&await Ot(async w=>{if(console.log(`[loadedResult] ${w}`),w!==be.Success)return;const y=Q.fromJsonInst(Me),$=Q.fromJsonInst(ve);Me=null,ve=null,await $e.Setup(y,n),await Ee.Setup($,n)}))}),c.enableLazyImages(n),f.show(),xe=f}const dt="playerForm.json",ut="enemyForm.json",pt="dockForm.json";async function Pt(){c.InitZOrder(_);const f=Q.toJsonText($e.formation,$e.scsList),g=Q.toJsonText(Ee.formation,Ee.scsList),A=ze.toJsonText(c),w=new window.JSZip;w.file(dt,f),w.file(ut,g),w.file(pt,A);const y=await w.generateAsync({type:"blob"}),$="gameConfig.zip",k=URL.createObjectURL(y),O=document.createElement("a");O.href=k,O.download=$,O.click(),URL.revokeObjectURL(k),console.log("saved!")}let ft=null,Me=null,ve=null;async function Ot(f){const g=document.createElement("input");return g.type="file",g.accept=".zip",g.addEventListener("cancel",()=>(console.log("Cancelled."),be.Cancel)),g.addEventListener("change",async()=>{if(g.files.length==1){console.log("File selected: ",g.files[0].name);const w=await g.files[0].arrayBuffer(),$=await new window.JSZip().loadAsync(w);async function k(M){const ge=$.file(M);if(ge){const N=await ge.async("string"),D=JSON.parse(N);return console.log(D),D}}{const M=await k(pt);M&&(ft=M)}{const M=await k(dt);M&&(Me=M)}{const M=await k(ut);M&&(ve=M)}const O=ft!==null&&Me!==null&&ve!==null?be.Success:be.Fail;f(O)}}),g.click(),be.Unknown}const _=new C;e&&(_.AddDialogs(),_.AssignIndexies(),await _.LoadAllSetting(),await _.loadSetting(xe),c.InitZOrder(_),await _.ForEachAsync(f=>{const g=W.FindDialogParent(f);return g!==null&&(m.isLocal||f==="charListArea"?g.hidden=!1:g.hidden=!0),!0}),xe!==null&&(xe.parentElement.hidden=!m.isLocal)),o.hideFullScreenCss(l);function gt(f){const g=new rt,A=new at,w=f.formation;w.uiInfo.name,w.uiInfo.name,f.scsList===void 0&&console.log(`[${f.formation.uiInfo.name}] 対戦予想結果の作成は工事中です`);let y=0;for(const $ of w.items){if(f.scsList===void 0)continue;const k=f.scsList[y];y++;const O=Math.ceil(k.stdScore),M=new At($.ch.id,$.ch.name,$.isEmpty,O);M.allAvailable=k.allAvailable,A.Add(M)}return g.Add(A),g.debug(),g}function yt(){const f=new ms,g=gt($e),A=gt(Ee),w=new st;w.setScoreItems(g.groupRows[0].columns),w.boost=100;const y=new st;y.setScoreItems(A.groupRows[0].columns),y.boost=100;const $=new hs;$.setPlayer(w),$.setEnemy(y),f.setPair(Xe.HiLv,$),f.calcCombatScore();for(const[k,O]of f.combatPairs){const M=O.judge(G.None);console.log(`judge=[${M}]`)}return f}}async function ds(m){if(!m.isWebRunning)return;const e=m.isWebRunning;console.log(`mode=${m.edit}`);const t=new qe;async function s(){const u=re.Resource,d=new wt;d.init(),await d.load(u,J.none),d.uiInfo.name="ResourceEdit",d.uiInfo.left="110",d.uiInfo.top="10";const p=d.uiInfo.name,E=await d.toHTML(d.makeResEditItems(),d.makeResLog);if(e){const S=document.createElement("div");S.id=d.uiInfo.name,S.className=d.uiInfo.name,document.body.appendChild(S);const R="文字列リソース",B=d.createEditorBox(R,p,E);d.addEventHandlers(B),d.addItemEventHandlers(),B.show(),d.enableResize();const z=new X;z.setAsDlg(B,R),t.add(z)}return d}async function i(){const u=re.ScoreUI,d=new wt;d.init(),await d.load(u,m.edit),d.uiInfo.name="ScoreEdit",d.uiInfo.left="110",d.uiInfo.top="100";const p=d.uiInfo.name,E=await d.toHTML(d.makeScoreEditItems(),d.makeScoreLog);if(e){const S=document.createElement("div");S.id=d.uiInfo.name,S.className=d.uiInfo.name,document.body.appendChild(S);const R="スコア設定",B=d.createEditorBox(R,p,E);d.addEventHandlers(B),d.addItemEventHandlers(),B.show(),d.enableResize();const z=new X;z.setAsDlg(B,R),t.add(z)}return d}(await s()).startAutoSave(),(await i()).startAutoSave();const l=document.createElement("div"),a="dockEdit";l.id=a,l.className=a,document.body.appendChild(l);let r=null;const c=await t.toHTML(a,null);if(e){const u=t.createDockBox(a,c);t.addItemClickHandlers(async d=>{t.stdApplyAction(d)}),u.show(),r=u}const h=new C;e&&(h.AddDialogs(),h.AssignIndexies(),await h.LoadAllSetting(),await h.loadSetting(r),t.InitZOrder(h),await h.ForEachAsync(u=>{const d=W.FindDialogParent(u);return d!==null&&(m.isLocal||u==="charListArea"?d.hidden=!1:d.hidden=!0),!0}),r!==null&&(r.parentElement.hidden=!m.isLocal))}const v=new Se,Dt=v.isWebRunning;Dt?(ps(),v.parseURLParams(),v.currentUserHome===""&&v.setUser(v.user1Home)):v.setUser(v.user2Home);const ct=window.EVONA_CONFIG.isLocal;v.setPath();U.encodeEnable=!ct;v.setImageHome(ct);const us=fs(ct);v.currentUserHome;v.statusJsonPath;v.zipPrefix;v.chListFile;v.chStatusListFile;switch(v.admin){case!0:await qt(v);break;case!1:if(Dt)if(v.edit===J.none){let m=!1,e=!1;const t=new de;t.CheckVisible=!0,t.CheckText="位置情報を初期化",t.SecretEnable=!0;const s=v.setBrowserTitle();await t.showWait(`「${s} 」モードで起動します`)===I.Secret&&(e=!0),m=t.Checked,console.log(`secretMode=[${e}]`),console.log(`cleanMode=[${m}]`),m&&(await(await zt()).clear(),await(await le()).clear()),e?(window.EVONA_CONFIG.demo=!1,await Nt(v)):us&&await Nt(v)}else v.setBrowserTitle(),await ds(v);break}function ps(){const m=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.hostname.startsWith("192.168."),e=m?"./jszip_dist/jszip.min.js":"https://cdn.jsdelivr.net/npm/jszip@3.10.1/dist/jszip.min.js",t=m?"./jsstore_dist/jsstore.min.js":"https://cdn.jsdelivr.net/npm/jsstore/dist/jsstore.min.js";window.EVONA_CONFIG={isLocal:m,workerFile:"./jsstore_dist/jsstore.worker.min.js",demo:!m};function s(i,n=!1){const o=document.createElement("script");o.src=i,n&&(o.type="module"),o.async=!1,document.head.appendChild(o)}s(e),s(t)}function fs(m){if(m)return!0;const e=document.referrer;console.log(`${e}`);const t="evona_auth",s="granted";return sessionStorage.getItem(t)===s?!0:e.includes("qiita.com")?(sessionStorage.setItem(t,s),!0):!1}
