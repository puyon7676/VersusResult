...
`);let i=0;for(const o of e.rows){const a=n[i].split("	"),r=this.getCellElems(o);if(r===null)return!1;if(a.length!==r.length)return console.log(`different column size : line ${i+1}`),!1;i++}i=0;for(const o of e.rows){const a=n[i].split("	"),r=this.getCellElems(o);if(r===null)return!1;let c=0;for(const h of r){let u=a[c];if(u.startsWith("&")!==!1&&u.endsWith("&")!==!1&&(u=u.substring(1,u.length-1),u!=="null")){for(const d of h){this.setElemValue(d,u);break}c++}}i++}return!0}getTable(){const e=`.${this.tableName}`,t=document.querySelectorAll(e);if(t===null||t.length<=0)return null;const n=t[0].querySelectorAll(e);return n===null||n.length<=0?null:n[0]}HorzCSS(e){return`
.${e} {
  width: 1000px;
...
}`}}class Bt{constructor(){this.htmlMaker=new v,this.table=new q,this.gridElem=null,this.headerElem=null,this.footerElem=null}makeKeyCell(e,t,s){const n=new ft;return n.typeInfo.setLabel(e,!1),n.className=t,n.typeInfo.toolTip=s,n}makePair(){return new Map}setPair(e){if(e.size===0)return!1;this.table.makeDim(2,e.size),e.forEach((s,n)=>{this.table.growCell(1,s.items.length)});let t=-1;return e.forEach((s,n)=>{t++,this.table.getCell(0,t).typeInfo.setLabel(n.typeInfo.using.label,!1),this.table.getCell(0,t).className=n.className;let i=-1;for(const o of s.items)i++,this.table.getCell(1,t,i).typeInfo=o.typeInfo,this.table.getCell(1,t,i).className=o.className}),!0}setListener(e,t,s,n="",i=""){this.dispose(),this.table.makeRowTemplate(t);const o=document.getElementById(s);if(o===null)return console.log(`[setListener] cannot found ${s}`),!1;const l=this.table.ToScrollHTML(e,e),a=new D;a.props.name="",a.props.id=e,a.props.className=e,a.props.option.setTable(l),a.props.option.onSelect=async h=>{console.log(`classify = ${h.classify} targetId = ${h.targetId}`),this.onSelect!==void 0&&await this.onSelect(h)},this.htmlMaker=new v,this.htmlMaker.add(a);const r=this.htmlMaker.ToHTML();let c=document.createElement("div");return c.className=e,c.innerHTML=r,this.gridElem=c.children[0],n!==""&&(this.headerElem=document.createElement("div"),this.headerElem.className=n,this.headerElem.id=n,o.appendChild(this.headerElem)),o.appendChild(this.gridElem),c.remove(),c=null,i!==""&&(this.footerElem=document.createElement("div"),this.footerElem.className=i,this.footerElem.id=i,o.appendChild(this.footerElem)),!0}getSelectedRow(){return this.table.getSelectedRow()}enableEvents(e){return this.gridElem===null?!1:(this.htmlMaker.enableTableEvents(this.gridElem.className),this.onSelect=e,!0)}disableEvents(){return this.gridElem===null?!1:(this.htmlMaker.disableTableEvents(this.gridElem.className),!0)}setVisible(e){return this.gridElem===null?!1:(this.gridElem.hidden=!e,!0)}dispose(){this.headerElem!==null&&(this.headerElem.parentElement?.removeChild(this.headerElem),this.headerElem.remove()),this.footerElem!==null&&(this.footerElem.parentElement?.removeChild(this.footerElem),this.footerElem.remove()),this.gridElem!==null&&(this.gridElem.parentElement?.removeChild(this.gridElem),this.gridElem.remove()),this.disableEvents(),this.headerElem=null,this.footerElem=null,this.gridElem=null}}class gt{constructor(){this.ctlName="",this.ovElem=null}firstAction(e,t){const s=document.getElementById(t);return s===null?(console.log(`[firstAction] cannot found ${t}`),null):(this.createOverlay(s),this.ctlName=e,s)}createOverlay(e){const t=document.createElement("div");t.id=`${this.ovCssName()}`,t.style.position="absolute",t.style.inset="0",t.style.zIndex=this.zIndexOv(),t.style.background="transparent",t.style.background="rgba(0,0,0,0.1)",e.appendChild(t),this.ovElem=t}getBaseElem(){return this.ovElem!==null?this.ovElem.parentElement:null}getOuterCssText(){return`
.${this.ctlName} {
  position: absolute;
  inset: auto;
...
padding: 1px;
        `.trim()}dispose(){this.ovElem!==null&&(this.ovElem.parentElement?.removeChild(this.ovElem),this.ovElem.remove())}ovCssName(){return`${this.ctlName}-barrier`}zIndexCtl(){return"1000"}zIndexOv(){return"999"}}const ke={ByText:"ByText",ByValue:"ByValue",Both:"Both"};class At extends gt{constructor(){super(...arguments),this.ctlName="",this.initValue="",this.selectedIndex=-1,this.delimiter="/",this.callerName="",this.htmlMaker=new v,this.table=new q,this.ctlElem=null,this.onUpAction=async()=>{this.keyValuePairs!==void 0&&(this.selectedIndex=this.selectedIndex<=0?this.keyValuePairs.length-1:this.selectedIndex-1,this.updateValueElemByKeyValue(this.keyValuePairs[this.selectedIndex]))},this.onDnAction=async()=>{this.keyValuePairs!==void 0&&(this.selectedIndex=this.selectedIndex>=this.keyValuePairs.length-1?0:this.selectedIndex+1,this.updateValueElemByKeyValue(this.keyValuePairs[this.selectedIndex]))}}setListener(e,t,s){this.dispose(),this.callerName=s,this.ctlName=e;const n=new q;n.makeDim(1,3);let i=0;n.getCell(0,i).typeInfo.setButton("▲"),n.getCell(0,i).className=this.upCssName(),n.getCell(0,i).typeInfo.using.itemId=i,i++,n.getCell(0,i).typeInfo.setButton(""),n.getCell(0,i).className=this.valCssName(),n.getCell(0,i).typeInfo.using.itemId=i,i++,n.getCell(0,i).typeInfo.setButton("▼"),n.getCell(0,i).className=this.dwCssName(),n.getCell(0,i).typeInfo.using.itemId=i;const o=this.firstAction(e,t);if(o===null)return!1;const l=n.ToScrollHTML(e,e),a=new D;a.props.name="",a.props.id=this.tblCssName(),a.props.className=this.tblCssName(),a.props.option.setTable(l),a.props.option.onSelect=async d=>{switch(d.classify){case this.valCssName():if(this.onApply!==void 0){const p=new Me;p.callerName=this.callerName,p.result=this.keyValuePairs[this.selectedIndex],await this.onApply(p)}break;case this.upCssName():if(this.onUp!==void 0){const p=new Me;p.callerName=this.callerName,p.result=this.keyValuePairs[this.selectedIndex],await this.onUp(p),d.cancel||this.onUpAction()}break;case this.dwCssName():if(this.onDown!==void 0){const p=new Me;p.callerName=this.callerName,p.result=this.keyValuePairs[this.selectedIndex],await this.onDown(p),d.cancel||this.onDnAction()}break}},this.htmlMaker=new v,this.htmlMaker.add(a);const r=this.htmlMaker.ToHTML();let c=document.createElement("dialog");c.className=e,c.innerHTML=r,this.ctlElem=c;let h=c.children[0],u=h.children[0];return u.className=`${this.tblCssName()}`,u.id=`${this.tblCssName()}`,this.ctlElem.appendChild(u),h.remove(),h=null,o.appendChild(this.ctlElem),this.table=n,!0}setSelectedByValue(e,t,s=ke.Both){const n=new Array;switch(s){case ke.ByText:n.push(0);break;case ke.ByValue:n.push(1);break;case ke.Both:n.push(0),n.push(1);break;default:return!1}this.initValue=e,this.keyValuePairs=t,this.selectedIndex=-1;const i=e.split(this.delimiter);let o=i.length>=2?i[1]:e,l="";for(const a of n){let r=-1;for(const c of t)if(r++,c!==null&&c!==""){const h=c.split(this.delimiter);if(h.length>=2&&h[a]===o){this.selectedIndex=r,l=h[0];break}}if(this.selectedIndex!==-1)break}if(this.selectedIndex===-1){const r=t[0].split(this.delimiter);this.selectedIndex=0,l=r[0]}return this.updateValueElemByText(l),this.selectedIndex!==-1}show(e,t){this.ctlElem!==null&&(this.ctlElem.style.left=`${e}px`,this.ctlElem.style.top=`${t}px`,this.ctlElem.show())}applyCss(){const e=`${this.getBaseElem().className}-updn-style`;if(document.getElementById(e))return;const t=document.createElement("style");t.id=e,t.textContent=`
...
width: 100%;
        ...
        `.trim(),document.head.appendChild(t)}enableEvents(e){return this.ctlElem===null?!1:(this.htmlMaker.enableTableEvents(this.ctlElem.className),this.onSelect=e,!0)}disableEvents(){return this.ctlElem===null?!1:(this.htmlMaker.disableTableEvents(this.ctlElem.className),!0)}setVisible(e){return this.ctlElem===null?!1:(this.ctlElem.hidden=!e,!0)}dispose(){super.dispose(),this.ctlElem!==null&&(this.ctlElem.parentElement?.removeChild(this.ctlElem),this.ctlElem.remove()),this.disableEvents(),this.ctlElem=null}tblCssName(){return`${this.ctlName}-tbl`}}class Ft{constructor(){this.itemType=x.Img,this.itemId=-1,this.label="",this.innerHTML=""}}class yt{constructor(){this.toolTip="",this.using=new Ft}setButton(e){this.using.itemType=x.Btn,this.using.label=e}setLabel(e,t){this.using.itemType=t?x.Label:x.LabelRO,this.using.label=e}setCombo(e){this.using.itemType=x.Combo,this.using.combo=e}setInput(e){this.using.itemType=x.Input,this.using.input=e}setImg(e){this.using.itemType=x.Img,this.using.img=e}setPlain(e){this.using.itemType=x.Plain,this.using.innerHTML=e}setTable(e){this.using.itemType=x.Table,this.using.innerHTML=e}ToButtonHTML(e){const t=this.using.itemId>=0?` item-id="${this.using.itemId}"`:"";return`
...
<img class="${e}" ${s} alt="${t}">
`.trim()}ToOverlayHTML(){return`<div class="overlay" title="${this.toolTip}"></div>`}}class Ut{constructor(){this.name="",this.id="",this.className="",this.option=new yt}}class D{constructor(){this.props=new Ut}ToHTML(e){let t="",s="";switch(e.option.using.itemType){case x.Label:t=e.option.ToLableHTML(e.className),s=e.option.ToOverlayHTML();break;case x.LabelRO:t=e.option.ToLableROHTML(e.className);break;case x.Plain:t=`
...
`.trim(),document.head.appendChild(o);const l=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,l)}itemCssClassName(){return`${this.listName}-item`}imgCssClassName(){return`${this.listName}-img`}listCssClassName(){return`${this.listName}-list`}dlgCssClassName(){return`${this.parentName}-dlg`}static GetDialogInfo(e){return V.GetDialogInfo(e)}static SetDialogInfo(e){return V.SetDialogInfo(e)}async InitZOrder(e){await e.ForEachAsync(t=>{const s=et.GetDialogInfo(t),n=e.FindByName(t);return s!==null&&(s.zindex=n!==null?n.style.zIndex:""),console.log(s),!0})}}class Vt{constructor(){this.cancel=!1}}class He{constructor(){this.dockType=Q.None,this.iconFileName="",this.toolTip="",this.dlgName="",this.hidden=!1,this.zIndex="",this.topPx="",this.leftPx=""}static toJsonText(e){const t=He.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new He;return t.dockType=e.dockType,t.iconFileName=e.iconFileName,t.toolTip=e.toolTip,e.isUIType&&(t.dlgName=e.dlgParent.id,t.hidden=typeof e.dlgParent.hidden=="string"?!1:e.dlgParent.hidden,t.zIndex=e.dlgParent.style.zIndex,t.leftPx=e.dlgParent.style.left,t.topPx=e.dlgParent.style.top),t}}class De{static toJsonText(e){const t=De.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new De;t.items=new Array;for(const s of e.items)t.items.push(He.toJsonInst(s));return t}restore(e,t){for(const s of this.items){const n=e.items.find(i=>i.dlg.id===s.dlgName);n&&(n.dockType=s.dockType,n.iconFileName=s.iconFileName,n.toolTip=s.toolTip,n.isUIType&&(n.dlgParent.hidden=typeof s.hidden=="string"?!1:s.hidden,n.dlgParent.style.zIndex=s.zIndex,n.dlgParent.style.left=s.leftPx,n.dlgParent.style.top=s.topPx))}t.ReOrder()}}class ze{constructor(){this.chUuid="",this.ch=new se}}class qt{constructor(){this.chList=new Array,this.uiInfo=new re,this.parentName="",this.editingRowIndex=-1,this.scoreGrid=new Bt,this.onSelect=async e=>{console.log(`classify = ${e.classify} selectedValue = ${e.selectedValue} targetId = ${e.targetId}`);const t=this.editingCh;if(t===null)return;const n=t.scoreSet.items.find(i=>i.key===e.classify);n&&(n.selectedVal=e.selectedValue)},this.savedScoreSet=new O,this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new b().SaveSetting(e)}}async load(){const t=await(await ae()).get(W.CharSummaryAction);if(t===null)return;const s=new Map;for(const n of t){const i=Ee.fromJsonText(n);if(console.log(i.logType),console.log(i.ch),console.log(i.scoreSet),i.chUuid==="")continue;let o=!1,l=!1;switch(i.logType){case G.None:break;case G.Add:o=!0;break;case G.Update:s.has(i.chUuid)?o=!0:o=!1;break;case G.Delete:o=!0,l=!0;break}o&&(l?s.has(i.chUuid)&&s.delete(i.chUuid):(s.has(i.chUuid)&&s.delete(i.chUuid),s.set(i.chUuid,n)))}this.chList=new Array;for(const[n,i]of s){const o=Ee.fromJsonText(i),l=new se;l.ns=o.ch.ns,l.id=o.ch.id,l.name=o.ch.name,l.contentURL=o.ch.contentURL,l.iconURL=o.ch.iconURL,l.idAsText=o.ch.idAsText,l.idAttributeForHTML=o.ch.idAttributeForHTML;const a=new O;O.copy(o.scoreSet,a,!0);const r=new ze;r.chUuid=o.chUuid,r.ch=l,r.scoreSet=a,this.chList.push(r)}}async updateCharInfos(e){let t=this.table.firstRowIndex-1;for(const s of this.chList){t++;const n=await e.getImageUrlBy(s.ch.iconFileName,s.ch.ns);n!==null&&this.table.updateRowImage(t,n),this.updateChScoreInfo(t)}this.table.redimAllRows(),t=this.table.firstRowIndex,this.table.selectRow(t),this.table.scroll(t)}setRow(e,t,s){let n=0;const i=new Qe;i.imgFile=e.iconFileName,s.getCell(n,t).typeInfo.setImg(i),s.getCell(n,t).className=this.itemIconCssClassName();const o=`${e.name} Lv.1 [ATK:1]`;s.getCell(n,t,1).typeInfo.setLabel(o,!1),s.getCell(n,t,1).className=this.itemStatusCssClassName(),n++,s.getCell(n,t).typeInfo.setButton("更新"),s.getCell(n,t).className=this.itemUpdateCssClassName(),s.getCell(n,t).typeInfo.using.itemId=t,s.getCell(n,t,1).typeInfo.setButton("削除"),s.getCell(n,t,1).className=this.itemDeleteCssClassName(),s.getCell(n,t,1).typeInfo.using.itemId=t}toHTML(){if(!this.chList)return"";const e=new q;if(this.chList.length>=1)e.makeDim(2,this.chList.length),e.growCell(0,2),e.growCell(1,2),this.chList.forEach((i,o)=>{const l=i.ch;this.setRow(l,o,e)}),e.makeRowTemplate(this.tableRowCssClassName()),this.table=e;else{e.makeDim(2,1),e.growCell(0,2),e.growCell(1,2);const i=new se;this.setRow(i,0,e),e.makeRowTemplate(this.tableRowCssClassName()),e.clearRows(),this.table=e}const t=this.tableCssClassName(),s=this.table.ToScrollHTML(t,"");this.htmlMaker=new v;const n=new D;return n.props.name="",n.props.id="0",n.props.className=t,n.props.option.setTable(s),n.props.option.onSelect=async i=>{switch(console.log(`classify = ${i.classify} targetId = ${i.targetId}`),i.classify){case this.itemUpdateCssClassName():await this.onItemEdit(i);break;case this.itemDeleteCssClassName():await this.onItemDelete(i);break}},this.htmlMaker.add(n),this.htmlMaker.ToHTML()}createSummaryBox(e,t,s){this.parentName=t;let n=`
...
`.trim();const i=this.htmlMaker.MakeDefaultToolButtonsHTML(n),o=`<div class="${this.dlgContentCssClassName()}" id="${this.dlgContentCssClassName()}">
    ${i}
    ${s}
</div>`,l=new V;l.title="<"+e+">";const a=l.NewDialog(t,this.dlgCssClassName());return l.SetContent(t,o),this.applyCss(),l.EnableEventHandlers(),l.onMoveDone=this.moverOnMoveDone,a}addEventHandlers(e,t){this.onAdd=t,document.getElementById(`${this.itemAddCssClassName()}`).onclick=async()=>{if(this.onAdd===void 0)return;const s=new Ct;await this.onAdd(s),s.cancel!==!0&&await this.onItemAdd(s)}}createScoreGrid(e){const t=this.dlgContentCssClassName(),s="headerName",n="footerName",i="gridName",o="gridRowName",l="keyClassName",a="valueClassName",r=this.scoreGrid.makePair();for(const c of e.items){const h=c.title,u=c.title,d=this.scoreGrid.makeKeyCell(h,l,u),p=new Le;p.selectionPair=c.selectionPair,p.selectedItem=c.selectedVal,p.classify=c.key;const k=new Ke;k.makeItems(),k.items[0].typeInfo.setCombo(p),k.items[0].className=a,r.set(d,k)}if(this.scoreGrid.setPair(r),this.scoreGrid.setListener(i,o,t,s,n),this.scoreGrid.enableEvents(this.onSelect),this.scoreGrid.footerElem!==null){let c=`
<button id="${n}-okBtn">OK</button>
<button id="${n}-canBtn">CANCEL</button>
`.trim();this.scoreGrid.footerElem.innerHTML=c,document.getElementById(`${n}-okBtn`).onclick=async()=>{this.updateChScoreInfo(this.editingRowIndex);const h=this.editingCh;h!==null&&(h.scoreSet,this.addActionLog(h,G.Update),this.removeScoreGrid())},document.getElementById(`${n}-canBtn`).onclick=async()=>{const h=this.editingCh;if(h===null)return;const u=h.scoreSet;O.copy(this.savedScoreSet,u),this.removeScoreGrid()}}}removeScoreGrid(){if(this.scoreGrid.headerElem!==null){const e=this.editingRowIndex,t=this.table.getRowElem(e),s=this.table.getCellElems(t),n=this.scoreGrid.headerElem.children[0];s[0][0].appendChild(n)}this.scoreGrid!==null&&(this.scoreGrid.dispose(),this.htmlMaker.setVisible(this.itemAddCssClassName(),!0),this.table.setVisible(!0))}get editingCh(){const e=this.editingRowIndex;return e<this.table.firstRowIndex?null:this.chList[e-this.table.firstRowIndex]}async onItemAdd(e){const t=new le;t.setParent(this.dlgCssClassName());let s=N.None;if(t.setYesNo(),s=await t.showWait(`${e.selectCh.name} を追加しますか？`),s===N.No)return;const n=this.tableRowCssClassName(),i=this.table.addRow(n);if(i<this.table.firstRowIndex)return;this.table.selectRow(i),this.table.updateRowImage(i,e.selectedImg),this.table.scroll(i);const o=new ze;o.chUuid=Rt(),o.ch=e.selectCh,o.scoreSet=e.scoreSet,this.chList.push(o),this.updateChScoreInfo(i),this.addActionLog(o,G.Add)}async onItemEdit(e){const t=parseInt(e.targetId);if(t<this.table.firstRowIndex)return;this.editingRowIndex=t;const s=this.chList[t-this.table.firstRowIndex].scoreSet;this.savedScoreSet=new O,O.copy(s,this.savedScoreSet,!0),this.createScoreGrid(s),this.htmlMaker.setVisible(this.itemAddCssClassName(),!1),this.table.setVisible(!1);const n=this.table.getRowElem(t),o=this.table.getCellElems(n)[0][0].children[0];this.scoreGrid.headerElem?.appendChild(o)}async onItemDelete(e){const t=parseInt(e.targetId);if(t<this.table.firstRowIndex)return;const s=this.chList[t-this.table.firstRowIndex],n=new le;n.setParent(this.dlgCssClassName());let i=N.None;switch(n.setYesNo(),i=await n.showWait(`${s.ch.name} を削除しますか？`),i){case N.Yes:break;case N.No:return;case N.Cancel:return}this.addActionLog(s,G.Delete),t>=1&&(this.table.deleteRow(t),this.table.redimAllRows(),this.chList.splice(t-this.table.firstRowIndex,1))}async addActionLog(e,t){const s=new Ee;s.logType=t,s.chUuid=e.chUuid,s.ch=e.ch,s.scoreSet=e.scoreSet;const n=Ee.toJsonText(s);await(await ae()).put(W.CharSummaryAction,n)}updateChScoreInfo(e){const t=this.table.getRowElem(e);if(t===null)return;const s=this.table.getCellElems(t);if(s===null)return;const n=e-this.table.firstRowIndex,i=this.chList[n];let o="";for(const l of i.scoreSet.items){let a=l.selectedText;a=a===void 0?"*bug*":a;const r=`${l.title}:${a}`;o!==""&&(o=`${o}
`),o=`${o}${r}`}this.table.updateText(s[0][1],o)}addItemEventHandlers(){this.htmlMaker.enableEvents(this.tableCssClassName())}enableLazyImages(e){this.htmlMaker.initObserver(this.dlgCssClassName(),e)}async charStock(e){let t=this.table.getSelectedRow();const s=t!==this.table.invalidRowIndex,n=new le;n.setParent(this.dlgCssClassName());let i=N.None;s?(n.setYesNoCancel(),i=await n.showWait(`${e.selectCh.name} を更新しますか？`)):(n.setYesNo(),i=await n.showWait(`${e.selectCh.name} を追加しますか？`));let o=!1,l=!1;switch(i){case N.Yes:s?(o=!1,l=!0):(o=!0,l=!1);break;case N.No:s?(o=!0,l=!1):(o=!1,l=!1);break;case N.Cancel:return}let a=null;if(o){const r=this.tableRowCssClassName(),c=this.table.addRow(r);if(c>=0){const h=new ze;h.ch=e.selectCh,h.scoreSet=e.scoreSet,this.chList.push(h),t=c,this.table.selectRow(c),this.table.updateRowImage(c,e.selectedImg),this.table.scroll(c),a=this.table.getRowElem(c)}}if(l){const r=t-this.table.firstRowIndex,c=this.chList[r];c.scoreSet=e.scoreSet,this.tableRowCssClassName();const h=t;this.table.scroll(h),a=this.table.getRowElem(h)}if(a!==null){const r=this.table.getCellElems(a);if(r){const c=t-this.table.firstRowIndex,h=this.chList[c];let u="";for(const d of h.scoreSet.items){let p=d.selectedText;p=p===void 0?"*bug*":p;const k=`${d.title}:${p}`;u!==""&&(u=`${u}
`),u=`${u}${k}`}this.table.updateText(r[0][1],u)}}}itemIconCssClassName(){return`${this.tableCssClassName()}-icon`}itemStatusCssClassName(){return`${this.tableCssClassName()}-status`}itemAddCssClassName(){return`${this.tableCssClassName()}-add`}itemUpdateCssClassName(){return`${this.tableCssClassName()}-update`}itemDeleteCssClassName(){return`${this.tableCssClassName()}-delete`}tableRowCssClassName(){return"char-summary-table-row"}tableCssClassName(){return"char-summary-table"}dlgContentCssClassName(){return`${this.dlgCssClassName()}-content`}dlgCssClassName(){return"char-summary-dlg"}applyCss(){const e=parseInt(this.uiInfo.left),t=parseInt(this.uiInfo.top),s=document.createElement("style");s.textContent=`
...
`.trim(),document.head.appendChild(s);const n=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,n)}}class Ct{constructor(){this.cancel=!1}}const G={None:"None",Add:"Add",Delete:"Delete",Update:"Update"};class Ee{constructor(){this.logType=G.None,this.chUuid=""}static toJsonText(e){return JSON.stringify(e,null,2)}static fromJsonText(e){return JSON.parse(e)}}class jt{constructor(){this.TextMap=new Map}set(e,t){const s=this.TextMap.has(e);return this.TextMap.set(e,t),s}remove(e){const t=this.TextMap.has(e);return t&&this.TextMap.delete(e),t}get count(){return this.TextMap.size}clear(){this.TextMap.clear()}forEach(e){if(e===void 0)return;let t=!1;for(const[s,n]of this.TextMap)if(t=e(s,n),t)break;return t}values(){const e=new Map;for(const[t,s]of this.TextMap)e.set(t,parseInt(s));return e}}class bt{constructor(e=0,t=""){this.ch=new se,this.isEmpty=!0,this.details=new jt,this.ch.id=e,this.ch.name=t}set(e,t){const s=this.details.TextMap.has(e);return this.details.set(e,t),s}get values(){return this.details.values()}get itemID(){const e=this.itemKey,t=this.ch.idAttributeForHTML.substring(e.length);let s=parseInt(t);return s<=0?-1:s}get itemKey(){return"chuid"}}class wt{constructor(){this.nFormationItem=5,this.uiInfo=new re}Init(){this.items=new Array;for(let e=0;e<this.nFormationItem;e++)this.items.push(new bt)}put(e,t){return this.items.find(n=>this.isExistCh(n,t))!==void 0?!1:(e.ch.ns=t.ns,e.ch.id=t.id,e.ch.name=t.name,e.isEmpty=!1,!0)}empty(e){const t=e.isEmpty;return e.isEmpty=!0,e.isEmpty!=t}isExistCh(e,t){return e.ch.name===t.name&&e.ch.id===t.id}equalsFormationItem(e,t){return e.ch.name===t.ch.name&&e.ch.id===t.ch.id}}class Gt{constructor(){this.emptyFile="plus.png",this.propItemNum=0,this.parentName="",this.listName="",this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new b().SaveSetting(e)}}Init(e){this.charDB=e,this.formation=new wt,this.formation.Init(),this.scsList=new Array;const t=this.formation.nFormationItem;for(let s=0;s<t;s++){const n=new O;this.scsList.push(n)}}async Setup(e,t){if(!e)return;this.formation=e;let s=0;for(const n of this.formation.items){n.isEmpty?this.formation.empty(n):this.formation.put(n,n.ch),s++;const i=`${n.itemKey}${s}`;n.ch.idAttributeForHTML=i;const o=n.isEmpty?this.emptyFile:n.ch.iconFileName,l=await t.getImageUrlBy(o,n.ch.ns);if(l===null)return;this.htmlMakerChSel.ReplaceImg(this.itemCssClassName(),n.ch.idAttributeForHTML,l)}}async toHTML(e,t){if(!this.formation)return"";this.listName=e,this.htmlMakerChSel=new v;let s=0;for(const n of this.formation.items){const i=n.ch;s++;const o=`${n.itemKey}${s}`;i.idAttributeForHTML=o;const l="",a=n.isEmpty?this.emptyFile:i.iconFileName,r=new Qe;r.imgSrc=l,r.imgFile=a;const c=new D;c.props.name=this.itemCssClassName(),c.props.id=o,c.props.className=this.imgCssClassName(),c.props.option.setImg(r),c.props.option.toolTip=i.name,c.props.option.onSelect=h=>{console.log(`notifty id = ${h.item.props.id}`),this.setSelectedItem(h.item.props.id)},this.htmlMakerChSel.add(c)}return this.htmlMakerChSel.MakeScrollableList(this.listCssClassName())}toGridHTML2(){this.htmlMakerProp=new v;let e=0,t="";for(const s of this.formation.items){s.ch;const n=this.scsList[e];e++;const i=new q;i.makeDim(1,n.items.length*2);let o=-1;for(const r of n.items){o++;const c=new Le;c.selectionPair=r.selectionPair,c.selectedItem=r.selectedVal,c.classify=r.key,i.getCell(0,o*2).typeInfo.setLabel(r.title,!1);const u=i.getCell(0,o*2+1);u.className=this.propItemCssClassName(),u.typeInfo.setCombo(c),u.typeInfo.onSelect=d=>{console.log(`notifty id = ${d.item.props.id}`)}}const l=i.ToScrollHTML(this.propItemCssClassName(),`${e}`);t=`
${t}
${l}`.trim();const a=new D;a.props.id=`${e}`,a.props.option.onSelect=r=>{console.log(`notifty id = ${r.item.props.id}`)},this.htmlMakerProp.itemList.push(a)}return t}toGridHTML(){this.htmlMakerProp=new v;let e=0;for(const t of this.formation.items){t.ch;const s=this.scsList[e];e++;const n=new v;for(const l of s.items)this.makeChLvSelect(t,`${l.key}${e}`,l.title,l.key,l.selectionPair,l.selectedVal,n),t.details.set(l.key,l.selectedVal);const i=n.ToHTML(),o=new D;o.props.name="",o.props.id=`${e}`,o.props.className="",o.props.option.setPlain(i),o.props.option.onSelect=l=>{console.log(`notifty id     = ${l.item.props.id}`),console.log(` targetId      = ${l.targetId}`),console.log(` classify      = ${l.classify}`),console.log(` selectedValue = ${l.selectedValue}`);const a=l.item.props.id,r=parseInt(a)-1;if(0<=r&&r<this.formation.items.length){const c=this.formation.items[r];c.set(l.classify,l.selectedValue);const h=this.scsList[r];h.set(l.classify,l.selectedValue);const u=new Wt;u.uiName=this.parentName,u.item=c,u.values=c.values,u.scoreConfigSet=h,this.onPropChanged(u)}else console.log(`invalid index = ${r}`)},this.htmlMakerProp.add(o)}return this.htmlMakerProp.MakeScrollableList(this.propCssClassName())}makeChLvSelect(e,t,s,n,i,o,l){const a=new D;a.props.name=this.propItemCssClassName(),a.props.id=t,a.props.className=this.lblCssClassName(),a.props.option.setLabel(s,!1);const r=a.ToHTML(a.props),c=new D;c.props.name=this.propItemCssClassName(),c.props.id=t,c.props.className=this.lblCssClassName();const h=new Le;h.selectionPair=i,h.selectedItem=o,h.classify=n,c.props.option.setCombo(h);const u=c.ToHTML(c.props);let d=`
${r}
${u}
`.trim();const p=new D;p.props.name=this.propItemCssClassName(),p.props.id=t,p.props.className=this.lblCssClassName(),p.props.option.setPlain(d),l.add(p)}createFormationBox(e,t,s,n,i){this.parentName=t;let o="";i&&(o=`<button id="${this.dlgCssClassName()}-stock">キャラ保存</button>`);let l=`
...
`.trim(),document.head.appendChild(r);const c=document.getElementById(this.parentName);this.htmlMakerChSel.copyCssToInlineStyle(`.${this.parentName}`,c)}}class Je{constructor(){this.cancel=!1}}class Wt{constructor(){this.uiName="",this.cancel=!1}}class Be{constructor(){this.ch=new ee,this.isEmpty=!0,this.TextMap=""}static toJsonText(e){const t=ee.toJsonInst(e.ch);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new Be;t.ch=ee.toJsonInst(e.ch),t.isEmpty=e.isEmpty;const s=Object.fromEntries(e.details.TextMap);return t.TextMap=JSON.stringify(s,null,2),t}static fromJsonInst(e){const t=new bt;t.ch=ee.fromJsonInst(e.ch),t.isEmpty=e.isEmpty;const s=new Map(Object.entries(JSON.parse(e.TextMap)));return t.details.TextMap=s,t}}class te{static toJsonText(e){const t=te.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new te;t.items=new Array;for(const s of e.items)t.items.push(Be.toJsonInst(s));return t}static fromJsonInst(e){const t=new wt;t.items=new Array;for(const s of e.items)t.items.push(Be.fromJsonInst(s));return t}}class Nt{constructor(e=0,t="",s=!0,n=0){this.ch=new se,this.isEmpty=!0,this.score=0,this.allAvailable=!1,this.ch.id=e,this.ch.name=t,this.isEmpty=s,this.score=n}}class tt{Add(e){if(e===void 0){console.log("[VersusGroupRow::Add] scItem === undefined");return}this.columns===void 0&&(this.columns=[]),this.columns.push(e)}Count(){return this.columns.length}debug(){if(this.columns===void 0){console.log("[VersusGroupRow::debug] this.columns === undefined");return}for(const e of this.columns)console.log(`[${e.ch.name}]	score=[${e.score}]`)}}tt.defNumColumn=5;class st{Add(e){this.groupRows===void 0&&(this.groupRows=[]),this.groupRows.push(e)}Count(){return this.groupRows.length}debug(){if(this.groupRows===void 0)console.log("this.groupRows === undefined");else for(const e of this.groupRows)e.debug()}async loadJson(e){const n=(await new ge().loadJson(e)).groupRows.map(o=>Object.assign(new tt,o)),i=new st;return i.groupRows=n,i}}const J={None:"None",Player:"Player",Enemy:"Enemy"},z={None:"None",Attr:"Attr",Role:"Role"},Ve={HiLv:"HiLv"},F={Likely:"Likely",Uncertain:"Uncertain",Wishful:"Wishful"};class Ae{}Ae.Likely=.9;Ae.Uncertain=.64;class Ye{constructor(){this.scoreItems=[],this.formationType=J.None,this.boost=0}get imgPrefix(){return this.formationType===J.Player?"ftPlayer":"ftEnemy"}get judgeWidth(){return 48}setScoreItems(e){if(e!==void 0){this.scoreItems=new Array;for(const t of e){const s=new Nt(t.ch.id,t.ch.name,t.isEmpty,t.score);this.scoreItems.push(s)}}}async toCharHTML(e,t){const s=t.ch.ns===R.None?"":t.ch.ns,n=await e.getImageUrlBy(t.ch.iconFileName,s);let i=this.scoreToolTip(t);return i!==""&&(i=`title="${i}"`),`
<img class=${this.charCssClassName()}
  src="${n}"
  ${i}>
`.trim()}scoreToolTip(e){return e.isEmpty?"":`${e.ch.name}
score=${e.score}`}async toJudgeHTML(e,t){const s=this.toJudgeFileURL(e,t);return`<img class=${this.judgeCssClassName()} src="${s}" width="48">`}async toJudgeFileURL(e,t){let s=null;switch(t){case F.Likely:s=await e.getImageUrlBy("win.png",e.AnyNs);break;case F.Uncertain:s=await e.getImageUrlBy("even.png",e.AnyNs);break;case F.Wishful:s=await e.getImageUrlBy("lost.png",e.AnyNs);break;default:return""}return s}charCssClassName(){return"combat-char"}judgeCssClassName(){return"combat-judge"}get combatScore(){if(this.scoreItems===void 0)return 0;const e=this.scoreItems.reduce((s,n)=>n.isEmpty?s:s+n.score,0),t=this.boost===0?1:this.boost;return Math.ceil(e*t/100)}}class Kt{constructor(){this.hasCombo=!1,this.winRate=new Map}setPlayer(e){e.formationType=J.Player,this.player=e}setEnemy(e){e.formationType=J.Enemy,this.enemy=e}judge(e){const s=this.winRate.get(e);return s>=Ae.Likely?F.Likely:s>=Ae.Uncertain?F.Uncertain:F.Wishful}judgeForEnemy(e){switch(e){case F.Likely:return F.Wishful;case F.Uncertain:return F.Uncertain;case F.Wishful:return F.Likely}}}class Yt{constructor(){this.combatPairs=new Map,this.emptyFile="plus.png",this.parentName="",this.uiInfo=new re,this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new b().SaveSetting(e)}}setPair(e,t){this.combatPairs.set(e,t)}calcCombatScore(){for(const[e,t]of this.combatPairs){if(t.player===void 0||t.enemy===void 0)continue;const s=[z.None,z.Attr,z.Role];for(const n of s){let i=t.player.combatScore,o=t.enemy.combatScore;t.winRate.set(n,o!==0?i/o:1)}}}async replaceChar(e,t,s,n,i){const o=this.combatPairs.get(e);let l;if(t===J.Player?l=o?.player:t===J.Enemy&&(l=o?.enemy),l===void 0)return!1;const a=s.itemID;if(a<0)return!1;const r=a-1;l=l;const h=`${l.imgPrefix}${a}`,u=l.scoreItems[r],d=u.ch;s.isEmpty?(d.id=0,d.name="",console.log("set empty")):(d.id=n.id,d.name=n.name,console.log(`set char ${n.id}:${n.name}`)),u.isEmpty=s.isEmpty;const p=d.ns===R.None?"":d.ns,k=await i.getImageUrlBy(d.iconFileName,p);if(k===null)return!1;const B=new v,U=this.outerCssClassName();return B.ReplaceImg(U,h,k),B.ReplaceImgToolTip(U,h,l.scoreToolTip(u)),!0}async replaceJudge(e){async function t(i,o){const l=await i.toJudgeFileURL(e,o);if(l===null)return;const a=i.imgPrefix;for(let r=0;r<i.scoreItems.length;r++){const c=`${a}${r+1}`,h=s.FindImgsByID(n,c);if(h===null||h.length<=1){console.error("fail on judge marker");continue}const u=h[1];s.SetImgSrc(u,l),i.scoreItems[r].isEmpty?s.SetImgSize(u,0,0):s.SetImgSize(u,i.judgeWidth,i.judgeWidth);const d=i.scoreItems[r];s.ReplaceImgToolTip(n,c,i.scoreToolTip(d))}}const s=new v,n=this.outerCssClassName();for(const[i,o]of this.combatPairs){if(o.player===void 0||o.enemy===void 0)continue;const l=[z.None,z.Attr,z.Role];for(const a of l){if(a!==z.None)continue;const r=o.judge(a),c=o.judgeForEnemy(r);await t(o.player,r),await t(o.enemy,c)}}}async toHTML(e,t){const s=document.createElement("table");s.id=e;const n=document.createElement("tbody");s?.appendChild(n);async function i(l,a){const r=document.createElement("tr");n?.appendChild(r);const c=await a.toJudgeHTML(t,l),h=a.imgPrefix;let u=0;for(const d of a.scoreItems){u++;const p=await a.toCharHTML(t,d),k=`
<div class=${o} item-id="${h}${u}">
    ${p}
    ${c}
</div>
`.trim(),B=document.createElement("td");B.innerHTML=k,r.appendChild(B)}}const o=this.outerCssClassName();for(const[l,a]of this.combatPairs){const r=a.judge(z.None),c=a.judgeForEnemy(r);await i(r,a.player),await i(c,a.enemy)}return s.outerHTML}createCombatBox(e,t,s){this.parentName=t,this.htmlMaker=new v;const n=`<div class="${this.parentName}-dlg-content">
    ${s}
</div>`,i=new V;i.title="<"+e+">";const o=i.NewDialog(t,this.dlgCssClassName());return i.SetContent(t,n),this.applyCss(),i.EnableEventHandlers(),i.onMoveDone=this.moverOnMoveDone,o}enableLazyImages(e){this.htmlMaker.initObserver(this.dlgCssClassName(),e)}processResult(e,t,s){async function n(o,l){const a=t(l.formationType),r=await l.toJudgeHTML(e,o),c=l.imgPrefix;let h=0;for(const u of l.scoreItems){h++;const d=await l.toCharHTML(e,u),p=`
<div class=${i} item-id="${c}${h}">
    ${d}
    ${r}
</div>
`.trim();s(a,p)}}const i=this.outerCssClassName();for(const[o,l]of this.combatPairs){const a=l.judge(z.None),r=l.judgeForEnemy(a);n(a,l.player),n(r,l.enemy)}}outerCssClassName(){return"combat-outer"}dlgCssClassName(){return`${this.parentName}-dlg`}applyCss(){const e=new Ye,t=`.${this.outerCssClassName()}`,s=`.${e.charCssClassName()}`,n=`.${e.judgeCssClassName()}`,i=parseInt(this.uiInfo.left),o=parseInt(this.uiInfo.top),l=document.createElement("style");l.textContent=`
...
`.trim(),document.head.appendChild(l);const a=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,a)}}const me={Unknown:"Unknown",Success:"Success",Fail:"Fail",Cancel:"Cancel"};async function Xt(m){const e=m.isWebRunning,t=m.currentUserHome,s=m.chStatusListFile,n=m.chListFile,i=new Dt,o=new v,l="splash-screen";o.initFullScreen(l,"エボナ データベース初期化中..."),o.applyFullScreenCss(l);const a=o.getFullScreenMsgElem(l),r=a!==null?a.innerHTML:"";if(t===m.user1Home){const g=[{ns:R.CnsRed,nsName:"赤属性"},{ns:R.CnsBlue,nsName:"青属性"},{ns:R.CnsGreen,nsName:"緑属性"},{ns:R.CnsYellow,nsName:"黄属性"},{ns:R.CnsViolet,nsName:"紫属性"}],S=await new fe().LoadList(n);for(const w of g)a!==null&&(a.innerHTML=`${r} ${w.nsName}`),await i.setupNs(w.ns,m,S)}if(t===m.user2Home){const g=[{ns:R.CnsBlue,nsName:"藍属性"},{ns:R.CnsRed,nsName:"紅属性"},{ns:R.CnsGreen,nsName:"翠属性"},{ns:R.CnsYellow,nsName:"黄属性"},{ns:R.CnsWhite,nsName:"天属性"},{ns:R.CnsBlack,nsName:"冥属性"}],S=await new fe().LoadList(n);for(const w of g)a!==null&&(a.innerHTML=`${r} ${w.nsName}`),await i.setupNs(w.ns,m,S)}a!==null&&(a.innerHTML="UI 初期化中 ...");const c=new et,h=new Pe;await h.loadDB(s);async function u(){async function g(){return await new fe().LoadList(n)}const f=await g();f.uiInfo.name="charListArea",f.uiInfo.left="300",f.uiInfo.top="100";const S=f.uiInfo.name,w=await f.toHTML(i);if(e){const E="キャラ選択",y=f.createSelectorBox(E,S,w);f.addEventHandlers(y),f.addItemEventHandlers(),f.enableLazyImages(i),y.show();const $=new ie;$.setAsDlg(y,E),c.add($)}return f}const d=await u();async function p(){const g=new qt;await g.load(),g.uiInfo.name="CharSummary",g.uiInfo.left="400",g.uiInfo.top="100";const f=g.uiInfo.name,S=await g.toHTML();if(e){const w="キャラ一覧",E=g.createSummaryBox(w,f,S);await g.updateCharInfos(i),g.addEventHandlers(E,async $=>{$.selectCh=d.selectedCh;const A=await i.getImageUrlBy(d.selectedCh.iconFileName,d.selectedCh.ns);if(A===null)$.selectedImg="",$.cancel=!0;else{$.selectedImg=A,$.cancel=!1;const L=await h.getStatus(d.selectedCh.idAsText);console.log(L),$.scoreSet=L}console.log(`selected ch = ${$.selectCh.name}`)}),g.addItemEventHandlers(),g.enableLazyImages(i),E.show();const y=new ie;y.setAsDlg(E,w),c.add(y)}return g}const k=await p();async function B(g,f,S,w,E){const y=new Gt;y.Init(h),y.formation.uiInfo.name=g,y.formation.uiInfo.left=`${f}`,y.formation.uiInfo.top=`${S}`;const $=y.formation.uiInfo.name,A=await y.toHTML($,i),L=y.toGridHTML();if(e){const ne=y.createFormationBox(w,$,A,L,E);y.addEventHandlers(ne),y.addItemEventkHandlers(async I=>{I.selectCh=d.selectedCh;const P=await i.getImageUrlBy(d.selectedCh.iconFileName,d.selectedCh.ns);if(P===null)return;I.selectedImg=P,I.item.isEmpty=!1,console.log(`selected ch = ${I.selectCh.name}`);const Y=Ve.HiLv;H.combatPairs.get(Y),I.uiName===U&&await H.replaceChar(Y,J.Player,I.item,I.selectCh,i),I.uiName===j&&await H.replaceChar(Y,J.Enemy,I.item,I.selectCh,i),await H.replaceJudge(i)},async I=>{const P=await i.getImageUrlBy(I.selectedImg,d.selectedCh.ns);if(P===null)return;I.selectedImg=P,I.item.isEmpty=!0,console.log(`empty ch = ${I.selectedImg}`);const Y=Ve.HiLv;H.combatPairs.get(Y),I.uiName===U&&await H.replaceChar(Y,J.Player,I.item,I.selectCh,i),I.uiName===j&&await H.replaceChar(Y,J.Enemy,I.item,I.selectCh,i),await H.replaceJudge(i)},async I=>{console.log(`selected ch = ${I.item.ch.name}`);const P=new Ct;P.selectCh=I.item.ch,P.selectedImg=I.selectedImg,P.scoreSet=I.scoreSet,k.charStock(P)},async I=>{const P=ht();console.log(P),await P.replaceJudge(i)}),y.enableLazyImages(i),ne.show();const we=new ie;we.setAsDlg(ne,w),c.add(we)}return y}const U="playerForm",j="enemyForm",Fe=await B(U,100,100,"自編成",!0),Ue=await B(j,100,200,"敵編成",!1);async function $t(g,f,S,w){H.uiInfo.name=g,H.uiInfo.left=`${f}`,H.uiInfo.top=`${S}`;const E=await H.toHTML("combatTable",i),y=H.createCombatBox(w,g,E);H.enableLazyImages(i),await H.replaceJudge(i),y.show();const $=new ie;$.setAsDlg(y,w),c.add($)}const H=ht();await $t("combatForm",120,300,"対戦予想");const nt="保存";{const g=new ie;g.setAsMenu(nt),c.add(g)}const it="復帰";{const g=new ie;g.setAsMenu(it),c.add(g)}let ye=null;const St=await c.toHTML("dockForm",i);if(e){const g=c.createDockBox("dockForm",St);c.addItemClickHandlers(async f=>{if(f.item.dlgParent===null){f.cancel=!0;return}console.log(`selected item = [${f.item.toolTip}::${f.item.dockType}]`),f.item.isUIType&&(new b().MoveHiestLayer(f.item.dlgParent),f.item.dlgParent.hidden&&(f.item.dlgParent.hidden=!1)),f.item.isMenuType&&(f.item.toolTip===nt&&await Et(),f.item.toolTip===it&&await xt(async S=>{if(console.log(`[loadedResult] ${S}`),S!==me.Success)return;const w=te.fromJsonInst(Ce),E=te.fromJsonInst(be);Ce=null,be=null,await Fe.Setup(w,i),await Ue.Setup(E,i)}))}),c.enableLazyImages(i),g.show(),ye=g}const ot="playerForm.json",lt="enemyForm.json",at="dockForm.json";async function Et(){c.InitZOrder(K);const g=te.toJsonText(Fe.formation),f=te.toJsonText(Ue.formation),S=De.toJsonText(c),w=new window.JSZip;w.file(ot,g),w.file(lt,f),w.file(at,S);const E=await w.generateAsync({type:"blob"}),y="gameConfig.zip",$=URL.createObjectURL(E),A=document.createElement("a");A.href=$,A.download=y,A.click(),URL.revokeObjectURL($),console.log("saved!")}let rt=null,Ce=null,be=null;async function xt(g){const f=document.createElement("input");return f.type="file",f.accept=".zip",f.addEventListener("cancel",()=>(console.log("Cancelled."),me.Cancel)),f.addEventListener("change",async()=>{if(f.files.length==1){console.log("File selected: ",f.files[0].name);const w=await f.files[0].arrayBuffer(),y=await new window.JSZip().loadAsync(w);async function $(L){const ne=y.file(L);if(ne){const we=await ne.async("string"),I=JSON.parse(we);return console.log(I),I}}{const L=await $(at);L&&(rt=L)}{const L=await $(ot);L&&(Ce=L)}{const L=await $(lt);L&&(be=L)}const A=rt!==null&&Ce!==null&&be!==null?me.Success:me.Fail;g(A)}}),f.click(),me.Unknown}const K=new b;e&&(K.AddDialogs(),K.AssignIndexies(),await K.LoadAllSetting(),await K.loadSetting(ye),c.InitZOrder(K),await K.ForEachAsync(g=>{const f=V.FindDialogParent(g);return f!==null&&(m.isLocal||g==="charListArea"?f.hidden=!1:f.hidden=!0),!0}),ye!==null&&(ye.parentElement.hidden=!m.isLocal)),o.hideFullScreenCss(l);function ct(g){const f=new st,S=new tt,w=g.formation;w.uiInfo.name,w.uiInfo.name;let E=0;for(const y of w.items){const $=g.scsList[E];E++;const A=Math.ceil($.stdScore),L=new Nt(y.ch.id,y.ch.name,y.isEmpty,A);L.allAvailable=$.allAvailable,S.Add(L)}return f.Add(S),f.debug(),f}function ht(){const g=new Yt,f=ct(Fe),S=ct(Ue),w=new Ye;w.setScoreItems(f.groupRows[0].columns),w.boost=100;const E=new Ye;E.setScoreItems(S.groupRows[0].columns),E.boost=100;const y=new Kt;y.setPlayer(w),y.setEnemy(E),g.setPair(Ve.HiLv,y),g.calcCombatScore();for(const[$,A]of g.combatPairs){const L=A.judge(z.None);console.log(`judge=[${L}]`)}return g}}class _t{constructor(){this.intervalMs=1e3,this.isOneShot=!0,this.intervalTimer=null}start(e,t){this.intervalTimer!==null&&this.clear(),this.intervalTimer=setTimeout(async()=>{t!==void 0&&(await t(e)||this.clear()),this.isOneShot===!0&&this.clear()},this.intervalMs)}clear(){clearTimeout(this.intervalTimer),this.intervalTimer=null}}const Z={Resource:"Resource",ScoreUI:"ScoreUI"},ve={Sequence:"Sequence",Text:"Text"};class It{constructor(){this.key="",this.text=""}}class Xe extends It{constructor(){super(...arguments),this.comment=""}}class _e extends It{constructor(){super(...arguments),this.selectType=ve.Sequence,this.start="",this.end="",this.step="",this.keyValue=""}}class xe{constructor(){this.resItem=new Xe,this.scItem=new _e}}class ut{constructor(){this.itemList=new Array,this.uiInfo=new re,this.parentName="",this.saveTimer=null,this.onSave=async e=>(console.log(`${e.parentName}`),!1),this.setColKey=(e,t,s,n)=>{const i=new X;i.value=t.owner.editorType==Z.Resource?t.resItem.key:t.scItem.key,i.placeholder="キー",n.getCell(e,s).typeInfo.setInput(i),n.getCell(e,s).className=this.itemKeyCssClassName(),n.getCell(e,s).typeInfo.using.itemId=s+n.firstRowIndex},this.setColValue=(e,t,s,n)=>{const i=new X;i.value=t.owner.editorType==Z.Resource?t.resItem.text:t.scItem.text,i.placeholder="文字列",n.getCell(e,s).typeInfo.setInput(i),n.getCell(e,s).className=this.itemDispCssClassName(),n.getCell(e,s).typeInfo.using.itemId=s+n.firstRowIndex},this.setColComment=(e,t,s,n)=>{const i=new X;i.value=t.resItem.comment,i.placeholder="コメント",n.getCell(e,s).typeInfo.setInput(i),n.getCell(e,s).className=this.itemCommentCssClassName(),n.getCell(e,s).typeInfo.using.itemId=s+n.firstRowIndex},this.setColSelectType=(e,t,s,n)=>{const i=new Le;i.selectionPair=[`連続/${ve.Sequence}`,`文字列/${ve.Text}`],i.selectedItem=ve.Sequence,i.classify="selectType",n.getCell(e,s).typeInfo.setCombo(i),n.getCell(e,s).className=this.itemSelectTypeCssClassName(),n.getCell(e,s).typeInfo.using.itemId=s+n.firstRowIndex},this.setColSelectStart=(e,t,s,n)=>{const i=new X;i.value=t.scItem.start,i.placeholder="開始",n.getCell(e,s).typeInfo.setInput(i),n.getCell(e,s).className=this.itemSeqTypeStartCssClassName(),n.getCell(e,s).typeInfo.using.itemId=s+n.firstRowIndex},this.setColSelectEnd=(e,t,s,n)=>{const i=new X;i.value=t.scItem.end,i.placeholder="終了",n.getCell(e,s).typeInfo.setInput(i),n.getCell(e,s).className=this.itemSeqTypeEndCssClassName(),n.getCell(e,s).typeInfo.using.itemId=s+n.firstRowIndex},this.setColSelectStep=(e,t,s,n)=>{const i=new X;i.value=t.scItem.step,i.placeholder="ステップ",n.getCell(e,s).typeInfo.setInput(i),n.getCell(e,s).className=this.itemSeqTypeStepCssClassName(),n.getCell(e,s).typeInfo.using.itemId=s+n.firstRowIndex},this.setColText=(e,t,s,n)=>{const i=new X;i.value=t.scItem.keyValue,i.placeholder="key/valueを&quot;,&quot;で区切った文字列",n.getCell(e,s).typeInfo.setInput(i),n.getCell(e,s).className=this.itemTextTypeCssClassName(),n.getCell(e,s).typeInfo.using.itemId=s+n.firstRowIndex},this.setColDelBtn=(e,t,s,n)=>{n.getCell(e,s).typeInfo.setButton("削除"),n.getCell(e,s).className=this.itemDeleteCssClassName(),n.getCell(e,s).typeInfo.using.itemId=s+n.firstRowIndex},this.resEditItems=[{className:"",colConfig:this.setColKey},{className:"",colConfig:this.setColValue},{className:"",colConfig:this.setColComment},{className:"",colConfig:this.setColDelBtn}],this.scoreEditItems=[{className:"",colConfig:this.setColKey},{className:"",colConfig:this.setColValue},{className:"",colConfig:this.setColSelectType},{className:"",colConfig:this.setColSelectStart},{className:"",colConfig:this.setColSelectEnd},{className:"",colConfig:this.setColSelectStep},{className:"",colConfig:this.setColText},{className:"",colConfig:this.setColDelBtn}],this.makeResLog=async e=>{const t=new qe;t.logType=_.Add;for(const i of e){const o=new Xe;for(const l of i.cells)for(const a of l.children){if(a.className===this.itemDeleteCssClassName())continue;const r=this.table.getElemValue(a)||"";switch(a.className){case this.itemKeyCssClassName():o.key=r;break;case this.itemDispCssClassName():o.text=r;break;case this.itemCommentCssClassName():o.comment=r;break}}t.inst.push(o)}const s=qe.toJsonText(t);await(await ae()).put(W.ResourceEditAction,s)},this.makeScoreLog=async e=>{const t=new je;t.logType=_.Add;for(const i of e){const o=new _e;for(const l of i.cells)for(const a of l.children){if(a.className===this.itemDeleteCssClassName())continue;const r=this.table.getElemValue(a)||"";switch(a.className){case this.itemKeyCssClassName():o.key=r;break;case this.itemDispCssClassName():o.text=r;break;case this.itemSelectTypeCssClassName():o.selectType=r;break;case this.itemSeqTypeStartCssClassName():o.start=r;break;case this.itemSeqTypeEndCssClassName():o.end=r;break;case this.itemSeqTypeStepCssClassName():o.step=r;break;case this.itemTextTypeCssClassName():o.keyValue=r;break}}t.inst.push(o)}const s=je.toJsonText(t);await(await ae()).put(W.ScoreEditAction,s)},this.editorConfigs=[{editorType:Z.Resource,title:"文字列リソース",items:this.resEditItems,logType:W.ResourceEditAction,makeLog:this.makeResLog,fromJsonText:qe.fromJsonText},{editorType:Z.ScoreUI,title:"スコア設定",items:this.scoreEditItems,logType:W.ScoreEditAction,makeLog:this.makeScoreLog,fromJsonText:je.fromJsonText}],this.editorType=Z.Resource,this.actEditor=this.editorConfigs[0],this.resizerOnResizeDone=async(e,t,s)=>{console.log(`[${e.className}] resized (${t}, ${s})`);const n=parseInt(s),i=document.getElementById(this.dlgContentCssClassName());if(i!==null){i.style.width===""?i.offsetWidth:parseInt(i.style.width),i.style.maxWidth="none";const o=i.style.height===""?i.offsetHeight:parseInt(i.style.height);i.style.maxHeight="none",i.style.height=`${o+n}px`;const l=i.querySelectorAll(`.${this.tableCssClassName()}`);if(l!==null){const a=l[0],r=a.style.height===""?a.offsetHeight:parseInt(a.style.height);a.style.maxHeight="none",a.style.height=`${r+n}px`}}},this.onCopyPaste=async(e,t)=>{switch(console.log(`[${e.className}] selected [${t}]`),t){case pe.Copy:await this.table.toClipboard();break;case pe.Paste:await this.table.fromClipboard();break}}}init(e){this.editorType=e;for(let t=0;t<10;t++){const s=new xe;s.owner=this,this.itemList.push(s)}}async load(e){const t=this.getEditor(e);if(t===void 0)return;const s=t.logType,i=await(await ae()).get(s);if(i===null)return;const o=s,l=new Map;for(const a of i){let c=t.fromJsonText(a).logType,h=!1,u=!1;switch(c){case _.None:break;case _.Add:h=!0;break;case _.Update:h=!0;break;case _.Delete:h=!0,u=!0;break}h&&(u?l.has(o)&&l.delete(o):(l.has(o)&&l.delete(o),l.set(o,a)))}this.itemList=new Array;for(const[a,r]of l){const c=t.fromJsonText(r),h=s===W.ResourceEditAction?c:null,u=s===W.ScoreEditAction?c:null;if(h!==null)for(const d of h.inst){const p=new Xe;p.key=d.key,p.text=d.text,p.comment=d.comment;const k=new xe;k.owner=this,k.resItem=p,this.itemList.push(k)}if(u!==null)for(const d of u.inst){const p=new _e;p.key=d.key,p.text=d.text,p.selectType=d.selectType;const k=new xe;k.owner=this,k.scItem=p,this.itemList.push(k)}}}async startAutoSave(){this.saveTimer=new _t,this.saveTimer.intervalMs=1e3,this.saveTimer.isOneShot=!1,this.saveTimer.start(this,this.onSave)}setRow(e,t,s){const n=this.actEditor.items;if(n===void 0)return;let i=-1;for(const o of n)i++,o.colConfig(i,e,t,s)}getEditor(e){return this.editorConfigs.find(s=>s.editorType===e)}toHTML(e){if(!this.itemList)return"";const t=this.getEditor(this.editorType);this.actEditor=t!==void 0?t:this.editorConfigs[0];const n=this.actEditor.items.length,i=new q;if(this.itemList.length>=1)i.makeDim(n,this.itemList.length),this.itemList.forEach((r,c)=>{this.setRow(r,c,i)}),i.makeRowTemplate(this.tableRowCssClassName()),this.table=i;else{i.makeDim(n,1);const r=new xe;this.setRow(r,0,i),i.makeRowTemplate(this.tableRowCssClassName()),i.clearRows(),this.table=i}const o=this.tableCssClassName(),l=this.table.ToScrollHTML(o,o);this.htmlMaker=new v;const a=new D;return a.props.name="",a.props.id=o,a.props.className=o,a.props.option.setTable(l),a.props.option.onSelect=async r=>{switch(console.log(`classify = ${r.classify} targetId = ${r.targetId}`),r.classify){case this.itemSeqTypeStartCssClassName():await this.onSeqEnter(r);break;case this.itemSeqTypeEndCssClassName():await this.onSeqEnter(r);break;case this.itemSeqTypeStepCssClassName():await this.onSeqEnter(r);break;case this.itemDeleteCssClassName():const c=new le;c.setParent(this.dlgCssClassName());let h=N.None;switch(c.setYesNo(),h=await c.showWait(`${r.targetId} を削除しますか？`),h){case N.Yes:break;case N.No:return;case N.Cancel:return}const u=parseInt(r.targetId);u>=1&&(i.deleteRow(u),i.redimAllRows(),this.itemList.splice(u-this.table.firstRowIndex,1));break}},this.htmlMaker.add(a),this.htmlMaker.ToHTML()}async onSeqEnter(e){if(e.KeyEnter===oe.Special){const t=this.table.getCellRect(e.parentElem),s=this.table.getTableOwnerRect(e.parentElem),n=this.table.makeCallerName(e.classify,e.targetId),i=this.table.getCallerCellElem(n);let o="";i!==null&&(o=i.value);const l=new Array;l.push("1/1");for(let r=1;r<=30;r++){const c=`${r*10}`;l.push(`${c}/${c}`)}const a=new At;a.setListener("updn",this.dlgContentCssClassName(),n),a.setSelectedByValue(o,l),a.applyCss(),a.show(`${parseInt(t.left)-parseInt(s.left)+10}`,`${parseInt(t.top)-parseInt(s.top)+10}`),a.enableEvents(r=>{console.log(`[onApply] ${r.callerName} ${r.result}`);const c=this.table.getCallerCellElem(r.callerName);if(c!==null){const h=c;h.value=r.result}a.dispose()},r=>{console.log(`[onUp] ${r.callerName} ${r.result}`)},r=>{console.log(`[onDown] ${r.callerName} ${r.result}`)})}}createEditorBox(e,t){this.parentName=e;const s=this.htmlMaker.MakeDefaultButtonsHTML(`
...
${this.htmlMaker.MakeDefaultButtonsCss()}
`.trim(),document.head.appendChild(s);const n=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,n)}}const _={None:"None",Add:"Add",Delete:"Delete",Update:"Update"};class Tt{constructor(){this.logType=_.None}}class qe extends Tt{constructor(){super(...arguments),this.inst=new Array}static toJsonText(e){return JSON.stringify(e,null,2)}static fromJsonText(e){return JSON.parse(e)}}class je extends Tt{constructor(){super(...arguments),this.inst=new Array}static toJsonText(e){return JSON.stringify(e,null,2)}static fromJsonText(e){return JSON.parse(e)}}async function Qt(m){if(!m.isWebRunning)return;const e=m.isWebRunning;async function t(){const o=Z.Resource,l=new ut;l.init(o),await l.load(o),l.uiInfo.name="ResourceEdit",l.uiInfo.left="110",l.uiInfo.top="10";const a=l.uiInfo.name,r=await l.toHTML(o);if(e){const c=document.createElement("div");c.id=l.uiInfo.name,c.className=l.uiInfo.name,document.body.appendChild(c);const h=l.createEditorBox(a,r);l.addEventHandlers(h),l.addItemEventHandlers(),h.show(),l.enableResize()}return l}async function s(){const o=Z.ScoreUI,l=new ut;l.init(o),await l.load(o),l.uiInfo.name="ScoreEdit",l.uiInfo.left="110",l.uiInfo.top="100";const a=l.uiInfo.name,r=await l.toHTML(o);if(e){const c=document.createElement("div");c.id=l.uiInfo.name,c.className=l.uiInfo.name,document.body.appendChild(c);const h=l.createEditorBox(a,r);l.addEventHandlers(h),l.addItemEventHandlers(),h.show(),l.enableResize()}return l}(await t()).startAutoSave(),(await s()).startAutoSave()}const M=new ge,kt=M.isWebRunning;kt?(Zt(),M.parseURLParams(),M.currentUserHome===""&&M.setUser(M.user1Home)):M.setUser(M.user2Home);M.setPath();M.setImageHome(window.EVONA_CONFIG.isLocal);M.currentUserHome;M.statusJsonPath;M.zipPrefix;M.chListFile;M.chStatusListFile;switch(M.admin){case!0:await Ht(M);break;case!1:if(kt)if(M.edit===!1){let m=!1,e=!1;const t=new le;t.CheckVisible=!0,t.CheckText="位置情報を初期化",t.SecretEnable=!0;const s=M.setBrowserTitle();await t.showWait(`「${s} 」モードで起動します`)===N.Secret&&(e=!0),m=t.Checked,console.log(`secretMode=[${e}]`),console.log(`cleanMode=[${m}]`),m&&(await(await vt()).clear(),await(await ae()).clear()),e&&(window.EVONA_CONFIG.demo=!1),await Xt(M)}else M.setBrowserTitle(),await Qt(M);break}function Zt(){const m=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.hostname.startsWith("192.168."),e=m?"./jszip_dist/jszip.min.js":"https://cdn.jsdelivr.net/npm/jszip@3.10.1/dist/jszip.min.js",t=m?"./jsstore_dist/jsstore.min.js":"https://cdn.jsdelivr.net/npm/jsstore/dist/jsstore.min.js";window.EVONA_CONFIG={isLocal:m,workerFile:"./jsstore_dist/jsstore.worker.min.js",demo:!m};function s(n,i=!1){const o=document.createElement("script");o.src=n,i&&(o.type="module"),o.async=!1,document.head.appendChild(o)}s(e),s(t)}
