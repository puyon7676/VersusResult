...
`.trim()}static get spacingTable(){return"border-collapse: collapse; border-spacing: 0;"}static get spacingTr(){return`background: ${this.normBkColor};`}static sliderText(e,t,s=new ln){return`
/* スイッチ全体のレイアウト */
.${e}-container {
  display: flex;
  align-items: center;
...
cursor: pointer;
        ...
        `.trim()}enableEvents(e){return this.ctlElem===null?!1:(this.htmlMaker.enableTableEvents(this.ctlElem.className),this.onSelect=e,!0)}disableEvents(){return this.ctlElem===null?!1:(this.htmlMaker.disableTableEvents(this.ctlElem.className),!0)}dispose(){super.dispose(),this.ctlElem!==null&&(this.ctlElem.parentElement?.removeChild(this.ctlElem),this.ctlElem.remove()),this.disableEvents(),this.ctlElem=null}tblCssName(){return`${this.ctlName}-tbl`}}class Es{constructor(){this.key="",this.text=""}}class hn extends Oe{constructor(){super(...arguments),this.callerName="",this.htmlMaker=new D,this.table=new Y,this.headerElem=null,this.footerElem=null,this.width=0,this.height=0}setGridtems(e){this.items=e}setListener(e,t,s,n="",i=""){if(this.items===void 0)return!1;this.dispose(),this.callerName=s,this.ctlName=e;const o=this.items.length,l=new Y;l.makeDim(2,o);let a=0;for(const C of this.items)l.getCell(0,a).typeInfo.setLabel(`${C.text}`,!1),l.getCell(0,a).className=this.keyCssName(),l.getCell(0,a).typeInfo.using.itemId=a,l.getCell(1,a).typeInfo=C.value.items[0].typeInfo,l.getCell(1,a).className=this.valueCssName(),l.getCell(1,a).typeInfo.using.itemId=a,a++;const r=this.firstAction(e,t);if(r===null)return!1;const c=l.ToScrollHTML(e,this.tblCssName()),m=new se;m.props.name="",m.props.id=this.tblCssName(),m.props.className=this.tblCssName(),m.props.option.setTable(c),m.props.option.onSelect=async C=>{if(this.onSelect!==void 0){const $=new re;$.callerName=C.classify,$.result=C.selectedValue,await this.onSelect($)}},this.htmlMaker=new D,this.htmlMaker.add(m);const f=this.htmlMaker.ToHTML();let d=document.createElement("dialog");d.className=e,d.innerHTML=f,this.ctlElem=d;let g=d.children[0];const p=this.divCssName();g.className=p,g.id=p;let u=g.children[0];return u.className=`${this.tblCssName()}`,u.id=`${this.tblCssName()}`,n!==""&&(this.headerElem=document.createElement("div"),this.headerElem.className=n,this.headerElem.id=n,d.appendChild(this.headerElem)),r.appendChild(this.ctlElem),i!==""&&(this.footerElem=document.createElement("div"),this.footerElem.className=i,this.footerElem.id=i,d.appendChild(this.footerElem)),this.table=l,!0}show(e,t){this.ctlElem!==null&&(this.ctlElem.style.left=`${e}px`,this.ctlElem.style.top=`${t}px`,this.ctlElem.show())}setFontConfig(e="0.9"){this.table.setFontConfig(e)}setSize(e="200",t="300"){let s=0;if(this.footerElem!==null){const n=this.htmlMaker.GetRect(this.footerElem);s=Number(n.height)}this.table.height=`${Number(t)-s}`,this.height=Number(t)+L.footerPadding,this.width=Number(e)}applyCss(){const e=`${this.getBaseElem().className}-flgrd-style`;if(document.getElementById(e))return;const t=this.appendStyle(e);t.textContent=`
${this.getOuterCssText()}
...
width: 100%;
        ...
        `.trim()}enableEvents(e){return this.ctlElem===null?!1:(this.htmlMaker.enableTableEvents(this.ctlElem.className),this.onSelect=e,!0)}disableEvents(){return this.ctlElem===null?!1:(this.htmlMaker.disableTableEvents(this.ctlElem.className),!0)}dispose(){super.dispose(),this.headerElem!==null&&(this.headerElem.parentElement?.removeChild(this.headerElem),this.headerElem.remove()),this.footerElem!==null&&(this.footerElem.parentElement?.removeChild(this.footerElem),this.footerElem.remove()),this.ctlElem!==null&&(this.ctlElem.parentElement?.removeChild(this.ctlElem),this.ctlElem.remove()),this.disableEvents(),this.ctlElem=null}divCssName(){return`${this.ctlName}-div`}tblCssName(){return`${this.ctlName}-tbl`}keyCssName(){return`${this.ctlName}-key`}valueCssName(){return`${this.ctlName}-value`}}const ae={Text:"Text",KeyValue:"KeyValue"},Ke={asText:"asText",asNumber:"asNumber"};class un extends Oe{constructor(){super(...arguments),this.pairDelimiter=",",this.itemDelimiter="/",this.keyToolTip="キー",this.valueToolTip="テキスト",this.editType=ae.KeyValue,this.valueType=Ke.asText,this.digLen=5,this.callerName="",this.htmlMaker=new D,this.table=new Y,this.headerElem=null,this.footerElem=null,this.numpad=null}setKeyValuePairs(e,t=8){const s=e.split(this.pairDelimiter);if(s.length===0)return;const n=new Array;for(const o of s){const l=o.split(this.itemDelimiter);if(l.length<=1)continue;const a=new Re;a.key=l[0],a.text=l[1],n.push(a)}const i=t-n.length;if(i>0)for(let o=0;o<i;o++){const l=new Re;l.key=`key${n.length+1}`,l.text="",n.push(l)}this.editType=ae.KeyValue,this.items=n}setTexts(e,t=8){const s=e.split(this.pairDelimiter);if(s.length===0)return;const n=new Array;for(const o of s){const l=new Re;l.text=o,n.push(l)}const i=t-n.length;if(i>0)for(let o=0;o<i;o++){const l=new Re;l.key=`key${n.length+o}`,l.text="",n.push(l)}this.editType=ae.Text,this.items=n}setValueType(e,t=Ke.asNumber){this.digLen=e,this.valueType=t}setListener(e,t,s,n,i){if(this.items===void 0)return!1;this.dispose(),this.callerName=s,this.ctlName=e;const o=this.items.length,l=new Y,a=this.editType===ae.KeyValue?2:1;l.makeDim(a,o);let r=this.valueType===Ke.asNumber,c=0;for(const $ of this.items){let S=0,v="",y="";this.editType===ae.KeyValue?(v=$.key,y=this.keyToolTip):(v=$.text,y=this.valueToolTip);const T=new te;if(T.value=v,T.placeholder=y,this.editType!==ae.KeyValue&&(T.disableKeyDown=r,T.enableClicked=r),l.getCell(S,c).typeInfo.setInput(T),l.getCell(S,c).className=`${e}-key-${c+1}`,l.getCell(S,c).typeInfo.using.itemId=c+l.firstRowIndex,l.getCell(S,c).typeInfo.toolTip=y,this.editType===ae.KeyValue){S++;const b=new te;b.value=$.text,b.placeholder=this.valueToolTip,b.disableKeyDown=r,b.enableClicked=r,l.getCell(S,c).typeInfo.setInput(b),l.getCell(S,c).className=`${e}-text-${c+1}`,l.getCell(S,c).typeInfo.using.itemId=c+l.firstRowIndex,l.getCell(S,c).typeInfo.toolTip=this.valueToolTip}c++}const m=this.firstAction(e,t);if(m===null)return!1;const f=l.ToScrollHTML(e,e),d=new se;d.props.name="",d.props.id=this.tblCssName(),d.props.className=this.tblCssName(),d.props.option.setTable(f),d.props.option.onSelect=async $=>{console.log(`[HtmlMakerInputEdit] classify = ${$.classify} targetId = ${$.targetId}`),this.onSelect!==void 0&&this.showNumpad($,this.digLen)},this.htmlMaker=new D,this.htmlMaker.add(d);const g=this.htmlMaker.ToHTML();let p=document.createElement("dialog");p.className=e,p.innerHTML=g,this.ctlElem=p;let u=p.children[0],C=u.children[0];return C.className=`${this.tblCssName()}`,C.id=`${this.tblCssName()}`,this.ctlElem.appendChild(C),u.remove(),u=null,n!==""&&(this.headerElem=document.createElement("div"),this.headerElem.className=n,this.headerElem.id=n,p.appendChild(this.headerElem)),m.appendChild(this.ctlElem),i!==""&&(this.footerElem=document.createElement("div"),this.footerElem.className=i,this.footerElem.id=i,p.appendChild(this.footerElem)),this.table=l,!0}show(e,t){this.ctlElem!==null&&(this.ctlElem.style.left=`${e}px`,this.ctlElem.style.top=`${t}px`,this.ctlElem.show())}applyCss(){const e=`${this.getBaseElem().className}-inputedit-style`;if(document.getElementById(e))return;const t=this.appendStyle(e);t.textContent=`
${this.getOuterCssText()}
.${this.tblCssName()} {
  ${this.getBaseCssText()}
  height: 180px;
...
${t}
        `.trim()}enableEvents(e){return this.ctlElem===null?!1:(this.htmlMaker.enableTableEvents(this.ctlElem.className),this.onSelect=e,!0)}disableEvents(){return this.ctlElem===null?!1:(this.htmlMaker.disableTableEvents(this.ctlElem.className),!0)}setTextByIndex(e,t){return this.cells===void 0?!1:0<=e&&e<this.cells.length?(this.cells[e].textContent=t,!0):!1}setTextByKey(e,t){if(this.cells===void 0||this.indexList===void 0||this.indexList.has(e)===!1)return!1;const s=this.indexList.get(e);return s===void 0?!1:(this.cells[s].textContent=t,!0)}dispose(){super.dispose(),this.ctlElem!==null&&(this.ctlElem.parentElement?.removeChild(this.ctlElem),this.ctlElem.remove()),this.disableEvents(),this.ctlElem=null}divCssName(){return`${this.ctlName}-div`}tblCssName(){return`${this.ctlName}-tbl`}}class xs{constructor(){this.tblCssName=""}}class Os{constructor(){this.headerElem=null,this.subTblElem=null}}const vs={OkCancel:"OkCancel"};class ot extends Oe{constructor(){super(...arguments),this.items=new Array,this.firstRowIndex=1,this.callerName="",this.htmlMaker=new D,this.table=new Y,this.headerName="",this.footerName="",this.headerElem=null,this.footerElem=null,this.onOkClickFooter=async e=>{if(this.onSelect!==void 0){const t=new re;t.callerName=this.callerName,t.result="",t.classify=We.Ok,t.notify=this,await this.onSelect(t)}},this.onCancelClickFooter=async e=>{if(this.onSelect!==void 0){const t=new re;t.callerName=this.callerName,t.result="",t.classify=We.Cancel,t.notify=this,await this.onSelect(t)}},this.height=0}makeSubTable(e){const t=e.tblCssName,s=e.table.ToHTML(t,t),n=new se;n.props.name="",n.props.id=t,n.props.className=t,n.props.option.setTable(s),n.props.option.onSelect=async a=>{if(this.onSelect!==void 0){const r=new re;if(r.callerName=a.classify,r.result=a.selectedValue,await this.onSelect(r),a.cancel)return}for(const r of this.items){if(a.classify.includes(r.headerItem.tblCssName)){r.headerItem.onSelect!==void 0&&r.headerItem.onSelect(a);break}if(a.classify.includes(r.subTblItem.tblCssName)){r.subTblItem.onSelect!==void 0&&r.subTblItem.onSelect(a);break}}};const i=e.htmlMaker;i.add(n);const o=i.ToHTML(),l=i.ToElem(o);return e.htmlMaker=i,l}addGroupPair(e,t){const s=new Os;e.htmlMaker===void 0&&(e.htmlMaker=new D),t.htmlMaker===void 0&&(t.htmlMaker=new D);const n=this.makeSubTable(e),i=this.makeSubTable(t);s.headerElem=n,s.subTblElem=i,s.headerItem=e,s.subTblItem=t,this.items.push(s)}makeHeader(){this.headerName="-header",this.headerElem=document.createElement("div")}makeFooter(e=vs.OkCancel){this.footerName=`-footer-${e}`,this.footerElem=document.createElement("div")}setListener(e,t,s){if(this.items===void 0)return!1;this.dispose(),this.callerName=s,this.ctlName=e;const n=this.items.length,i=new Y;i.makeDim(1,2*n);let o=0;for(const u of this.items)u.headerElem!==null&&(i.getCell(0,o).typeInfo.setLowerTable(),o++),u.subTblElem!==null&&(i.getCell(0,o).typeInfo.setLowerTable(),o++);const l=this.firstAction(e,t);if(l===null)return!1;const a=i.ToScrollHTML(e,this.tblCssName()),r=new se;r.props.name="",r.props.id=this.tblCssName(),r.props.className=this.tblCssName(),r.props.option.setTable(a),r.props.option.onSelect=async u=>{if(this.onSelect!==void 0){const C=new re;C.callerName=u.classify,C.result=u.selectedValue,await this.onSelect(C)}},this.htmlMaker=new D,this.htmlMaker.add(r);const c=this.htmlMaker.ToHTML();for(const u of this.items){if(u.headerItem!==void 0)for(const C of u.headerItem.htmlMaker.itemList)this.htmlMaker.add(C);if(u.subTblItem!==void 0)for(const C of u.subTblItem.htmlMaker.itemList)this.htmlMaker.add(C)}let m=document.createElement("dialog");m.className=e,m.innerHTML=c,this.ctlElem=m;let f=m.children[0];const d=this.divCssName();f.className=d,f.id=d;let g=f.children[0];g.className=`${this.tblCssName()}`,g.id=`${this.tblCssName()}`,o=0;let p=0;for(const u of g.rows)o%2===0?(u.cells[0].appendChild(this.items[p].headerElem),o++):(u.cells[0].appendChild(this.items[p].subTblElem),o++,p++);if(this.headerElem!==null&&(this.headerElem.className=this.headerName,this.headerElem.id=this.headerName,m.appendChild(this.headerElem)),l.appendChild(this.ctlElem),this.footerElem!==null){const u=this.footerCssName();if(this.footerElem.className=u,this.footerElem.id=u,m.appendChild(this.footerElem),this.footerName.endsWith(vs.OkCancel)){const C=`${u}-okBtn`,$=`${u}-canBtn`;let S=`
<button id="${C}">OK</button>
<button id="${$}">CANCEL</button>
`.trim();this.footerElem.innerHTML=S,document.getElementById(C).onclick=this.onOkClickFooter,document.getElementById($).onclick=this.onCancelClickFooter}}return this.table=i,!0}show(e,t){this.ctlElem!==null&&(this.ctlElem.style.left=`${e}px`,this.ctlElem.style.top=`${t}px`,this.ctlElem.show())}enableEvents(e){if(this.ctlElem===null)return!1;const t=new Array;return t.push(this.items[0].headerItem.tblCssName),t.push(this.items[0].subTblItem.tblCssName),this.htmlMaker.enableTableEvents(this.ctlElem.className,t),this.onSelect=e,!0}disableEvents(){return this.ctlElem===null?!1:(this.htmlMaker.disableTableEvents(this.ctlElem.className),!0)}dispose(){super.dispose(),this.headerElem!==null&&(this.headerElem.parentElement?.removeChild(this.headerElem),this.headerElem.remove()),this.footerElem!==null&&(this.footerElem.parentElement?.removeChild(this.footerElem),this.footerElem.remove()),this.ctlElem!==null&&(this.ctlElem.parentElement?.removeChild(this.ctlElem),this.ctlElem.remove()),this.disableEvents(),this.ctlElem=null}setSize(e="300"){let t=0;if(this.footerElem!==null){const s=this.htmlMaker.GetRect(this.footerElem);t=Number(s.height)}this.table.height=`${Number(e)-t}`,this.height=Number(e)+L.footerPadding}setFontConfig(e="0.9"){this.table.setFontConfig(e)}get cssText(){const e=this.footerCssName(),t=this.footerName!==""?`
/*フッター背景*/
[class^="${e}"] {
${L.footerText()}
}
...
${L.getTableCssText(this.divCssName(),this.table.height)}
${t}
`.trim()}divCssName(){return`${this.ctlName}-div`}tblCssName(){return`${this.ctlName}-tbl`}headerCssName(){return`${this.ctlName}${this.headerName}`}footerCssName(){return`${this.ctlName}${this.footerName}`}}ot.allRowAction=-1;class Ms{constructor(){this.url="",this.toolTip=""}}class zt extends ot{constructor(){super(...arguments),this.checkClassName="",this.subTblClassName="",this.imgClassName="",this.imgSize=100,this.bgColor=`${L.onColor}66`,this.onSelectHeader=async e=>{const t=e.classify.split("-");t.length>=1&&this.setCheck(Number(t[t.length-1]))},this.onSelectSubTbl=async e=>{console.log(e)}}makeCheckHeader(e,t,s){const n=new Y;n.makeDim(1,1),this.checkClassName=`${e}-check`;const i=new Yt;i.placeholder=t,i.value=!1,i.enableClicked="true";const o=new Ce;o.makeItems(),o.items[0].typeInfo.setCheck(i),o.items[0].className=`${this.checkClassName}-${s}`,n.getCell(0,0).typeInfo=o.items[0].typeInfo,n.getCell(0,0).className=o.items[0].className,n.getCell(0,0).typeInfo.using.itemId=1,n.getCell(0,0).typeInfo.toolTip=t;const l=new xs;return l.tblCssName=e,l.table=n,l.onSelect=this.onSelectHeader,l}makeImgSubTbl(e,t,s){const n=new Y;n.makeDim(t.length,1),this.subTblClassName=e,this.imgClassName=`${e}-img`;let i=0;for(const l of t){const a=new Pt;a.imgFile="",a.imgSrc=l.url,a.alt="";const r=new Ce;r.makeItems(),r.items[0].typeInfo.setImg(a),r.items[0].className=`${this.imgClassName}-${s}-${i}`,n.getCell(i,0).typeInfo=r.items[0].typeInfo,n.getCell(i,0).className=r.items[0].className,n.getCell(i,0).typeInfo.using.itemId=i,n.getCell(i,0).typeInfo.toolTip=l.toolTip,i++}const o=new xs;return o.tblCssName=e,o.table=n,o.onSelect=this.onSelectSubTbl,o}setCheckByRow(e=this.firstRowIndex,t=!0){if(e===ot.allRowAction){for(const n of this.items)this.setCheckInternal(n);return!0}if(e<0||e>=this.items.length)return!1;const s=this.items[e-this.firstRowIndex];return this.setCheckInternal(s)}setCheck(e=this.firstRowIndex){let t=this.firstRowIndex;for(const s of this.items)t===e?this.setCheckInternal(s,!0):this.setCheckInternal(s,!1),t++}setCheckInternal(e,t=!0){const s=e.headerElem;if(s===null)return!1;const n=s.rows[0];for(const i of n.cells){for(const o of i.children)if(o.tagName==="DIV"){e.headerItem.table.setElemValue(o,t);break}break}return!0}getCheckMap(){const e=new Map;let t=this.firstRowIndex;for(const s of this.items){const n=s.headerElem;if(n===null)continue;const i=n.rows[0];for(const o of i.cells){for(const l of o.children){if(l.tagName!=="DIV")continue;const r=s.headerItem.table.getElemValue(l);e.set(t,r);break}break}t++}return e}checkedRow(){const e=this.getCheckMap();for(const[t,s]of e)if(s===!0)return t;return-1}selectFirstCell(e=this.firstRowIndex){if(e===ot.allRowAction){for(const s of this.items)this.selectFirstCellInternal(s);return!0}if(e<0||e>=this.items.length)return!1;const t=this.items[e-this.firstRowIndex];return this.selectFirstCellInternal(t)}selectFirstCellInternal(e){const t=e.subTblElem;if(t===null)return!1;const s=t.rows[0];for(const n of s.cells){for(const i of n.children)i.tagName==="DIV"&&i.classList.remove("selected");if(n.children.length>=1){n.children[0].classList.add("selected");break}break}return!0}applyCss(){const e=`${this.getBaseElem().className}-listviewgroup-style`;if(document.getElementById(e))return;const t=L.spacingTable,s=this.appendStyle(e);s.textContent=`
${this.cssText}
...
`.trim(),document.head.appendChild(t)}setB2Allow(e=!0){const t=document.getElementById(`${this.toolNameB2}`);if(t===null)return;this.b2cursor===""&&(this.b2cursor=t.style.cursor);const s=e?this.b2cursor:"not-allowed";t.style.cursor=s}isB2Allow(){const e=document.getElementById(`${this.toolNameB2}`);return e===null?!1:e.style.cursor===this.b2cursor}}const mt={None:"None",Add:"Add",Remove:"Remove"};class yn{constructor(){this.reqType=mt.None,this.parentClassName="",this.uiName="",this.itemName="",this.title="",this.content=""}}const Xe={None:"None",Memo:"Memo",Table:"Table"},Xt={None:"None",InVisible:"InVisible"};class Ls{constructor(){this.heightPx="100",this.name="",this.title="",this.closeType=Xt.None,this.toolTipType=Xe.None,this.memoSpanElem=null,this.tblElem=null,this.tblAuxCss="",this.onB0Click=async e=>{console.log("onB0Click",e)},this.onB4Click=async e=>{if(this.closeType===Xt.InVisible){this.SetVisible(!1);return}await q.Remove(this.dlg.id)},this.onMgClick=async e=>{await q.Activate(this)},this.onTableClick=async e=>{const t=e.target;if(t===null||t.tagName!=="DIV")return;const s=t,n=s.className,i=s.textContent,o="is-active";document.querySelectorAll(`.${t.className}`).forEach(r=>r.classList.remove(o)),t.classList.add(o);let l="",a="";for(const r of this.table.rows)for(const c of r.cols)for(const m of c.items)if(m.className===n&&m.typeInfo.using.itemType===P.Radio&&s.dataset!==void 0&&m.typeInfo.using.radio.classify===s.dataset.classify)for(const f of m.typeInfo.using.radio.selectionPair){if(f.length===0)continue;const d=f.split("/");if(!(d.length<=1)&&d[0]===i){a=d[0],l=d[1],this.onChangedTableSelection!==void 0&&await this.onChangedTableSelection(l,a);return}}},this.mover=new os,this.moverOnMoveDone=async()=>{this.onMoveDone!==void 0&&await this.onMoveDone(this.dlg)}}NewToolTip(e,t){if(e===null)return null;const s=document.createElement("dialog");s.id=t,s.className=this.dlgName,e.appendChild(s),this.dlg=s;const n=`<button class="${this.toolNameB0}" id="${this.toolNameB0}" title="DragMove">[＊]</button>`,i=`<button class="${this.toolNameB4}" id="${this.toolNameB4}" title="Close">[×]</button>`,o=`<button class="${this.toolNameMg}" id="${this.toolNameMg}" title="ActivateMgr">[Ｍ]</button>`,l=`<span class="${this.toolNameTitle}" id="${this.toolNameTitle}" title="UIName">UIName</span>`,a=`${n}${i}${o}${l}`,r=document.createElement("div");r.id=this.toolDivName,r.className=this.toolDivName,r.innerHTML=a;const c=document.createElement("div"),m=this.divName;return c.id=m,c.className=m,s.appendChild(r),s.appendChild(c),this.div=c,s}SetTitle(e){const t=this.dlg.getElementsByClassName(`${this.toolDivName}`);if(t.length>=1){const n=t[0].getElementsByClassName(`${this.toolNameTitle}`);if(n.length>=1){const i=n[0];i.innerHTML=e}}}SetMemoText(e){return this.toolTipType!==Xe.None?!1:(this.memoSpanElem===null&&this.initMemoMode(this.div),this.memoSpanElem!==null&&(this.memoSpanElem.innerHTML=e),this.toolTipType=Xe.Memo,!0)}SetTable(e,t=""){return this.toolTipType!==Xe.None||e===void 0?!1:(this.tblElem===null&&(this.table=e,this.initTableMode(this.div)),this.tblAuxCss=t,this.toolTipType=Xe.Table,!0)}VisibleMgrBtn(e){const t=this.dlg.querySelector(`.${this.toolNameMg}`);if(t!==null){const s=t;s.style.display=e?"":"none"}}initMemoMode(e){const t=document.createElement("span"),s=this.spanName;t.id=s,t.className=s,e.appendChild(t),this.memoSpanElem=t}initTableMode(e){const t=this.tableName,s=this.table.ToHTML(t,t),n=new se;n.props.name="",n.props.id=t,n.props.className=t,n.props.option.setTable(s),n.props.option.onSelect=async a=>{};const i=new D;i.add(n);const o=i.ToHTML(),l=i.ToElem(o);e.appendChild(l),this.tblElem=l}Show(e){this.dlg.show();const t=document.getElementById(e);if(t!==null){const s=t.getBoundingClientRect(),n=s.left+s.width/2,i=s.top+s.height/2;this.dlg.style.left=`${n}px`,this.dlg.style.top=`${i}px`}}SetVisible(e=!0){this.dlg.style.display=e?"":"none"}GetVisible(){return this.dlg.style.display!=="none"}EnableEvents(){const e=document.getElementById(this.toolNameB0);e.onclick=this.onB0Click,this.mover.onMoveDone=this.moverOnMoveDone,this.mover.attach(e,this.dlg),document.getElementById(this.toolNameB4).onclick=this.onB4Click,document.getElementById(this.toolNameMg).onclick=this.onMgClick,this.tblElem!==null&&this.tblElem.addEventListener("click",this.onTableClick)}applyCss(){const e=`${this.dlgName}-style`;if(document.getElementById(e))return;const t="100",s="120",n=document.createElement("style");n.id=e,n.textContent=`
/* ツールチップ外枠 */
.${this.dlgName} {
  position: fixed;
  inset: auto; /* ブラウザの中央寄せを無効化 */
...
${this.tblAuxCss}
`.trim(),document.head.appendChild(n)}dispose(){}get toolDivName(){return`${this.dlgName}-tool-div`}get toolNameB0(){return`${this.dlg.id}-tool-b0`}get toolNameB4(){return`${this.dlg.id}-tool-b4`}get toolNameMg(){return`${this.dlg.id}-tool-Mg`}get toolNameTitle(){return`${this.dlg.id}-tool-title`}get dlgName(){return"toolTip-dlg-common"}get divName(){return`${this.dlgName}-div`}get spanName(){return`${this.dlgName}-span`}get tableName(){return`${this.dlgName}-table`}}class q{constructor(){this.mover=new os}static FindParent(e){return document.getElementById(e)}static TopElement(){return document.body}static MakeUniqueName(e,t){return`${e}_${t}`}static Add(e){if(z.FindBy(e)!==null)return!1;const s=z.items.length+z.zIndexFirst,n=new Ls;return n.NewToolTip(z.TopElement(),e),n.dlg.style.zIndex=`${s}`,z.items.push(n),!0}static Remove(e){const t=z.items.findIndex(n=>n.dlg.id===e);if(t===-1)return!1;this.table.deleteRow(t+this.table.firstRowIndex),this.table.redimAllRows();const s=z.items[t];return s.dlg.innerHTML="",s.dlg.remove(),z.items.splice(t,1),!0}static SetToolTipText(e,t,s){const n=z.FindBy(e);return n===null?!1:(n.SetTitle(t),n.SetMemoText(s),!0)}static MoveTop(e){const t=z.FindBy(e);if(t===null)return!1;let s=z.items.length-1+z.zIndexFirst;for(const n of z.items)n.dlg.className!==t.dlg.className&&(n.dlg.style.zIndex=`${s}`,s--);return s=z.items.length+z.zIndexFirst,t.dlg.style.zIndex=`${s}`,!0}static FindBy(e){const t=z.items.findIndex(s=>s.dlg.id===e);return t===-1?null:z.items[t]}static async Activate(e){const t=this.parentCssClassName(),s=document.getElementById(t);if(s!==null&&(s.style.display="",s.hidden=!1,this.requestActivate!==void 0)){for(const n of s.children)if(n.tagName==="DIALOG"){const i=n;await this.requestActivate(i);break}}}static setRow(e,t,s){let n=0;s.getCell(n,t).typeInfo.setLabel(`${e.title}`,!1),s.getCell(n,t).className=this.itemNameCssClassName(),s.getCell(n,t).typeInfo.using.itemId=t+s.firstRowIndex,s.getCell(n,t,1).typeInfo.setLabel(`${e.title}`,!1),s.getCell(n,t,1).className=this.itemNameCssClassName(),s.getCell(n,t,1).typeInfo.using.itemId=t+s.firstRowIndex,n++,s.getCell(n,t).typeInfo.setButton("アクティブ化"),s.getCell(n,t).className=this.itemActCssClassName(),s.getCell(n,t).typeInfo.using.itemId=t+s.firstRowIndex}static toHTML(){if(!this.items)return"";const e=2,t=new Y;if(this.items.length>=1)t.makeDim(e,this.items.length),t.growCell(0,2),this.items.forEach((o,l)=>{this.setRow(o,l,t)}),t.makeRowTemplate(this.tableRowCssClassName()),this.table=t;else{t.makeDim(e,1),t.growCell(0,2);const o=new Ls;this.setRow(o,0,t),t.makeRowTemplate(this.tableRowCssClassName()),t.clearRows(),this.table=t}const s=this.tableCssClassName(),n=this.table.ToScrollHTML(s,s);this.htmlMaker=new D;const i=new se;return i.props.name="",i.props.id=s,i.props.className=s,i.props.option.setTable(n),i.props.option.onSelect=async o=>{console.log(`classify = ${o.classify} targetId = ${o.targetId}`)},this.htmlMaker.add(i),this.htmlMaker.ToHTML()}static AddRow(){return this.table.addRow(this.tableRowCssClassName())}static SetTitle(e,t,s){const n=this.table.getRowElem(e);n!==null&&(n.cells[0].children[0].children[0].innerHTML=t,n.cells[0].children[1].children[0].innerHTML=s)}static createMgrBox(e,t){const s=document.createElement("div"),n=this.parentCssClassName();s.id=n,s.className=n,this.TopElement().appendChild(s),this.uiInfo=new Ue;const i=new de;i.title="<"+e+">",i.SetB4Type(Se.DialogHide);const o=i.NewDialog(n,this.dlgCssClassName());return i.SetContent(n,t),i.EnableEventHandlers(),i.onMoveDone=z.moverOnMoveDone,this.dlg=o,o}static enableEvents(){const e=this.getTableElem();return e===null?!1:(e.addEventListener("click",this.onButtonClicked),!0)}static disableEvents(){const e=this.getTableElem();return e===null?!1:(e.removeEventListener("click",this.onButtonClicked),!0)}static getTableElem(){const e=document.getElementsByClassName(this.tableCssClassName());return e===null||e.length<=0?null:e[0]}static applyCss(){const e=this.parentCssClassName(),t=parseInt(this.uiInfo.left),s=parseInt(this.uiInfo.top),n=new D,i=document.createElement("style");i.textContent=`
...
`.trim()}const c=`${a}${i}${o}${l}`,m=c!==""?`<div class="msg-footer">${c}</div>`:"",f=document.createElement("div");if(f.id=this.parentName,f.innerHTML=`
        ...
        `.trim(),this.applyCss(),document.body.appendChild(f),this.AuthVisible){document.getElementById(this.authName1).focus(),this.authText="",window.addEventListener("keydown",this.onWindowKeyboard);for(let g=0;g<10;g++){const p=`${this.authBtnName}-b${g}`,u=document.querySelectorAll(`.${p}`);if(u.length!==1)continue;const C=u[0];C!==null&&C.addEventListener("click",this.onAuthButtonClicked)}}}applyCss(){const e=`${this.parentName}-style`;if(document.getElementById(e))return;let t="";for(let n=0;n<10;n++){const i=`${this.authBtnName}-b${n}`;t+=`
#${this.parentName} .${i} {
width: 30px;
padding: 10px;
border: none;
...
${t}
`.trim(),document.head.appendChild(s)}setCheckResult(){const e=document.getElementById(this.chkName1);if(e!==null){const t=e.checked;this.Checked=t}}remove(){document.getElementById(this.btnName1)?.removeEventListener("click",this.onB1Clicked),document.getElementById(this.btnName2)?.removeEventListener("click",this.onB2Clicked),document.getElementById(this.btnName3)?.removeEventListener("click",this.onB3Clicked),document.getElementById(this.btnNameS)?.removeEventListener("click",this.onS1Clicked),document.getElementById(this.parentName)?.remove()}}class bn{constructor(){this.intervalMs=1e3,this.isOneShot=!0,this.intervalTimer=null}start(e,t){this.intervalTimer!==null&&this.clear(),this.intervalTimer=setTimeout(async()=>{t!==void 0&&(await t(e)||this.clear()),this.isOneShot===!0&&this.clear()},this.intervalMs)}clear(){clearTimeout(this.intervalTimer),this.intervalTimer=null}}const ce={Resource:"Resource",ScoreUI:"ScoreUI",GameUI:"GameUI"},je={Sequence:"Sequence",Text:"Text"};class ls{constructor(){this.key="",this.text=""}static copy(e,t){t.key=e.key,t.text=e.text}}class Lt extends ls{constructor(){super(...arguments),this.comment=""}static copy(e,t){t.key=e.key,t.text=e.text,t.comment=e.comment}}class Bt extends ls{constructor(){super(...arguments),this.selectType=je.Sequence,this.start="",this.end="",this.step="",this.keyValue=""}static copy(e,t){t.key=e.key,t.text=e.text,t.selectType=e.selectType,t.start=e.start,t.end=e.end,t.step=e.step,t.keyValue=e.keyValue}get isScoreAvail(){if(this.key.trim().length===0||this.text.trim().length===0)return!1;if(this.selectType===je.Sequence){if(this.start.trim().length===0||this.end.trim().length===0||this.step.trim().length===0)return!1}else if(this.keyValue.trim().length===0)return!1;return!0}}class Ht extends ls{constructor(){super(...arguments),this.formation="",this.nsEnable=!1,this.nsCombo="",this.nsScore="",this.gameEnable=!1,this.gameCombo="",this.gameScore=""}static copy(e,t){t.key=e.key,t.text=e.text,t.formation=e.formation,t.nsEnable=`${e.nsEnable}`!="",t.nsCombo=e.nsCombo,t.nsScore=e.nsScore,t.gameEnable=`${e.gameEnable}`!="",t.gameCombo=e.gameCombo,t.gameScore=e.gameScore}get nsComboAvail(){return this.nsEnable===!1||this.nsCombo.trim().length===0||this.nsScore.trim().length===0?0:parseInt(this.nsCombo.trim())}get gameComboAvail(){return this.gameEnable===!1||this.gameCombo.trim().length===0||this.gameScore.trim().length===0?0:parseInt(this.gameCombo.trim())}get nsComboScoreList(){let e=this.nsComboAvail;return e===0?new Map:this.toScoreMap(this.nsScore,e)}get gameComboScoreList(){let e=this.gameComboAvail;return e===0?new Map:this.toScoreMap(this.gameScore,e)}toScoreMap(e,t){const s=new Map,n=e.split(",");if(n.length===0)return s;for(const i of n){if(i.trim().length===0)continue;const o=parseInt(i);s.set(t,o),t++}return s}}function Nn(){const h=(e,t)=>{const s=e;for(const n of s.inst){const i=new Lt;Lt.copy(n,i);const o=new ft;o.resItem=i,o.owner=t,t.itemList.push(o)}};return{gameType:Q.none,editorType:ce.Resource,logType:Me.ResourceEditAction,fromJsonText:Qt.fromJsonText,logToItem:h}}function Gs(){const h=(e,t)=>{const s=e;for(const n of s.inst){const i=new Ht;Ht.copy(n,i);const o=new ft;o.gameItem=i,o.owner=t,t.itemList.push(o)}};return{gameType:Q.none,editorType:ce.GameUI,logType:Me.GameEditAction,fromJsonText:_t.fromJsonText,logToItem:h}}function wn(h){const e=(t,s)=>{const n=t;if(n.gameType===h)for(const i of n.inst){const o=new Bt;Bt.copy(i,o);const l=new ft;l.scItem=o,l.owner=s,s.itemList.push(l)}};return{gameType:h,editorType:ce.ScoreUI,logType:Me.ScoreEditAction,fromJsonText:Zt.fromJsonText,logToItem:e}}class ft{constructor(){this.resItem=new Lt,this.gameItem=new Ht,this.scItem=new Bt}}class as{constructor(){this.gameType=Q.none,this.itemList=new Array,this.initNumItems=10}setConfig(e){e!==void 0&&(this.editorConfig=e,this.gameType=e.gameType)}async loadGameConfig(e){this.setConfig(Gs()),await this.load(ce.GameUI,e);const t=this.itemList.filter(s=>s.gameItem.key===e);if(t.length!==0&&t[0].gameItem.key===e)return t[0].gameItem}setDefaultGameConfig(){this.init(),this.setDefaultGameConfigPq(),this.setDefaultGameConfigMm()}setDefaultGameConfigPq(){this.itemList[0].gameItem.key=Q.classPq,this.itemList[0].gameItem.text="ぷよクエ",this.itemList[0].gameItem.formation="5"}setDefaultGameConfigMm(){this.itemList[1].gameItem.key=Q.classMM,this.itemList[1].gameItem.text="メメントモリ",this.itemList[1].gameItem.formation="5"}init(){this.itemList=new Array;for(let e=0;e<this.initNumItems;e++){const t=new ft;t.owner=this,this.itemList.push(t)}}async load(e,t){const s=this.getEditor(e);if(s===void 0)return;const n=s.logType,o=await(await Le()).get(n);if(o===null){e===ce.GameUI&&this.setDefaultGameConfig();return}const l=n,a=new Map,r=new Array;this.usingLog(l,o,a,r),this.itemList=new Array;for(const[c,m]of a){const f=s.fromJsonText(m.log);s.logToItem(f,this)}this.itemList.length===0&&this.init(),e===ce.GameUI&&(this.itemList[0].gameItem.key.length===0&&this.setDefaultGameConfigPq(),this.itemList[1].gameItem.key.length===0&&this.setDefaultGameConfigMm())}async loadUnused(e){const s=await(await Le()).get(e);if(s===null)return null;const n=new Map,i=new Array;return this.usingLog(e,s,n,i),i}usingLog(e,t,s,n){if(this.editorConfig!==void 0)for(const i of t){let l=this.editorConfig.fromJsonText(i.log).logType,a=!1,r=!1;switch(l){case xe.None:break;case xe.Add:a=!0;break;case xe.Update:a=!0;break;case xe.Delete:a=!0,r=!0;break}if(a)if(r){if(s.has(e)){const c=s.get(e);n.push(c),s.delete(e)}}else{if(s.has(e)){const c=s.get(e);n.push(c),s.delete(e)}s.set(e,i)}}}getEditor(e){return this.editorConfig}get editorType(){return this.editorConfig?.editorType}}class rs{constructor(){this.gameType=Q.none}}function Tn(){function h(){return`${n()}-key`}function e(){return`${n()}-text`}function t(){return`${n()}-comment`}function s(){return`${n()}-delete`}function n(){return`${ce.Resource}-edit-table-row`}const i=(d,g,p,u)=>{const C=new te;C.value=g.resItem.key,C.placeholder="キー",u.getCell(d,p).typeInfo.setInput(C),u.getCell(d,p).className=h(),u.getCell(d,p).typeInfo.using.itemId=p+u.firstRowIndex},o=(d,g,p,u)=>{const C=new te;C.value=g.resItem.text,C.placeholder="文字列",u.getCell(d,p).typeInfo.setInput(C),u.getCell(d,p).className=e(),u.getCell(d,p).typeInfo.using.itemId=p+u.firstRowIndex},l=(d,g,p,u)=>{const C=new te;C.value=g.resItem.comment,C.placeholder="コメント",u.getCell(d,p).typeInfo.setInput(C),u.getCell(d,p).className=t(),u.getCell(d,p).typeInfo.using.itemId=p+u.firstRowIndex},a=(d,g,p,u)=>{u.getCell(d,p).typeInfo.setButton("削除"),u.getCell(d,p).className=s(),u.getCell(d,p).typeInfo.using.itemId=p+u.firstRowIndex},r=async(d,g,p)=>{const u=new Qt;u.logType=xe.Add;for(const S of p){const v=new Lt;for(const y of S.cells)for(const T of y.children){if(T.className===s())continue;const b=g.getElemValue(T)||"";switch(T.className){case h():v.key=b;break;case e():v.text=b;break;case t():v.comment=b;break}}u.inst.push(v)}const C=Qt.toJsonText(u);await(await Le()).put(Me.ResourceEditAction,C)},c=async(d,g)=>{switch(console.log(`classify = ${d.classify} targetId = ${d.targetId}`),d.classify){case s():const p=new be;p.setParent(g.dlgCssClassName());let u=A.None;switch(p.setYesNo(),u=await p.showWait(`${d.targetId} を削除しますか？`),u){case A.Yes:break;case A.No:return;case A.Cancel:return}const C=parseInt(d.targetId);C>=1&&(g.table.deleteRow(C),g.table.redimAllRows(),g.itemList.splice(C-g.table.firstRowIndex,1));break}};function m(){return`
.${h()} {
height: 90%;
}
.${e()} {
...
`.trim()}const c=(y,T,b,N)=>{const w=new te;w.value=T.scItem.key,w.placeholder="キー",N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=h(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},m=(y,T,b,N)=>{const w=new te;w.value=T.scItem.text,w.placeholder="文字列",N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=e(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},f=(y,T,b,N)=>{const w=new ct;w.selectionPair=[`連続/${je.Sequence}`,`文字列/${je.Text}`],w.selectedItem=T.scItem.selectType,w.classify="selectType",N.getCell(y,b).typeInfo.setCombo(w),N.getCell(y,b).className=t(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},d=(y,T,b,N)=>{const w=new te;w.value=T.scItem.start,w.placeholder="開始",w.disableKeyDown=!0,w.enableClicked=!0,N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=s(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},g=(y,T,b,N)=>{const w=new te;w.value=T.scItem.end,w.placeholder="終了",w.disableKeyDown=!0,w.enableClicked=!0,N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=n(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},p=(y,T,b,N)=>{const w=new te;w.value=T.scItem.step,w.placeholder="ステップ",w.disableKeyDown=!0,w.enableClicked=!0,N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=i(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},u=(y,T,b,N)=>{const w=new te;w.value=T.scItem.keyValue,w.placeholder="key/valueを&quot;,&quot;で区切った文字列",w.disableKeyDown=!0,w.enableClicked=!0,N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=o(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},C=(y,T,b,N)=>{N.getCell(y,b).typeInfo.setButton("削除"),N.getCell(y,b).className=l(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},$=async(y,T,b)=>{const N=new Zt;N.logType=xe.Add,N.gameType=y;for(const ne of b){const Z=new Bt;for(const W of ne.cells)for(const ke of W.children){if(ke.className===l())continue;const F=T.getElemValue(ke)||"";switch(ke.className){case h():Z.key=F;break;case e():Z.text=F;break;case t():Z.selectType=F;break;case s():Z.start=F;break;case n():Z.end=F;break;case i():Z.step=F;break;case o():Z.keyValue=F;break}}N.inst.push(Z)}const w=Zt.toJsonText(N);await(await Le()).put(Me.ScoreEditAction,w)},S=async(y,T)=>{switch(console.log(`classify = ${y.classify} targetId = ${y.targetId}`),y.classify){case h():await T.showUpDn(y,$n());break;case s():await T.showUpDn(y,Jt());break;case n():await T.showUpDn(y,Jt());break;case i():await T.showUpDn(y,Jt());break;case o():await T.showMiniTableEditor(y,ae.KeyValue,Ke.asNumber,"スコアキー","スコア値");break;case l():const b=new be;b.setParent(T.dlgCssClassName());let N=A.None;switch(b.setYesNo(),N=await b.showWait(`${y.targetId} を削除しますか？`),N){case A.Yes:break;case A.No:return;case A.Cancel:return}const w=parseInt(y.targetId);w>=1&&(T.table.deleteRow(w),T.table.redimAllRows(),T.itemList.splice(w-T.table.firstRowIndex,1));break}},v=new rs;return v.editItems=[{className:h(),colConfig:c},{className:e(),colConfig:m},{className:t(),colConfig:f},{className:s(),colConfig:d},{className:n(),colConfig:g},{className:i(),colConfig:p},{className:o(),colConfig:u},{className:l(),colConfig:C}],v.makeLog=$,v.onSelect=S,v.getCssText=r,v}function kn(){function h(){return`${a()}-name`}function e(){return`${a()}-form`}function t(){return`${a()}-ns-enable`}function s(){return`${a()}-ns-combo`}function n(){return`${a()}-ns-score`}function i(){return`${a()}-game-enable`}function o(){return`${a()}-game-combo`}function l(){return`${a()}-game-score`}function a(){return`${ce.GameUI}-edit-table`}const r=(y,T,b,N)=>{const w=new te;w.value=T.gameItem.text,w.placeholder="ゲーム名",N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=h(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},c=(y,T,b,N)=>{const w=new te;w.value=T.gameItem.formation,w.placeholder="編成数",w.disableKeyDown=!0,w.enableClicked=!0,N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=e(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex},m=(y,T,b,N)=>{const w=new Yt;w.value=T.gameItem.nsEnable,w.placeholder="NS有効",N.getCell(y,b).typeInfo.setCheck(w),N.getCell(y,b).className=t(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex,N.getCell(y,b).typeInfo.toolTip="N<br>S"},f=(y,T,b,N)=>{const w=new te;w.value=T.gameItem.nsCombo,w.placeholder="コンボ数",w.disableKeyDown=!0,w.enableClicked=!0,N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=s(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex,N.getCell(y,b).typeInfo.toolTip="NSコンボ数"},d=(y,T,b,N)=>{const w=new te;w.value=T.gameItem.nsScore,w.placeholder="NSコンボ加点",w.disableKeyDown=!0,w.enableClicked=!0,N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=n(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex,N.getCell(y,b).typeInfo.toolTip=`NSコンボ加点
(コンボ数毎の加点を,で区切って入力)`},g=(y,T,b,N)=>{const w=new Yt;w.value=T.gameItem.gameEnable,w.placeholder="GM有効",N.getCell(y,b).typeInfo.setCheck(w),N.getCell(y,b).className=i(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex,N.getCell(y,b).typeInfo.toolTip="G<br>M"},p=(y,T,b,N)=>{const w=new te;w.value=T.gameItem.gameCombo,w.placeholder="コンボ数",w.disableKeyDown=!0,w.enableClicked=!0,N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=o(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex,N.getCell(y,b).typeInfo.toolTip="GMコンボ数"},u=(y,T,b,N)=>{const w=new te;w.value=T.gameItem.gameScore,w.placeholder="GMコンボ加点",w.disableKeyDown=!0,w.enableClicked=!0,N.getCell(y,b).typeInfo.setInput(w),N.getCell(y,b).className=l(),N.getCell(y,b).typeInfo.using.itemId=b+N.firstRowIndex,N.getCell(y,b).typeInfo.toolTip=`GMコンボ加点
(コンボ数毎の加点を,で区切って入力)`},C=async(y,T,b)=>{const N=new _t;N.logType=xe.Add;let w=0;for(const Z of b){const W=new Ht;for(const ke of Z.cells)for(const F of ke.children){const ee=T.getElemValue(F)||"";switch(T.findInputElem(F).className){case h():W.text=ee;break;case e():W.formation=ee;break;case t():W.nsEnable=ee;break;case s():W.nsCombo=ee;break;case n():W.nsScore=ee;break;case i():W.gameEnable=ee;break;case o():W.gameCombo=ee;break;case l():W.gameScore=ee;break}}switch(w){case 0:W.key=Q.classPq;break;case 1:W.key=Q.classMM;break}w++,console.log(W),N.inst.push(W)}const _=_t.toJsonText(N);await(await Le()).put(Me.GameEditAction,_)},$=async(y,T)=>{switch(console.log(`classify = ${y.classify} targetId = ${y.targetId}`),y.classify){case e():await T.showNumpad(y,1);break;case s():await T.showNumpad(y,1);break;case n():await T.showMiniTableEditor(y,ae.Text,Ke.asNumber,"","NSコンボ加点");break;case o():await T.showNumpad(y,1);break;case l():await T.showMiniTableEditor(y,ae.Text,Ke.asNumber,"","ゲームコンボ加点");break}};function S(){const y=`${t()}`,T=`${i()}`;return`
.${h()} {
height: 90%;
width: 100px;
}
...
`.trim()}const v=new rs;return v.editItems=[{className:h(),colConfig:r},{className:e(),colConfig:c},{className:t(),colConfig:m},{className:s(),colConfig:f},{className:n(),colConfig:d},{className:i(),colConfig:g},{className:o(),colConfig:p},{className:l(),colConfig:u}],v.makeLog=C,v.onSelect=$,v.getCssText=S,v}function Vs(){return`
width: 100%;
height: 100%;
white-space: nowrap;
...
border-radius: 4px;
padding: 4px 12px;
`.trim()}function $n(){const h=Object.values(B),e=new Array;for(const t of h){const s=t;e.push(`${s}/${s}`)}return e}function Jt(){const h=new Array;h.push("1/1");for(let e=1;e<=30;e++){const t=`${e*10}`;h.push(`${t}/${t}`)}return h}class qt extends as{constructor(){super(...arguments),this.uiInfo=new Ue,this.canAdd=!0,this.parentName="",this.saveTimer=null,this.onAutoSave=async e=>(console.log(`${e.parentName}`),!1),this.updn=null,this.numpad=null,this.miniEdit=null,this.numTableFooterName="numTableFooter",this.onOkClickNumTable=async e=>{if(this.miniEdit!==null){const t=this.miniEdit.editedResult();if(t!==void 0){const s=this.table.getCallerCellElem(this.miniEdit.callerName);if(s!==null){const n=s;n.value=t}}}this.closeNumTable()},this.onCancelClickNumTable=async e=>{this.closeNumTable()},this.isEnableWindowEvent=!1,this.onWindowKeyboard=e=>{e.key===Ze.Escape&&this.isEnableWindowEvent&&(this.disableWindowEvent(),this.closeUpDn(),this.closeNumpad())},this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new H().SaveSetting(e),this.requestActivate!==void 0&&await this.requestActivate(e)},this.resizerOnResizeDone=async(e,t,s)=>{console.log(`[${e.className}] resized (${t}, ${s})`);const n=parseInt(s),i=document.getElementById(this.dlgContentCssClassName());if(i!==null){i.style.width===""?i.offsetWidth:parseInt(i.style.width),i.style.maxWidth="none";const o=i.style.height===""?i.offsetHeight:parseInt(i.style.height);i.style.maxHeight="none",i.style.height=`${o+n}px`;const l=i.querySelectorAll(`.${this.tableCssClassName()}`);if(l!==null){const a=l[0],r=a.style.height===""?a.offsetHeight:parseInt(a.style.height);a.style.maxHeight="none",a.style.height=`${r+n}px`}}},this.onCopyPaste=async(e,t)=>{switch(console.log(`[${e.className}] selected [${t}]`),t){case Ie.Copy:await this.table.toClipboard();break;case Ie.Paste:await this.table.fromClipboard();break}}}async startAutoSave(){this.saveTimer=new bn,this.saveTimer.intervalMs=1e3,this.saveTimer.isOneShot=!1,this.saveTimer.start(this,this.onAutoSave)}setRow(e,t,s){const n=this.config.editItems;if(n===void 0)return;let i=-1;for(const o of n)i++,o.colConfig(i,e,t,s)}toHTML(e){if(!this.itemList)return"";e.gameType=this.gameType,this.config=e;const s=e.editItems.length,n=new Y;if(this.itemList.length>=1)n.makeDim(s,this.itemList.length),this.itemList.forEach((a,r)=>{this.setRow(a,r,n)}),n.makeRowTemplate(this.tableRowCssClassName()),this.table=n;else{n.makeDim(s,1);const a=new ft;this.setRow(a,0,n),n.makeRowTemplate(this.tableRowCssClassName()),n.clearRows(),this.table=n}const i=this.tableCssClassName(),o=this.table.ToScrollHTML(i,i);this.htmlMaker=new D;const l=new se;return l.props.name="",l.props.id=i,l.props.className=i,l.props.option.setTable(o),l.props.option.onSelect=async a=>{console.log(`classify = ${a.classify} targetId = ${a.targetId}`),this.config.onSelect(a,this)},this.htmlMaker.add(l),this.htmlMaker.ToHTML()}checkValidStatus(e){return Object.values(B).find(n=>e)!==void 0}async showUpDn(e,t){if(e.KeyEnter===ge.Special||e.eventType===Pe.Click){if(this.updn!==null)return;const n=this.table.getScrollCellRect(e.parentElem),i=this.table.makeCallerName(e.classify,e.targetId),o=this.table.getCallerCellElem(i);let l="";o!==null&&(l=o.value);const a=new cn;a.setListener("updn",this.dlgContentCssClassName(),i),a.setSelectedByValue(l,t),a.applyCss(),a.show(n.left,n.top),a.enableEvents(r=>{console.log(`[onApply] ${r.callerName} ${r.result}`);const c=this.table.getCallerCellElem(r.callerName);if(c!==null){const m=c;m.value=r.result}this.closeUpDn()},r=>{console.log(`[onUp] ${r.callerName} ${r.result}`)},r=>{console.log(`[onDown] ${r.callerName} ${r.result}`)}),this.enableWindowEvent(),this.updn=a}}closeUpDn(){this.disableWindowEvent(),this.updn!==null&&(this.updn.dispose(),this.updn=null)}async showNumpad(e,t){if(e.KeyEnter===ge.Special||e.eventType===Pe.Click){if(this.numpad!==null)return;const n=this.table.getScrollCellRect(e.parentElem),i=this.table.makeCallerName(e.classify,e.targetId),o=this.table.getCallerCellElem(i);let l="";o!==null&&(l=o.value);const a=new Ps;a.setNum(l),a.maxDig=t,a.setListener("numpad",this.dlgContentCssClassName(),i),a.applyCss(),a.show(n.left,n.top),a.enableEvents(r=>{console.log(`[onApply] ${r.callerName} ${r.result}`);const c=this.table.getCallerCellElem(r.callerName);if(c!==null){const m=c;m.value=r.result}this.closeNumpad()}),this.enableWindowEvent(),this.numpad=a,this.setB2Allow(!1)}}closeNumpad(){this.disableWindowEvent(),this.setB2Allow(!0),this.numpad!==null&&(this.numpad.dispose(),this.numpad=null)}async showMiniTableEditor(e,t,s,n,i){if(e.KeyEnter===ge.Special||e.eventType===Pe.Click){if(this.miniEdit!==null)return;const l=this.table.getScrollCellRect(e.parentElem),a=this.table.makeCallerName(e.classify,e.targetId),r=this.table.getCallerCellElem(a);let c="";r!==null&&(c=r.value);const m=`${a}-numTable`,f=`${this.numTableFooterName}-${a}`,d=new un;if(t===ae.KeyValue?d.setKeyValuePairs(c):d.setTexts(c),d.setValueType(5,s),d.keyToolTip=n,d.valueToolTip=i,d.setListener(m,this.dlgContentCssClassName(),a,"",f),d.applyCss(),d.show(l.left,l.top),d.enableEvents(g=>{console.log(`[onApply] ${g.callerName} ${g.result}`)}),this.miniEdit=d,this.miniEdit.footerElem!==null){let g=`
...
${this.htmlMaker.MakeDefaultButtonsCss()}
`.trim(),document.head.appendChild(o);const l=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,l)}}class ye{constructor(){this.ns=K.None,this.id=0,this.name="",this.contentURL="",this.iconURL=""}static toJsonText(e){const t=ye.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new ye;return t.ns=e.ns,t.id=e.id,t.name=e.name,t.contentURL=e.contentURL,t.iconURL=e.iconURL,t}static fromJsonInst(e){const t=new Te;return t.ns=e.ns,t.id=e.id,t.name=e.name,t.contentURL=e.contentURL,t.iconURL=e.iconURL,t}}class at{constructor(){this.title="",this.key="",this.selectionPair=[],this.selectedVal="",this.initScoreVal=0,this.mulScoreVal=0,this.available=!1}get stdScore(){const e=this.selectedVal.length>=1?this.selectedVal:"1",t=parseInt(e);return this.initScoreVal+t*this.mulScoreVal}get maxScore(){if(this.selectionPair.length===0)return 0;const e=this.selectionPair.length;return this.initScoreVal+e*this.mulScoreVal}get selectedText(){if(this.selectionPair.length!==0&&this.selectedVal!=="")for(const e of this.selectionPair){const t=e.split("/");if(t[1]===this.selectedVal)return t[0]}}}class U{constructor(){this.ns=K.None,this.items=new Array,this.allow=new Map,this.roleText="",this.comboText=""}makeDemoLvText(e){let t="";for(let s=1;s<=100;s++)t+=`"${e}${s}/${s}",`;return t=t.substring(0,t.length-1),t}load(){const e=this.makeDemoLvText("Lv"),t=this.makeDemoLvText("Lv"),s=this.makeDemoLvText(""),n=`
[
    {
        "title": "Ch.Lv",
        "key": "chLvId",
...
`.trim(),document.head.appendChild(o);const l=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,l)}itemCssClassName(){return`${this.listName}-item`}imgCssClassName(){return`${this.listName}-img`}listCssClassName(){return`${this.listName}-list`}dlgCssClassName(){return`${this.parentName}-dlg`}static GetDialogInfo(e){return de.GetDialogInfo(e)}static SetDialogInfo(e){return de.SetDialogInfo(e)}async InitZOrder(e){await e.ForEachAsync(t=>{const s=Ut.GetDialogInfo(t),n=e.FindByName(t);return s!==null&&(s.zindex=n!==null?n.style.zIndex:""),console.log(s),!0})}}class Bs{constructor(){this.cancel=!1}}async function Bn(){const h=new be;h.title="About EvoNa",await h.showWait('EvoNa (Evolution Navigator)<br>Release 1<br><img src="./wallpaper.png" width="64" height="64"></img><br><br>Powered By Gemini/Chromium Tech.')}class At{constructor(){this.dockType=Ee.None,this.iconFileName="",this.toolTip="",this.dlgName="",this.hidden=!1,this.zIndex="",this.topPx="",this.leftPx=""}static toJsonText(e){const t=At.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new At;return t.dockType=e.dockType,t.iconFileName=e.iconFileName,t.toolTip=e.toolTip,e.isUIType&&(t.dlgName=e.dlgParent.id,t.hidden=typeof e.dlgParent.hidden=="string"?!1:e.dlgParent.hidden,t.zIndex=e.dlgParent.style.zIndex,t.leftPx=e.dlgParent.style.left,t.topPx=e.dlgParent.style.top),t}}class Dt{static toJsonText(e){const t=Dt.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new Dt;t.items=new Array;for(const s of e.items)t.items.push(At.toJsonInst(s));return t}restore(e,t){for(const s of this.items){const n=e.items.find(i=>i.dlg.id===s.dlgName);n&&(n.dockType=s.dockType,n.iconFileName=s.iconFileName,n.toolTip=s.toolTip,n.isUIType&&(n.dlgParent.hidden=typeof s.hidden=="string"?!1:s.hidden,n.dlgParent.style.zIndex=s.zIndex,n.dlgParent.style.left=s.leftPx,n.dlgParent.style.top=s.topPx))}t.ReOrder()}}class Hn{constructor(){this.splitTextList=["スキル","（星7）"]}convTitle(e){for(const t of this.splitTextList)if(e.endsWith(t))return`${e.substring(0,e.length-t.length)}<br>${t}`;return e.length<=8,e}}let Kt=null;function es(){return Kt||(Kt=new Hn,console.log("ConvertTools instance created (Singleton)")),Kt}class oe{constructor(){this.comment="",this.fixedType=ue.None}static copy(e,t){t.comment=e.comment,t.fixedType=e.fixedType}}class rt{constructor(){this.chUuid="",this.ch=new Te,this.prop=new oe}setDefault(){this.prop.comment===""&&(this.prop.comment=`${this.ch.name.replace("（星7）","")}(Lv1)`)}}class zs{constructor(){this.chList=new Array,this.uiInfo=new Ue,this.parentName="",this.scoreGrid=new rn,this.gridHeaderName=`${this.dlgCssClassName()}-headerName`,this.gridFooterName=`${this.dlgCssClassName()}-footerName`,this.gridName=`${this.dlgCssClassName()}-gridName`,this.gridRowName=`${this.dlgCssClassName()}-gridRowName`,this.keyClassName=`${this.dlgCssClassName()}-keyClassName`,this.valueClassName=`${this.dlgCssClassName()}-valueClassName`,this.commentClassName=`${this.dlgCssClassName()}-commentClassName`,this.fixedClassName=`${this.dlgCssClassName()}-fixedClassName`,this.nsDefs=[],this.updateItemId=1,this.deleteItemId=2,this.onNotifyWatched=async e=>{const t=e.className.split("-"),s=t.length>=2?t[0]:"",n=this.nsComboCssClassName(),i=document.getElementsByClassName(n);if(i.length>=1){const o=i[0];o.value!==s&&(o.value=s)}},this.onNestedNodeSelect=async e=>{const t=e.callerName,s=t.split("_");if(s.length===0)return;let n=s.find(o=>o.startsWith("uuid"));if(n===void 0)return;n=n.substring(4);const i=this.chList.find(o=>o.chUuid===n);if(i!==void 0)switch(console.log(i),e.result){case`${this.updateItemId}`:this.editingCh=i;const o=i.scoreSet;oe.copy(i.prop,this.savedProp),this.savedScoreSet=new U,U.copy(o,this.savedScoreSet,!0),this.createScoreGrid(i,o),this.htmlMaker.setVisible(this.htmlMaker.defaultToolButtonsCssName,!1),this.nested.setVisible(!1);const l=this.nested.findParentNodeBy(t);console.log(l);const a=this.nested.getCell(l);console.log(a);const r=this.nested.findCell(a,"img");console.log(r);const c=r.src,m=document.createElement("img");m.src=c,m.style.width="100px",m.style.height="100px",this.scoreGrid.headerElem?.appendChild(m);break;case`${this.deleteItemId}`:const f=new be;f.setParent(this.dlgCssClassName());let d=A.None;switch(f.setYesNo(),d=await f.showWait(`${i.ch.name} を削除しますか？`),d){case A.Yes:const g=this.nested.findParentNodeBy(t);console.log(g);const p=this.nested.getChildren(g);console.log(p),this.nested.removeNodeBy(t),p!==null&&p.length===1&&(this.nested.removeNode(g),this.addActionLog(i,$e.Delete));break;case A.No:return;case A.Cancel:return}break}},this.editingCh=null,this.onSelect=async e=>{switch(console.log(`classify = ${e.classify} selectedValue = ${e.selectedValue} targetId = ${e.targetId}`),e.classify){case this.commentClassName:const i=document.getElementsByClassName(this.commentClassName);if(i.length===1){const o=i[0];console.log("** comment input & enter! **",o.value)}return;case this.fixedClassName:this.editingCh!==null&&(this.editingCh.prop.fixedType=e.selectedValue);return}const t=this.editingCh;if(t===null)return;const n=t.scoreSet.items.find(i=>i.key===e.classify);n&&(n.selectedVal=e.selectedValue)},this.savedProp=new oe,this.savedScoreSet=new U,this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new H().SaveSetting(e),this.requestActivate!==void 0&&await this.requestActivate(e)},this.onCopyPaste=async(e,t)=>{console.log(`[${e.className}] selected [${t}]`);const s="charSummary:";switch(t){case Ie.Copy:const n=ut.toJsonText(this);await ie.put(`${s}${n}`);break;case Ie.Paste:const i=await ie.get();if(i===null)break;if(!i.startsWith(s)){const a=new be;a.setParent(this.dlgCssClassName()),await a.showWait(`ペーストデータの形式が不正です<br>${s}`);break}const o=JSON.parse(i.substring(s.length)),l=ut.fromJsonInst(o);this.chList=l.chList,this.nested.disableEvents(),this.nested.reset(),await this.addAllCharNodes(),this.enableLazyImages(this.imageLoader),this.nested.enableEvents(this.onNestedNodeSelect);break}}}async load(){const t=await(await Le()).get(Me.CharSummaryAction);if(t===null)return;const s=new Map,n=new Array;this.usingLog(t,s,n),this.chList=new Array;for(const[i,o]of s){const l=Et.fromJsonText(o.log),a=new Te;Te.copy(l.ch,a);const r=new oe;oe.copy(l.prop,r);const c=new U;U.copy(l.scoreSet,c,!0);const m=new rt;m.chUuid=l.chUuid,m.ch=a,m.prop=r,m.scoreSet=c,m.setDefault(),this.chList.push(m)}}usingLog(e,t,s){for(const n of e){const i=Et.fromJsonText(n.log);if(i.chUuid==="")continue;let o=!1,l=!1;switch(i.logType){case $e.None:break;case $e.Add:o=!0;break;case $e.Update:t.has(i.chUuid)?o=!0:o=!1;break;case $e.Delete:o=!0,l=!0;break}if(o)if(l){if(t.has(i.chUuid)){t.delete(i.chUuid);const a=t.get(i.chUuid);s.push(a)}}else{if(t.has(i.chUuid)){const a=t.get(i.chUuid);s.push(a),t.delete(i.chUuid)}t.set(i.chUuid,n)}}}sortByScore(){if(this.chList.length===0)return null;const e=new Array;for(const s of this.chList){const n=new Te;Te.copy(s.ch,n);const i=new U;U.copy(s.scoreSet,i,!0);const o=new rt;o.chUuid=s.chUuid,o.ch=n,oe.copy(s.prop,o.prop),o.setDefault(),o.scoreSet=i,e.push(o)}return e.sort((s,n)=>n.scoreSet.stdScore-s.scoreSet.stdScore)}toHTML(){return this.htmlMaker=new D,this.htmlMaker.ToHTML()}createSummaryBox(e,t,s){this.parentName=t;let n=`
...
`.trim();this.htmlMaker.defaultToolButtonsCssName=`${this.dlgCssClassName()}-tool-btns`;const i=this.htmlMaker.MakeDefaultToolButtonsHTML(n),o=`<div class="${this.dlgContentCssClassName()}" id="${this.dlgContentCssClassName()}">
    ${i}
    ${s}
</div>`,l=new de;l.title="<"+e+">",l.SetB2Type(Fe.CopyPaste,this.onCopyPaste);const a=l.NewDialog(t,this.dlgCssClassName());return l.SetContent(t,o),this.applyCss(),l.EnableEventHandlers(),l.onMoveDone=this.moverOnMoveDone,a}addEventHandlers(e,t){this.onAdd=t,document.getElementById(`${this.itemAddCssClassName()}`).onclick=async()=>{if(this.onAdd===void 0)return;const s=new An;await this.onAdd(s),s.cancel!==!0&&await this.onItemAdd(s)}}async createCharSummaryNodes(e,t){this.imageLoader=e;const s=new fn;s.init(),s.setListener("charNodes",this.dlgContentCssClassName(),this.dlgContentCssClassName()),this.nested=s,this.nsDefs=t,await this.addAllCharNodes(),s.setSize("400"),s.applyCss()}async showCharSummaryNodes(){this.nested.enableOverlay(!1);let e=10,t=e;const s=document.getElementsByClassName(this.dlgContentCssClassName());if(s.length>=1){const i=s[0].getElementsByClassName(this.htmlMaker.defaultToolButtonsCssName);if(i.length>=1){const o=i[0],l=this.htmlMaker.GetRect(o);console.log("toolRc",l),t=e+Number(l.height)}if(i.length>=1){const o=this.nsComboCssClassName(),l=this.createNsCombo(o);i[0].appendChild(l)}}this.nested.show("0",`${t}`),this.nested.enableEvents(this.onNestedNodeSelect),this.nested.startWatch(this.onNotifyWatched)}createNsCombo(e){let t=-1,s="";for(const i of this.nsDefs){t++;const o=i.ns,l=i.nsName,r=`
 <option value="${o}"${t===0?" selected":""}>${l}</option>
`.trim();s+=r}const n=document.createElement("select");return n.id=e,n.className=e,n.innerHTML=s,n.addEventListener("change",i=>{const o=i.target,l=this.nested.findNodeBy(o.value);l!==null&&this.nested.scroll(l)}),n}getCharUuidClassName(e){const t=e.ch,s=t.ns,n=`${s}_${t.name}_${t.id}`;if(this.nested.findNodeBy(s)===null)return null;const o=n;return`${this.nested.findNodeBy(o).className}_uuid${e.chUuid}`}async addAllCharNodes(){this.nested.createRoot();const e=this.nested.topTableElem;for(const t of this.nsDefs){const s=new Mt;s.enableWatchNotify=!0,this.nested.createNode(e,t.ns,s);const n=this.nested.findNodeBy(t.ns),i=this.nested.makeTextCell(`${t.ns}Label`,t.nsName,`${t.nsName}グループ`).ToHTML();this.nested.setCellContent(n,0,i)}for(const t of this.chList)await this.addCharNode(this.nested,t,!0);console.log("**[TOP]**",this.nested.findNodeBy(this.nested.rootName))}async addCharNode(e,t,s){const n=t.ch,i=n.ns,o=`${i}_${n.name}_${n.id}`,l=e.findNodeBy(i);if(l===null)return null;const a=o;let r=e.findNodeBy(a);if(r===null){e.createNode(l,a),r=e.findNodeBy(a);let y=await this.imageLoader.getImageUrlBy(n.iconFileName,n.ns),T="",b=n.name,N=e.makeImgCell(`${a}Img`,y,T,b).ToHTML();e.setCellContent(r,0,N)}let c=`${r.className}_uuid${t.chUuid}`;const m=new Mt;m.numCell=2,e.createNode(r,c,m);const f=e.findNodeBy(c);let d=t.prop.comment,g=this.getChScoreText(t);const u=es().convTitle(d),C=`${d}${g}`;let $=e.makeTextCell(`${c}`,u,C).ToHTML();e.setCellContent(f,0,$);const S=e.makeBtnCell(`${c}`,"更新","更新",this.updateItemId).ToHTML(),v=e.makeBtnCell(`${c}`,"削除","削除",this.deleteItemId).ToHTML();return e.setCellContent(f,1,S+v),f}getChScoreText(e){let t="";for(const s of e.scoreSet.items){let n=s.selectedText;n=n===void 0?"*bug*":n,t+=vt.toolTipNewLine+s.title+"："+n+"("+Math.ceil(s.stdScore)+")"}return t}createScoreGrid(e,t){const s=this.dlgContentCssClassName(),n=es(),i=this.scoreGrid.makePair();this.setCommentPair(e,i),this.setFixedFormPair(e,i);for(const o of t.items){const l=n.convTitle(o.title),a=o.title,r=this.scoreGrid.makeKeyCell(l,this.keyClassName,a),c=new ct;c.selectionPair=o.selectionPair,c.selectedItem=o.selectedVal,c.classify=o.key;const m=new Ce;m.makeItems(),m.items[0].typeInfo.setCombo(c),m.items[0].className=this.valueClassName,i.set(r,m)}if(this.scoreGrid.setPair(i),this.scoreGrid.setListener(this.gridName,this.gridRowName,s,this.gridHeaderName,this.gridFooterName),this.scoreGrid.enableEvents(this.onSelect),this.scoreGrid.footerElem!==null){let o=`
<button id="${this.gridFooterName}-okBtn">OK</button>
<button id="${this.gridFooterName}-canBtn">CANCEL</button>
`.trim();this.scoreGrid.footerElem.innerHTML=o,document.getElementById(`${this.gridFooterName}-okBtn`).onclick=async()=>{const l=this.editingCh;if(l===null)return;l.scoreSet;const a=document.getElementsByClassName(this.commentClassName);if(a.length===1){const r=a[0];l.prop.comment=r.value}this.addActionLog(l,$e.Update),this.removeScoreGrid(),this.updateChScoreInfo(this.editingCh)},document.getElementById(`${this.gridFooterName}-canBtn`).onclick=async()=>{const l=this.editingCh;if(l===null)return;l.prop.comment=this.savedProp.comment;const a=l.scoreSet;U.copy(this.savedScoreSet,a),this.removeScoreGrid()}}}setCommentPair(e,t){const s=e.prop.comment.trim(),n="キャラ情報を入力",i=this.scoreGrid.makeKeyCell("キャラ情報",this.keyClassName,n),o=new te;o.value=s,o.placeholder=n;const l=new Ce;l.makeItems(),l.items[0].typeInfo.setInput(o),l.items[0].className=this.commentClassName,l.items[0].typeInfo.using.itemId=1,t.set(i,l)}setFixedFormPair(e,t){const i=this.scoreGrid.makeKeyCell("固定枠",this.keyClassName,"自動編成の固定枠を選択");let o=new Array,l="";for(const[c,m]of As){const f=`${m}/${c}`;o.push(f),e.prop.fixedType===c&&(l=c)}const a=new ct;a.selectionPair=o,a.selectedItem=l,a.classify=this.fixedClassName;const r=new Ce;r.makeItems(),r.items[0].typeInfo.setCombo(a),r.items[0].className=this.fixedClassName,t.set(i,r)}removeScoreGrid(){if(this.scoreGrid.headerElem!==null){let e=this.scoreGrid.headerElem.children[0];e!==null&&(e.remove(),e=null)}this.scoreGrid!==null&&(this.scoreGrid.dispose(),this.htmlMaker.setVisible(this.htmlMaker.defaultToolButtonsCssName,!0),this.nested.setVisible(!0))}async onItemAdd(e){const t=new be;t.setParent(this.dlgCssClassName());let s=A.None;if(t.setYesNo(),s=await t.showWait(`${e.selectCh.name} を追加しますか？`),s===A.No)return;const n=new rt;n.chUuid=on(),n.ch=e.selectCh,n.ch.iconURL=e.selectedImg,n.scoreSet=e.scoreSet,n.setDefault(),this.chList.push(n);const i=await this.addCharNode(this.nested,n,!1);i!==null&&(this.nested.scroll(i),this.addActionLog(n,$e.Add))}async addActionLog(e,t){const s=new Et;s.logType=t,s.chUuid=e.chUuid,s.ch=e.ch,s.prop=e.prop,s.scoreSet=e.scoreSet;const n=Et.toJsonText(s);await(await Le()).put(Me.CharSummaryAction,n)}updateChScoreInfo(e){const t=this.getCharUuidClassName(e);if(t===null)return;const s=this.nested.findNodeBy(t);let n=this.getChScoreText(e);const i=`${e.prop.comment}`,o=`${i}${n}`;let l=this.nested.makeTextCell(`${t}`,i,o).ToHTML();this.nested.setCellContent(s,0,l)}enableLazyImages(e){this.htmlMaker.initObserver(this.dlgCssClassName(),e),this.imageLoader=e}itemAddCssClassName(){return"char-summary-add"}nsComboCssClassName(){return`${this.dlgCssClassName()}-nscombo`}dlgContentCssClassName(){return`${this.dlgCssClassName()}-content`}dlgCssClassName(){return"char-summary-dlg"}applyCss(){const e=parseInt(this.uiInfo.left),t=parseInt(this.uiInfo.top),s=document.createElement("style");s.textContent=`
${this.htmlMaker.MakeDefaultDialogParentCss(this.parentName,e,t)}
${this.htmlMaker.MakeDefaultDialogCss(this.dlgCssClassName())}
.${this.dlgContentCssClassName()} {
  width: 100%;
...
`.trim(),document.head.appendChild(s);const n=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,n)}}class An{constructor(){this.cancel=!1}}const $e={None:"None",Add:"Add",Delete:"Delete",Update:"Update"};class Et{constructor(){this.logType=$e.None,this.chUuid=""}static toJsonText(e){return JSON.stringify(e,null,2)}static fromJsonText(e){return JSON.parse(e)}}class ht{constructor(){this.chUuid="",this.ch=new ye,this.prop=new oe}static toJsonText(e){const t=ht.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new ht;return t.chUuid=e.chUuid,t.ch=ye.toJsonInst(e.ch),oe.copy(e.prop,t.prop),t.scoreSet=e.scoreSet,t}static fromJsonInst(e){const t=new rt;return t.ch=ye.fromJsonInst(e.ch),oe.copy(e.prop,t.prop),t.scoreSet=new U,U.copy(e.scoreSet,t.scoreSet,!0),t}}class ut{constructor(){this.items=new Array}static toJsonText(e){const t=ut.toJsonInst(e);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new ut;t.items=new Array;for(const s of e.chList)t.items.push(ht.toJsonInst(s));return t}static fromJsonInst(e){const t=new zs;t.chList=new Array;for(const s of e.items)t.chList.push(ht.fromJsonInst(s));return t}}class Dn{constructor(){this.TextMap=new Map}set(e,t){const s=this.TextMap.has(e);return this.TextMap.set(e,t),s}remove(e){const t=this.TextMap.has(e);return t&&this.TextMap.delete(e),t}get count(){return this.TextMap.size}clear(){this.TextMap.clear()}forEach(e){if(e===void 0)return;let t=!1;for(const[s,n]of this.TextMap)if(t=e(s,n),t)break;return t}values(){const e=new Map;for(const[t,s]of this.TextMap)e.set(t,parseInt(s));return e}}class Js{constructor(e=0,t=""){this.ch=new Te,this.prop=new oe,this.isEmpty=!0,this.details=new Dn,this.ch.id=e,this.ch.name=t}set(e,t){const s=this.details.TextMap.has(e);return this.details.set(e,t),s}get values(){return this.details.values()}get itemID(){const e=this.itemKey,t=this.ch.idAttributeForHTML.substring(e.length);let s=parseInt(t);return s<=0?-1:s}get itemKey(){return"chuid"}}class ts{constructor(){this.nFormationItem=5,this.uiInfo=new Ue}Init(){this.items=new Array;for(let e=0;e<this.nFormationItem;e++)this.items.push(new Js)}put(e,t){const s=this.items.find(n=>this.isExistCh(n,t));return s!==void 0&&s.isEmpty===!1?!1:(e.ch.ns=t.ns,e.ch.id=t.id,e.ch.name=t.name,e.isEmpty=!1,!0)}empty(e){const t=e.isEmpty;return e.isEmpty=!0,e.isEmpty!=t}isExistCh(e,t){return e.ch.name===t.name&&e.ch.id===t.id}equalsFormationItem(e,t){return e.ch.name===t.ch.name&&e.ch.id===t.ch.id}}class De{constructor(){this.autoScoreType=we.High}static copy(e,t){t.autoScoreType=e.autoScoreType}}class Rn{constructor(){this.emptyFile="plus.png",this.autoForm=!1,this.editFormEnable=!1,this.saveEnable=!1,this.enableScoreEvent=!1,this.parentName="",this.listName="",this.gridHeaderName=`${this.dlgCssClassName()}-headerName`,this.gridFooterName=`${this.dlgCssClassName()}-footerName`,this.gridName=`${this.dlgCssClassName()}-gridName`,this.scoreGrid=null,this.editingIndex=-1,this.onNotifyLvg=async e=>{if(e.classify===We.Ok){const t=e.notify,s=t.checkedRow();s!==-1&&(t.dispose(),await this.autoFormationApply(s))}e.classify===We.Cancel&&e.notify.dispose()},this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new H().SaveSetting(e),this.requestActivate!==void 0&&await this.requestActivate(e)},this.onScoreGridOpen=async e=>{console.log(`notifty id     = ${e.item.props.id}`),console.log(` targetId      = ${e.targetId}`),console.log(` classify      = ${e.classify}`),console.log(` selectedValue = ${e.selectedValue}`);const t=e.item.props.id,s=parseInt(t)-1;if(0<=s&&s<this.formation.items.length){const n=`${this.propItemCssClassName()}-${t}`;if(this.htmlMakerProp.IsEnabledId(n)!==!0)return;if(this.enableScoreEvent){const o=this.formation.items[s];if(o.ch.id===0){console.log("*bug?*");return}const l=await this.loadScoreConfig(o,s);l!==null&&this.makeFlyoutGrid(l,s)}}else console.log(`invalid index = ${s}`)},this.savedOpt=new De,this.savedScoreSet=new U,this.onScoreValueSelect=async e=>{if(console.log(`[onScoreValueSelect] callerName=${e.callerName}, result=${e.result}`),e.callerName===B.cmAutoScore){const n=this.formationOptList[this.editingIndex];n.autoScoreType=e.result;return}const s=this.scsList[this.editingIndex].items.find(n=>n.key===e.callerName);s!==void 0&&(s.selectedVal=e.result)},this.onOkClickScoreGrid=async e=>{const t=this.formation.items[this.editingIndex],s=this.scsList[this.editingIndex];this.disposeScorGrid(),await this.notifyChangeScore(t,s)},this.onCancelClickScoreGrid=async e=>{const t=this.formationOptList[this.editingIndex];De.copy(this.savedOpt,t);const s=this.scsList[this.editingIndex];U.copy(this.savedScoreSet,s),this.disposeScorGrid()},this.onCopyPaste=async(e,t)=>{console.log(`[${e.className}] selected [${t}]`);const s="formation:";switch(t){case Ie.Copy:const n=ve.toJsonText(this.formation,this.scsList,this.formationOptList);await ie.put(`${s}${n}`);break;case Ie.Paste:const i=await ie.get();if(i===null)break;if(!i.startsWith(s)){const r=new be;r.setParent(this.dlgCssClassName()),await r.showWait(`ペーストデータの形式が不正です<br>${s}`);break}const o=JSON.parse(i.substring(s.length)),l=this.selectedItem.itemID;this.formation.Init();let a=-1;for(const r of o.items){a++,this.formation.items[a]=dt.fromJsonInst(r);const c=this.formation.items[a];c.ch.idAttributeForHTML=`${c.itemKey}${a+1}`}if(this.enableScoreEvent===!0)if(o.formationOptList.length>=1){this.formationOptList=new Array;for(const r of o.formationOptList){const c=new De;De.copy(r,c),this.formationOptList.push(c)}}else for(const r of this.formationOptList)r.autoScoreType=we.None;else this.formationOptList=new Array;this.scsList=new Array;for(const r of o.scsList){const c=new U;U.copy(r,c,!0),this.scsList.push(c)}a=-1;for(const r of this.formation.items){a++;let c=!1;if(r.isEmpty?await this.charEmptyItem(r):(await this.charPutItem(r),c=!0),this.enableScoreEvent!==!1){const f=`${this.propItemCssClassName()}-${a+1}`;this.htmlMakerProp.EnableId(f,c)}const m=this.scsList[a];await this.notifyChangeScore(r,m)}this.selectedItem=this.formation.items[l-1];break}}}InitForEnemy(e){this.charDB=e,this.formation=new ts,this.formation.Init(),this.enableScoreEvent=!0,this.initScoreOptions(),this.initScsList()}InitForPlayer(e){this.charSummary=e,this.autoFormation()}initScsList(){this.scsList=new Array;const e=this.formation.nFormationItem;for(let t=0;t<e;t++){const s=new U;this.scsList.push(s)}}initScoreOptions(){this.formationOptList=new Array;const e=this.formation.nFormationItem;for(let t=0;t<e;t++){const s=new De;this.formationOptList.push(s)}}async Setup(e,t){if(!e)return;this.formation=e;let s=0;for(const n of this.formation.items){n.isEmpty?this.formation.empty(n):this.formation.put(n,n.ch),s++;const i=`${n.itemKey}${s}`;n.ch.idAttributeForHTML=i;const o=n.isEmpty?this.emptyFile:n.ch.iconFileName,l=await t.getImageUrlBy(o,n.ch.ns);if(l===null)return;this.htmlMakerChSel.ReplaceImg(this.itemCssClassName(),n.ch.idAttributeForHTML,l)}}async toHTML(e){if(!this.formation)return"";this.listName=e,this.htmlMakerChSel=new D;let t=0;for(const s of this.formation.items){const n=s.ch;t++;const i=`${s.itemKey}${t}`;n.idAttributeForHTML=i;const o="",l=s.isEmpty?this.emptyFile:n.iconFileName,a=new Pt;a.imgSrc=o,a.imgFile=l;const r=new se;r.props.name=this.itemCssClassName(),r.props.id=i,r.props.className=this.imgCssClassName(),r.props.option.setImg(a),r.props.option.toolTip=n.name,r.props.option.onSelect=c=>{console.log(`notifty id = ${c.item.props.id}`),this.setSelectedItem(c.item.props.id)},this.htmlMakerChSel.add(r)}return this.htmlMakerChSel.MakeScrollableList(this.listCssClassName())}toGridHTML(){this.htmlMakerProp=new D;let e=0;for(const t of this.formation.items){t.ch;const s=this.scsList[e];e++;for(const i of s.items)t.details.set(i.key,i.selectedVal);const n=new se;n.props.name=`${this.propItemCssClassName()}-${e}`,n.props.id=`${e}`,n.props.className=`${this.propItemCssClassName()}`,n.props.option.setButton("スコア"),n.props.option.using.itemId=e,n.props.option.onSelect=this.onScoreGridOpen,this.htmlMakerProp.add(n)}return this.htmlMakerProp.MakeScrollableList(this.propCssClassName())}async autoFormation(){const e=this.formation!==void 0?this.formation.uiInfo:void 0;this.formation=new ts,this.formation.Init(),e===void 0&&this.initScsList(),e!==void 0&&(this.formation.uiInfo=e),await this.makeLvwGroup(this.imgLoader)}async autoFormationApply(e){const t=this.charSummary.sortByScore();if(t===null||t.length===0)return console.log("[autoFormationApply] sortedChSummary.length === 0"),!1;const s=this.formation.nFormationItem,n=this.moveLockedFormation(s);if(n===null)return console.log("[autoFormationApply] lockInfo === null"),!1;const i=n[0],o=n[1],l=t.length;let a=Math.floor(l/s);l%s&&a++;let r=0,c=-1,m=!1;for(let p=0;p<a;p++)if(i[p]){if(r++,r===e){c=p,m=!0;break}if(r++,r===e){c=p;break}}else{if(r++,r!==e)continue;c=p;break}if(c===-1)return;this.initScsList();const f=c*s;if(m){console.log("**lock form selected**",m,c,o[c]);for(let p=0;p<s;p++){let u=o[c][p],C=!1;switch(u){case-1:u=f+p;break;case-2:C=!0;break}console.log("->",u);const $=this.formation.items[p];C?this.formation.empty($):(this.formation.put($,t[u].ch),oe.copy(t[u].prop,$.prop),U.copy(t[u].scoreSet,this.scsList[p],!0))}}else{console.log("**normal form selected**",f);for(let p=0;p<s;p++){let u=!1;f+p>=t.length&&(u=!0);const C=f+p;console.log("->",C);const $=this.formation.items[p];u?this.formation.empty($):(this.formation.put($,t[C].ch),oe.copy(t[C].prop,$.prop),U.copy(t[C].scoreSet,this.scsList[p],!0))}}let d=0;for(const p of this.formation.items){d++;const u=`${p.itemKey}${d}`;p.ch.idAttributeForHTML=u,p.isEmpty?await this.charEmptyItem(p):await this.charPutItem(p),await this.notifyChangeScore(p,this.scsList[d-1])}this.formation.items.find(p=>p.ch.ns!==K.None)!==void 0&&(this.selectedItem=this.formation.items[0])}moveLockedFormation(e){let t=Math.floor(e/3);if(t<0||t>3)return null;const s=this.charSummary.sortByScore();if(s===null||s.length===0)return console.log("[moveLockedFormation] sortedChSummary.length === 0"),null;let n=s.length,i=Math.floor(n/e);n%e&&i++;const o=new Array,l=new Array;for(let C=0;C<i;C++)o.push(new Array),l.push(!1);let a=0;for(let C=0;C<i;C++){let $=0;for(;$<e;)a>=n?(o[C].push(-2),s.push(new rt)):s[a].prop.fixedType===ue.None?o[C].push(-1):o[C].push(a),$++,a++}const r=new Map([[3,[1,1]],[4,[1,2]],[5,[1,2]],[6,[1,2]],[7,[1,3]],[8,[1,3]],[9,[1,3]]]),c=new Map([[3,[2,2]],[4,[3,3]],[5,[3,3]],[6,[3,4]],[7,[4,5]],[8,[4,5]],[9,[4,6]]]),m=new Map([[3,[3,3]],[4,[4,4]],[5,[4,5]],[6,[5,6]],[7,[6,7]],[8,[6,8]],[9,[7,9]]]),f=new Map([[ue.Front,r],[ue.Center,c],[ue.Backend,m]]);function d(C){let $=-1;for(const S of C){if(S<0)continue;if(s[S].prop.fixedType!==ue.None){$=S;break}}return $}function g(C){let $=-1;for(const S of C){if(S<0)continue;const v=s[S].prop.fixedType,y=f.get(v);if(y===void 0)continue;const T=y.get(e);if(T===void 0)continue;let b=T[0]-1,N=T[1]-1;for(let w=b;w<=N;w++){if(C[w]===-1){$=w;break}if(C[w]===-2){console.log(`[findToIndex] move to space-form(${w})`),$=w;break}}if($!==-1)break}return $}let p=0,u=0;for(const C of o){for(;;){const $=d(C);if($===-1)break;const S=g(C);if(S!==-1){console.log(`move from ${$} -> ${u+S}`);const v=C[$%e];s[v].prop.fixedType=ue.None,C[$%e]=u+S,C[S]=v,l[p]=!0}}p++,u+=e}return[l,o]}async makeLvwGroup(e){if(e===void 0)return console.log("[makeLvwGroup] not initialized imgLoader"),!1;const t=this.charSummary.sortByScore();if(t===null||t.length===0)return console.log("[makeLvwGroup] sortedChSummary.length === 0"),!1;const s=this.formation.nFormationItem,n=this.moveLockedFormation(s);if(n===null)return console.log("[makeLvwGroup] lockInfo === null"),!1;const i=n[0],o=n[1];console.log("lockInfo",i,o);const l=t.length;let a=Math.floor(l/s);l%s&&a++;const r=new Array;for(let C=0;C<a;C++)r.push(C+1);const c="player",m=new zt;let f=0,d=0;for(const C of r){if(i[C-1]){d++;const T=C-1,b=o[T],N=m.makeCheckHeader(`${c}Header`,`Locked Form${C}`,`${d}`),w=new Array;let _=0;for(const Z of b){const W=new Ms;if(Z===-2||Z>=l){const F=this.emptyFile,ee=await e.getImageUrlBy(F,"");if(ee===null)continue;W.url=ee,W.toolTip=""}else{let F=Z===-1?C-1+_:Z;const ee=t[F],Ge=ee.ch,yt=Ge.iconFileName,He=await e.getImageUrlBy(yt,Ge.ns);if(He===null)continue;W.url=He,W.toolTip=ee.prop.comment+vt.toolTipNewLine+As.get(ee.prop.fixedType)}w.push(W),_++}const ne=m.makeImgSubTbl(`${c}SubTbl`,w,`${d}`);m.addGroupPair(N,ne)}d++;const $=m.makeCheckHeader(`${c}Header`,`Form${C}`,`${d}`),S=new Array;let v=0;for(;v<s;){const T=new Ms;if(f>=l){const b=this.emptyFile,N=await e.getImageUrlBy(b,"");if(N===null)continue;T.url=N,T.toolTip=""}else{const b=t[f],N=b.ch,w=N.iconFileName,_=await e.getImageUrlBy(w,N.ns);if(_===null)continue;T.url=_,T.toolTip=b.prop.comment}S.push(T),v++,f++}const y=m.makeImgSubTbl(`${c}SubTbl`,S,`${d}`);m.addGroupPair($,y)}m.makeFooter(),m.setListener(c,this.listCssClassName(),this.listCssClassName()),m.setFontConfig("0.9");const p=document.getElementById(this.dlgContentCssClassName()).getElementsByClassName(this.htmlMakerChSel.defaultToolButtonsCssName),u=this.htmlMakerChSel.GetRect(p[0]);return m.show("0",`${parseInt(u.height)+10}`),m.setSize("350"),m.applyCss(),m.setCheckByRow(zt.allRowAction),m.setCheck(),m.selectFirstCell(zt.allRowAction),m.enableEvents(this.onNotifyLvg),!0}createFormationBox(e,t,s,n){this.parentName=t;let i=`
...
`.trim();const m=this.htmlMakerChSel.MakeDefaultToolButtonsHTML(c),f="";let d="";n!==""?d=`<div class="${this.dlgContentCssClassName()}" id="${this.dlgContentCssClassName()}">
    ...
    ${s}
    ${f}
</div>`;const g=new de;g.title="<"+e+">",g.SetB2Type(Fe.CopyPaste,this.onCopyPaste),g.SetB4Type(Se.DialogHide);const p=g.NewDialog(t,this.dlgCssClassName());return g.SetContent(t,d),this.applyCss(),g.EnableEventHandlers(),g.onMoveDone=this.moverOnMoveDone,p}addEventHandlers(e){const t=document.getElementById(`${this.dlgCssClassName()}-auto`);t!==null&&(t.onclick=async()=>{await this.onAutoPut()});const s=document.getElementById(`${this.dlgCssClassName()}-tbView`);s!==null&&(s.onclick=async()=>{await this.onCharView()});const n=document.getElementById(`${this.dlgCssClassName()}-tbput`);n!==null&&(n.onclick=async()=>{await this.onCharPut()});const i=document.getElementById(`${this.dlgCssClassName()}-tbempty`);i!==null&&(i.onclick=async()=>{await this.onCharEmpty()});const o=document.getElementById(`${this.dlgCssClassName()}-tbLeft`);o!==null&&(o.onclick=async()=>{await this.onCharLeft()});const l=document.getElementById(`${this.dlgCssClassName()}-tbRight`);l!==null&&(l.onclick=async()=>{await this.onCharRight()});const a=document.getElementById(`${this.dlgCssClassName()}-stock`);a!==null&&(a.onclick=async()=>{if(this.onStock!==void 0){if(this.selectedItem.ch.ns===K.None)return;const r=this.htmlMakerChSel.FindImgByID(this.itemCssClassName(),this.selectedItem.ch.idAttributeForHTML),c=new Wt;c.item=this.selectedItem,c.selectedImg=r===null?"":r.src;const m=this.findPropSelectedPos();m!==-1&&(c.scoreSet=this.scsList[m]),await this.onStock(c)}})}addItemEventkHandlers(e,t,s,n){this.onStock=s,this.onPut=e,this.onEmpty=t,this.onPropChanged=n;const i=this.htmlMakerChSel.GetIdByIndex(0);if(this.htmlMakerChSel.SelectByID(this.itemCssClassName(),i),this.htmlMakerChSel.enableEvents(this.itemCssClassName()),this.enableScoreEvent===!0){let o=0;for(const l of this.formation.items){o++;const a=`${this.propItemCssClassName()}-${o}`;this.htmlMakerProp.EnableId(a,!1)}this.htmlMakerProp.enableEvents(this.propCssClassName())}this.setSelectedItem(i)}async onAutoPut(){await this.autoFormation()}async notifyChangeForm(){for(const e of this.formation.items)await this.notifyChangeFormItem(e)}async notifyChangeFormItem(e){e.isEmpty?await this.notiftyOnEmpty(e):await this.notiftyOnPut(e,e.ch.iconFileName)}async notiftyOnPut(e,t){const s=new Wt;return s.uiName=this.formation.uiInfo.name,s.item=e,s.selectedImg=t,await this.onPut(s),s}async notiftyOnEmpty(e){const t=new Wt;return t.uiName=this.formation.uiInfo.name,t.item=e,t.selectedImg=this.emptyFile,await this.onEmpty(t),t}async notifyChangeScore(e,t){const s=new Fn;s.uiName=this.parentName,s.item=e,s.values=e.values,s.scoreConfigSet=t,await this.onPropChanged(s)}async onCharView(){await this.requestToToolTipMgr(mt.Add)}async requestToToolTipMgr(e){if(this.requestToolTip!==void 0){const t=this.selectedItem.itemID-1;if(await this.loadScoreConfig(this.selectedItem,t)!==null){const n=this.selectedItem.prop.comment!==""?this.selectedItem.prop.comment:this.selectedItem.ch.name,i=new yn;i.reqType=e,i.parentClassName=this.dlgCssClassName(),i.uiName=this.formation.uiInfo.name,i.itemName=`${this.selectedItem.ch.iconFileName}`,i.title=n,i.content=n+this.scsList[this.selectedItem.itemID-1].getScoreText(vt.toolTipNewLine),await this.requestToolTip(i)}}}async onCharPut(){if(this.onPut!==void 0){this.selectedItem.isEmpty=!1;const e=await this.notiftyOnPut(this.selectedItem,"");if(this.formation.put(this.selectedItem,e.selectCh),this.replaceCharImg(this.selectedItem.ch.idAttributeForHTML,e.selectedImg,this.selectedItem.ch.name),this.propSelectedEnabled(!0),this.findPropSelectedPos()!==-1){const s=this.selectedItem.itemID-1,n=await this.loadScoreConfig(this.selectedItem,s);n!==null&&await this.notifyChangeScore(this.selectedItem,n)}}}async onCharEmpty(){if(this.onEmpty!==void 0){this.selectedItem.isEmpty=!0;const e=await this.notiftyOnEmpty(this.selectedItem);this.formation.empty(this.selectedItem),this.replaceCharImg(this.selectedItem.ch.idAttributeForHTML,e.selectedImg,""),this.propSelectedEnabled(!1);const t=this.findPropSelectedPos();t!==-1&&(this.scsList[t]=new U),await this.requestToToolTipMgr(mt.Remove)}}async onCharLeft(){this.canSwap(1)&&await this.formSwap(-1)}async onCharRight(){this.canSwap(this.formation.nFormationItem)&&await this.formSwap(1)}canSwap(e){return!(this.selectedItem===void 0||this.selectedItem.isEmpty===!0||this.selectedItem.itemID===e)}async formSwap(e){const t=this.selectedItem,s=t.itemID-1,n=s+e,i=this.formation.items[n],o=t.ch.idAttributeForHTML,l=i.ch.idAttributeForHTML,a=this.scsList[s],r=this.scsList[n],c=this.itemCssClassName(),m=this.htmlMakerChSel.FindImgByID(c,o),f=this.htmlMakerChSel.FindImgByID(c,l);if(m!==null&&f!==null){this.htmlMakerChSel.SwapImgSrcAndPairToolTip(m,f);const d=`${i.itemKey}${i.itemID}`;this.htmlMakerChSel.UnselectAll(c),this.htmlMakerChSel.SelectByID(c,d),this.formation.items[s]=i,this.formation.items[n]=t,this.formation.items[s].ch.idAttributeForHTML=o,this.formation.items[n].ch.idAttributeForHTML=l,this.scsList[s]=r,this.scsList[n]=a,this.setSelectedItem(d);const g=this.formation.items[n],p=this.formation.items[s];this.enableScoreEvent&&(this.propAutoEnabled(g),this.propAutoEnabled(p)),await this.notifyChangeFormItem(g),await this.notifyChangeFormItem(p),await this.notifyChangeScore(g,this.scsList[s]),await this.notifyChangeScore(p,this.scsList[n])}}async charPutItem(e){const t=await this.notiftyOnPut(e,e.ch.iconFileName);this.replaceCharImg(e.ch.idAttributeForHTML,t.selectedImg,e.prop.comment)}async charEmptyItem(e){const t=await this.notiftyOnEmpty(e);this.replaceCharImg(e.ch.idAttributeForHTML,t.selectedImg,"")}replaceCharImg(e,t,s){this.htmlMakerChSel.ReplaceImg(this.itemCssClassName(),e,t),this.htmlMakerChSel.ReplaceDivToolTip(this.itemCssClassName(),e,s)}async loadScoreConfig(e,t){if(this.scsList[t].items.length===0){const s=`${e.ch.id}`,n=await this.charDB.getStatus(s);if(n!==null&&n.items!==void 0)return U.renameTitles(n),this.scsList[t]=n,n}else{const s=this.scsList[t];return U.renameTitles(s),s}return null}propSelectedEnabled(e){const t=this.findPropSelectedPos();if(t!==-1){const s=`${this.propItemCssClassName()}-${t+1}`;this.htmlMakerProp.EnableId(s,e)}}propAutoEnabled(e){const t=!e.isEmpty,s=`${this.propItemCssClassName()}-${e.itemID}`;this.htmlMakerProp.EnableId(s,t)}setOptionItem(e,t){const s="ステータス選定";let n=new Array,i="";for(const[r,c]of Ds){const m=`${c.displayText}/${r}`;n.push(m),e.autoScoreType===r&&(i=r)}const o=new ct;o.selectionPair=n,o.selectedItem=i,o.classify=B.cmAutoScore;const l=new Ce;l.makeItems(),l.items[0].typeInfo.setCombo(o),l.items[0].className="";const a=new Es;a.key=B.cmAutoScore,a.text=s,a.value=l,t.push(a)}makeFlyoutGrid(e,t){if(this.scoreGrid!==null)return;this.editingIndex=t,this.savedOpt=new De,De.copy(this.formationOptList[t],this.savedOpt),this.savedScoreSet=new U,U.copy(e,this.savedScoreSet,!0);const s=es(),n=new Array;this.setOptionItem(this.formationOptList[t],n);for(const f of e.items){const d=new ct;d.selectionPair=f.selectionPair,d.selectedItem=f.selectedVal,d.classify=f.key;const g=new Ce;g.makeItems(),g.items[0].typeInfo.setCombo(d),g.items[0].className="";const p=new Es;p.key=f.key,p.text=s.convTitle(f.title),p.value=g,n.push(p)}const i=t+1,o=new hn;if(o.setGridtems(n),o.setListener(`${this.gridName}-${i}`,`${this.propItemCssClassName()}-${i}`,this.dlgContentCssClassName(),`${this.gridHeaderName}-${i}`,`${this.gridFooterName}-${i}`),o.setVisible(!0),o.setFontConfig("0.8"),o.setSize("190","200"),o.applyCss(),o.enableEvents(this.onScoreValueSelect),this.scoreGrid=o,this.scoreGrid.footerElem!==null){let f=`
<button id="${this.gridFooterName}-okBtn">OK</button>
<button id="${this.gridFooterName}-canBtn">CANCEL</button>
...
`.trim(),document.head.appendChild(r);const c=document.getElementById(this.parentName);this.htmlMakerChSel.copyCssToInlineStyle(`.${this.parentName}`,c)}}class Wt{constructor(){this.cancel=!1}}class Fn{constructor(){this.uiName="",this.cancel=!1}}class dt{constructor(){this.ch=new ye,this.prop=new oe,this.isEmpty=!0,this.TextMap=""}static toJsonText(e){const t=ye.toJsonInst(e.ch);return JSON.stringify(t,null,2)}static toJsonInst(e){const t=new dt;t.ch=ye.toJsonInst(e.ch),oe.copy(e.prop,t.prop),t.isEmpty=e.isEmpty;const s=Object.fromEntries(e.details.TextMap);return t.TextMap=JSON.stringify(s,null,2),t}static fromJsonInst(e){const t=new Js;t.ch=ye.fromJsonInst(e.ch),oe.copy(e.prop,t.prop),t.isEmpty=e.isEmpty;const s=new Map(Object.entries(JSON.parse(e.TextMap)));return t.details.TextMap=s,t}}class ve{static toJsonText(e,t,s){const n=ve.toJsonInst(e,t,s);return JSON.stringify(n,null,2)}static toJsonInst(e,t,s){const n=new ve;n.items=new Array,n.scsList=new Array,n.formationOptList=new Array;for(const i of e.items)n.items.push(dt.toJsonInst(i));for(const i of t)n.scsList.push(i);if(s===void 0)console.log(`[FormationSetJson::toJsonInst] optList === undefined (${e.uiInfo.name})`);else for(const i of s)n.formationOptList.push(i);return n}static fromJsonInst(e){const t=new ts;t.items=new Array;for(const s of e.items)t.items.push(dt.fromJsonInst(s));return t}}class xt{constructor(){this.chName="",this.autoScoreType=we.None}static copy(e,t){t.chName=e.chName,t.autoScoreType=e.autoScoreType}}class ss{constructor(e,t,s=!0,n){this.isEmpty=!0,this.allAvailable=!1;const i=new Te;i.ns=e.ns,i.id=e.id,i.name=e.name,this.ch=i;const o=new xt;xt.copy(t,o),this.prop=o,this.isEmpty=s,this.scoreSet=n}get score(){let e=0;if(this.prop.autoScoreType===we.None)e=Math.ceil(this.scoreSet.stdScore);else{const t=Ds.get(this.prop.autoScoreType),s=t===void 0?1:t.ratio;e=Math.ceil(this.scoreSet.maxScore*s)}return e}static copy(e,t){t.ch.ns=e.ch.ns,t.ch.id=e.ch.id,t.ch.name=e.ch.name,xt.copy(e.prop,t.prop),t.isEmpty=e.isEmpty,t.scoreSet=new U,U.copy(e.scoreSet,t.scoreSet,!0)}}class hs{Add(e){if(e===void 0){console.log("[VersusGroupRow::Add] scItem === undefined");return}this.columns===void 0&&(this.columns=[]),this.columns.push(e)}Count(){return this.columns.length}debug(){if(this.columns===void 0){console.log("[VersusGroupRow::debug] this.columns === undefined");return}console.log("**VersusGroupRow**",this.columns)}}hs.defNumColumn=5;class us{Add(e){this.groupRows===void 0&&(this.groupRows=[]),this.groupRows.push(e)}Count(){return this.groupRows.length}debug(){if(this.groupRows===void 0)console.log("this.groupRows === undefined");else for(const e of this.groupRows)e.debug()}async loadJson(e){const n=(await new pt().loadJson(e)).groupRows.map(o=>Object.assign(new hs,o)),i=new us;return i.groupRows=n,i}}const Be={None:"None",Player:"Player",Enemy:"Enemy"},Ne={None:"None",Attr:"Attr",Role:"Role"},Rt={HiLv:"HiLv"},me={Likely:"Likely",Uncertain:"Uncertain",Wishful:"Wishful"};class Ft{}Ft.Likely=.9;Ft.Uncertain=.64;class ns{constructor(){this.scoreItems=[],this.formationType=Be.None,this.boost=0}get imgPrefix(){return this.formationType===Be.Player?"ftPlayer":"ftEnemy"}get judgeWidth(){return 48}setScoreItems(e){if(e!==void 0){this.scoreItems=new Array;for(const t of e){const s=new ss(t.ch,t.prop,t.isEmpty,t.scoreSet);this.scoreItems.push(s)}}}async toCharHTML(e,t){const s=t.isEmpty?e.demoMaterial:t.ch.iconFileName,n=t.ch.ns===K.None?"":t.ch.ns,i=await e.getImageUrlBy(s,n);let o=this.scoreToolTip(t);return o!==""&&(o=`title="${o}"`),`
<img class=${this.charCssClassName()}
  src="${i}"
  ${o}>
`.trim()}scoreToolTip(e){return e.isEmpty?"":`${e.prop.chName}
score=${e.score}`}async toJudgeHTML(e,t){const s=this.toJudgeFileURL(e,t);return`<img class=${this.judgeCssClassName()} src="${s}" width="48">`}async toJudgeFileURL(e,t){let s=null;switch(t){case me.Likely:s=await e.getImageUrlBy("win.png",e.AnyNs);break;case me.Uncertain:s=await e.getImageUrlBy("even.png",e.AnyNs);break;case me.Wishful:s=await e.getImageUrlBy("lost.png",e.AnyNs);break;default:return""}return s}charCssClassName(){return"combat-char"}judgeCssClassName(){return"combat-judge"}get combatScore(){if(this.scoreItems===void 0)return 0;const e=this.scoreItems.reduce((s,n)=>n.isEmpty?s:s+n.score,0),t=this.boost===0?1:this.boost;return Math.ceil(e*t/100)}get checkNsCombo(){if(this.scoreItems===void 0){console.log(`[checkNsCombo] scoreItems undefined (${this.formationType})`);return}const e=Array();for(const i of this.scoreItems){if(i.isEmpty||i.ch.ns===K.None)continue;const o=new ss(i.ch,i.prop,i.isEmpty,i.scoreSet);e.push(o)}if(e.length==0){console.log(`[checkNsCombo] no scoreItems (${this.formationType})`);return}let t=K.None,s=0;const n=new Map;for(const i of e){if(t===K.None){t=i.ch.ns,s=1;continue}if(t!==i.ch.ns){t=i.ch.ns,s=1;continue}s++,s>=2&&(n.has(t),n.set(t,s))}return n}calcNsScore(e){const t=this.checkNsCombo;if(t===void 0)return 0;let s=0;for(const[n,i]of t){if(!e.has(i))continue;const o=e.get(i);o!==void 0&&(s+=o)}return s}calcGmScore(e){let t=0;for(const[s,n]of this.gmComboKeywords)e.has(n)&&(t+=e.get(n));return t}}class Pn{constructor(){this.hasCombo=!1,this.winRate=new Map}setPlayer(e){e.formationType=Be.Player,this.player=e}setEnemy(e){e.formationType=Be.Enemy,this.enemy=e}judge(e){const s=this.winRate.get(e);return s>=Ft.Likely?me.Likely:s>=Ft.Uncertain?me.Uncertain:me.Wishful}judgeForEnemy(e){switch(e){case me.Likely:return me.Wishful;case me.Uncertain:return me.Uncertain;case me.Wishful:return me.Likely}}}class On{constructor(){this.uiInfo=new Ue,this.combatPairs=new Map,this.gameConfig=void 0,this.option=void 0,this.guide=void 0,this.parentName="",this.tableName="",this.moverOnMoveDone=async e=>{console.log(`[${e.className}] moved`),new H().SaveSetting(e),this.requestActivate!==void 0&&await this.requestActivate(e)},this.onOption=async(e,t)=>{if(console.log("**onOption**"),this.option!==void 0){this.option.SetVisible(!this.option.GetVisible());return}},this.onGuide=async(e,t,s)=>{if(this.guide!==void 0){this.guide.setVisible(!this.guide.getVisible());return}const n=this.parentName,i=new Map,o=new Ss;o.value.makeItems(1),o.value.items[0].typeInfo.setLabel("NS : 0",!1),o.value.items[0].className=`${n}-guide-ns`,i.set("ns",o);const l=new Ss;l.value.makeItems(1),l.value.items[0].typeInfo.setLabel("GM : 0",!1),l.value.items[0].className=`${n}-guide-gm`,i.set("gm",l);const a=this.htmlMaker.GetRect(e.parentElement),r=this.htmlMaker.GetRect(s),c=new dn;c.setGuidetems(i),c.setListener(`${n}-guide`,n,`${n}-guide`),c.setFontConfig("0.7"),c.applyCss(),c.enableOverlay(!1),c.show(`${parseInt(r.left)-parseInt(a.left)+34}`,"0"),this.guide=c,this.updateGuide()}}setPair(e,t){this.combatPairs.set(e,t)}calcCombatScore(){for(const[e,t]of this.combatPairs){if(t.player===void 0||t.enemy===void 0)continue;const s=[Ne.None,Ne.Attr,Ne.Role];for(const n of s){let i=t.player.combatScore,o=t.enemy.combatScore;if(console.log("**normal score**",i,o),this.gameConfig!==void 0){console.log("** NS combo checking ... **");const l=t.player.checkNsCombo,a=t.enemy.checkNsCombo,r=this.gameConfig.nsComboScoreList,c=this.gameConfig.gameComboScoreList;if(r.size===0&&console.log("** NS score disable or empty **"),c.size===0&&console.log("** GM score disable or empty **"),l!==void 0){let m=t.player.calcNsScore(r);console.log(`** player nsScoreAdd : ${m} **`),i+=m}if(a!==void 0){let m=t.enemy.calcNsScore(r);console.log(`** enemy nsScoreAdd : ${m} **`),o+=m}if(this.gameConfig.gameComboAvail>=1){let m=t.player.calcGmScore(c),f=t.enemy.calcGmScore(c);console.log(`** player gmScore : ${m} **`),console.log(`** enemy  gmScore : ${f} **`),i+=m,o+=f}}else console.log("** NS combo skipped **");console.log("**result score**",i,o),t.winRate.set(n,o!==0?i/o:1)}}}async replaceChar(e,t,s,n,i){const o=this.combatPairs.get(e);let l;if(t===Be.Player?l=o?.player:t===Be.Enemy&&(l=o?.enemy),l===void 0)return!1;const a=s.itemID;if(a<0)return!1;const r=a-1;l=l;const m=`${l.imgPrefix}${a}`,f=l.scoreItems[r],d=f.ch;let g="";s.isEmpty?(d.id=0,d.name="",g=i.demoMaterial,console.log("[replaceChar] set empty")):(d.id=n.id,d.name=n.name,g=d.iconFileName,console.log(`[replaceChar] set char ${n.id}:${n.name}`)),f.isEmpty=s.isEmpty;const p=d.ns===K.None?"":d.ns,u=await i.getImageUrlBy(g,p);if(u===null)return!1;const C=new D,$=this.outerCssClassName();return C.ReplaceImg($,m,u),!0}async replaceJudge(e){async function t(i,o){const l=await i.toJudgeFileURL(e,o);if(l===null)return;const a=i.imgPrefix;for(let r=0;r<i.scoreItems.length;r++){const c=`${a}${r+1}`,m=s.FindImgsByID(n,c);if(m===null||m.length<=1){console.error("fail on judge marker");continue}const f=m[1];s.SetImgSrc(f,l),i.scoreItems[r].isEmpty?s.SetImgSize(f,0,0):s.SetImgSize(f,i.judgeWidth,i.judgeWidth);const d=i.scoreItems[r];s.ReplaceImgToolTip(n,c,i.scoreToolTip(d))}}const s=new D,n=this.outerCssClassName();for(const[i,o]of this.combatPairs){if(o.player===void 0||o.enemy===void 0)continue;const l=[Ne.None,Ne.Attr,Ne.Role];for(const a of l){if(a!==Ne.None)continue;const r=o.judge(a),c=o.judgeForEnemy(r);await t(o.player,r),await t(o.enemy,c)}}}async updateGuide(){if(this.guide===void 0||this.gameConfig===void 0||this.combatPairs.has(Rt.HiLv)===!1)return;const e=this.combatPairs.get(Rt.HiLv);if(e===void 0)return;const t=e.player.checkNsCombo,s=e.enemy.checkNsCombo,n=this.gameConfig.nsComboScoreList,i=this.gameConfig.gameComboScoreList;let o=0;t!==void 0&&(o=e.player.calcNsScore(n));let l=0;s!==void 0&&(l=e.enemy.calcNsScore(n));let a=0,r=0;this.gameConfig.gameComboAvail>=1&&(a=e.player.calcGmScore(i),r=e.enemy.calcGmScore(i)),this.guide.setTextByKey("ns",`NSコンボ：P=${o} vs E=${l}`),this.guide.setTextByKey("gm",`GMコンボ：P=${a} vs E=${r}`)}async toHTML(e,t){this.tableName=e;const s=document.createElement("table");s.className=e,s.id=e;const n=document.createElement("tbody");s?.appendChild(n);async function i(l,a){const r=document.createElement("tr");n?.appendChild(r);const c=await a.toJudgeHTML(t,l),m=a.imgPrefix;let f=0;for(const d of a.scoreItems){f++;const g=await a.toCharHTML(t,d),p=`
<div class=${o} item-id="${m}${f}">
  ${g}
  ${c}
</div>
`.trim(),u=document.createElement("td");u.innerHTML=p,r.appendChild(u)}}const o=this.outerCssClassName();for(const[l,a]of this.combatPairs){const r=a.judge(Ne.None),c=a.judgeForEnemy(r);await i(r,a.player),await i(c,a.enemy)}return s.outerHTML}createCombatBox(e,t,s){this.parentName=t,this.htmlMaker=new D;const n=`<div class="${this.parentName}-dlg-content">
    ${s}
</div>`,i=new de;i.title="<"+e+">";const o=i.NewDialog(t,this.dlgCssClassName());return i.SetOType(st.Option,this.onOption),i.SetGuide(nt.Guide,this.onGuide),i.SetContent(t,n),this.applyCss(),i.EnableEventHandlers(),i.onMoveDone=this.moverOnMoveDone,o}enableLazyImages(e){this.htmlMaker.initObserver(this.dlgCssClassName(),e)}outerCssClassName(){return"combat-outer"}dlgCssClassName(){return`${this.parentName}-dlg`}applyCss(){const e=new ns,t=`.${this.outerCssClassName()}`,s=`.${e.charCssClassName()}`,n=`.${e.judgeCssClassName()}`,i=parseInt(this.uiInfo.left),o=parseInt(this.uiInfo.top),l=document.createElement("style");l.textContent=`
...
`.trim(),document.head.appendChild(l);const a=document.getElementById(this.parentName);this.htmlMaker.copyCssToInlineStyle(`.${this.parentName}`,a)}}const _e={Unknown:"Unknown",Success:"Success",Fail:"Fail",Cancel:"Cancel"};async function Hs(h){const e=h.isWebRunning,t=h.currentUserHome,s=h.chStatusListFile,n=h.chListFile,i=new vn,o=new D,l="splash-screen";o.initFullScreen(l,"エボナ データベース初期化中..."),o.applyFullScreenCss(l);const a=o.getFullScreenMsgElem(l),r=a!==null?a.innerHTML:"",m=await new ms().LoadList(n);let f;if(t===h.user1Home){f=[{ns:K.CnsRed,nsName:"赤属性"},{ns:K.CnsBlue,nsName:"青属性"},{ns:K.CnsGreen,nsName:"緑属性"},{ns:K.CnsYellow,nsName:"黄属性"},{ns:K.CnsViolet,nsName:"紫属性"}];for(const I of f)a!==null&&(a.innerHTML=`${r} ${I.nsName}`),await i.setupNs(I.ns,h,m)}if(t===h.user2Home){f=[{ns:K.CnsBlue,nsName:"藍属性"},{ns:K.CnsRed,nsName:"紅属性"},{ns:K.CnsGreen,nsName:"翠属性"},{ns:K.CnsYellow,nsName:"黄属性"},{ns:K.CnsWhite,nsName:"天属性"},{ns:K.CnsBlack,nsName:"冥属性"}];for(const I of f)a!==null&&(a.innerHTML=`${r} ${I.nsName}`),await i.setupNs(I.ns,h,m)}let d;d=await h.loadGameConfig(h.gameType),console.log(d),h.onGameConfigChanged=async I=>{I.receivedBool===!0&&(console.log("onGameConfigChanged"),console.log(I.receivedBool),d=await h.loadGameConfig(h.gameType),console.log(d),await Gt())},h.startBcHelper(),a!==null&&(a.innerHTML="UI 初期化中 ...");const g=new Ut,p=new Ot;await p.loadDB(s),p.charSpecSet=m,await p.loadAuxScoreSet(h.gameType);async function u(){const I=new Ln;I.chSet=m,I.uiInfo.name="charListArea",I.uiInfo.left="300",I.uiInfo.top="100";const x=I.uiInfo.name,M=await I.toHTML(i);if(e){const k="キャラ選択",E=I.createSelectorBox(k,x,M);I.addEventHandlers(E),I.addItemEventHandlers(),I.enableLazyImages(i),E.show();const R=new he;R.setAsDlg(E,k),g.add(R)}return I}const C=await u();async function $(){const I=new zs;await I.load(),I.uiInfo.name="CharSummary",I.uiInfo.left="400",I.uiInfo.top="100";const x=I.uiInfo.name,M=await I.toHTML();if(e){const k="キャラ一覧",E=I.createSummaryBox(k,x,M);I.addEventHandlers(E,async G=>{G.selectCh=C.selectedCh;const X=await i.getImageUrlBy(C.selectedCh.iconFileName,C.selectedCh.ns);if(X===null)G.selectedImg="",G.cancel=!0;else{G.selectedImg=X,G.cancel=!1;const j=await p.getStatus(C.selectedCh.idAsText);G.scoreSet=j}console.log(`selected ch = ${G.selectCh.name}`)}),await I.createCharSummaryNodes(i,f),I.enableLazyImages(i),E.show();const R=new he;R.setAsDlg(E,k),g.add(R)}return I}const S=await $();async function v(I,x,M,k){const E=new Rn;I===y&&(E.InitForPlayer(S),E.autoForm=!0,E.editFormEnable=!1,E.saveEnable=!1,E.imgLoader=i),I===T&&(E.InitForEnemy(p),E.autoForm=!1,E.editFormEnable=!0,E.saveEnable=!0),E.formation.uiInfo.name=I,E.formation.uiInfo.left=`${x}`,E.formation.uiInfo.top=`${M}`;const R=E.formation.uiInfo.name,G=await E.toHTML(R),X=I===T?E.toGridHTML():"";if(e){const j=E.createFormationBox(k,R,G,X);E.addEventHandlers(j),E.addItemEventkHandlers(async V=>{let le="",Vt="";V.selectedImg===""?(le=C.selectedCh.iconFileName,Vt=C.selectedCh.ns,V.selectCh=C.selectedCh):(le=V.item.ch.iconFileName,Vt=V.item.ch.ns,V.selectCh=V.item.ch);const Is=await i.getImageUrlBy(le,Vt);Is!==null&&(V.selectedImg=Is,V.item.isEmpty=!1,Ts(V.uiName,V.item,V.selectCh))},async V=>{const le=await i.getImageUrlBy(V.selectedImg,C.selectedCh.ns);le!==null&&(V.selectedImg=le,V.item.isEmpty=!0,Ts(V.uiName,V.item,V.selectCh))},async V=>{console.log(`selected ch = ${V.item.ch.name}`)},async V=>{await Gt()}),E.enableLazyImages(i),j.show();const fe=new he;fe.setAsDlg(j,k),g.add(fe)}return E}const y="playerForm",T="enemyForm",b="自編成",N="敵編成",w=await v(y,100,100,b),_=await v(T,100,200,N),ne="combatForm",Z="対戦予想";let W;async function ke(I,x,M,k){F.uiInfo.name=I,F.uiInfo.left=`${x}`,F.uiInfo.top=`${M}`;const E=await F.toHTML("combatTable",i),R=F.createCombatBox(k,I,E);F.enableLazyImages(i),await F.replaceJudge(i),R.show(),W=R;const G=new he;G.setAsDlg(R,k),g.add(G)}const F=new On;await ws(),await ke(ne,120,300,Z);const ee="保存";new he().setAsMenu(ee);const Ge="復帰";new he().setAsMenu(Ge);const yt="設定";{const I=new he;I.setAsMenu(yt),g.add(I)}let He=null;const Ks=await g.toHTML("dockForm",i);if(e){const I=g.createDockBox("dockForm",Ks);g.addItemClickHandlers(async x=>{if(g.stdApplyAction(x)!==!1&&x.item.isMenuType&&(x.item.toolTip===ee&&await Ws(),x.item.toolTip===Ge&&await js(async k=>{if(console.log(`[loadedResult] ${k}`),k!==_e.Success)return;const E=ve.fromJsonInst(Ct),R=ve.fromJsonInst(bt);Ct=null,bt=null,await w.Setup(E,i),await _.Setup(R,i)}),x.item.toolTip===yt)){const k=h.editorURL;window.open(k,k)}}),g.enableLazyImages(i),I.show(),He=I}const ds="playerForm.json",fs="enemyForm.json",ps="dockForm.json";async function Ws(){g.InitZOrder(Ae);const I=ve.toJsonText(w.formation,w.scsList,w.formationOptList),x=ve.toJsonText(_.formation,_.scsList,_.formationOptList),M=Dt.toJsonText(g),k=new window.JSZip;k.file(ds,I),k.file(fs,x),k.file(ps,M);const E=await k.generateAsync({type:"blob"}),R="gameConfig.zip",G=URL.createObjectURL(E),X=document.createElement("a");X.href=G,X.download=R,X.click(),URL.revokeObjectURL(G),console.log("saved!")}let gs=null,Ct=null,bt=null;async function js(I){const x=document.createElement("input");return x.type="file",x.accept=".zip",x.addEventListener("cancel",()=>(console.log("Cancelled."),_e.Cancel)),x.addEventListener("change",async()=>{if(x.files.length==1){console.log("File selected: ",x.files[0].name);const k=await x.files[0].arrayBuffer(),R=await new window.JSZip().loadAsync(k);async function G(j){const fe=R.file(j);if(fe){const V=await fe.async("string"),le=JSON.parse(V);return console.log(le),le}}{const j=await G(ps);j&&(gs=j)}{const j=await G(ds);j&&(Ct=j)}{const j=await G(fs);j&&(bt=j)}const X=gs!==null&&Ct!==null&&bt!==null?_e.Success:_e.Fail;I(X)}}),x.click(),_e.Unknown}const Ae=new H;if(e&&(Ae.AddDialogs(),Ae.AssignIndexies(),await Ae.LoadAllSetting(),await Ae.loadSetting(He),g.InitZOrder(Ae),await Ae.ForEachAsync(I=>{const x=de.FindDialogParent(I);return x!==null&&(h.isLocal||I==="charListArea"?x.hidden=!1:x.hidden=h.evonaType!==pe.Full),!0}),He!==null&&(He.parentElement.hidden=h.evonaType!==pe.Full)),await S.showCharSummaryNodes(),e){const I="ツールチップ一覧",x=q.toHTML(),M=q.createMgrBox(I,x);q.uiInfo.left="400",q.uiInfo.top="100",q.applyCss(),M.show(),q.enableEvents();const k=new he;k.setAsDlg(M,I),g.add(k)}w.requestToolTip=ys,_.requestToolTip=ys;async function ys(I){console.log(`[${I.uiName}] requestToolTip`);const x=q.MakeUniqueName(I.uiName,I.itemName),M=q.FindBy(x);switch(I.reqType){case mt.Add:if(M===null){q.Add(x);const k=q.FindBy(x);if(k!==null){let E="*unknown*";switch(I.uiName){case y:E=b;break;case T:E=N;break}k.name=x,k.SetTitle(E),k.SetMemoText(I.content),k.applyCss(),k.Show(I.parentClassName),k.SetVisible(!0),k.EnableEvents();const R=q.AddRow();q.SetTitle(R,E,I.title)}}break;case mt.Remove:M!==null&&q.Remove(x);break}}async function Ys(){const I=new an,x=new Array;for(const[G,X]of ks)x.push(`${[X.displayText]}/${G}`);I.selectionPair=x,I.selectedItem=qe.B100,I.classify="optionUI-opt-boost";const M=2,k=new Y;k.makeDim(M,1);let E=0,R=0;return k.getCell(R,E).typeInfo.setLabel("ブースト率",!1),k.getCell(R,E).className=Qs(),k.getCell(R,E).typeInfo.using.itemId=E+k.firstRowIndex,R++,k.getCell(R,E).typeInfo.setRadio(I),k.getCell(R,E).className=Nt(),k.getCell(R,E).typeInfo.using.itemId=E+k.firstRowIndex,k.makeRowTemplate(Xs()),k}function Xs(){return`${ne}-optionUI-row`}function Qs(){return`${ne}-optionUI-title`}function Nt(){return`${ne}-optionUI-opt`}function _s(){return`
...
`.trim()}const Zs=async function(I,x){console.log("onChangedTableSelection::radio",I,x);const M=ks.get(I);if(M!==void 0){for(const[k,E]of F.combatPairs)E.enemy.boost=M.ratio;await Gt()}};async function en(){const I=q.MakeUniqueName(ne,"optionUI");if(q.FindBy(I)!==null)return;q.Add(I);const M=q.FindBy(I);if(M!==null){const k=Z,E=await Ys();M.name=I,M.VisibleMgrBtn(!1),M.SetTitle(k+"：オプション"),M.SetTable(E,_s()),M.onChangedTableSelection=Zs,M.closeType=Xt.InVisible,M.applyCss(),M.Show(W.className),M.SetVisible(!0),M.EnableEvents()}return M}const Cs=await en();Cs!==null&&(F.option=Cs),o.hideFullScreenCss(l),C.requestActivate=Ve,S.requestActivate=Ve,w.requestActivate=Ve,_.requestActivate=Ve,F.requestActivate=Ve,q.requestActivate=Ve;async function Ve(I){console.log(`[${I.className}] requestActivate`),g.activateItem(I)}function bs(I){const x=new us,M=new hs,k=I.formation;k.uiInfo.name,k.uiInfo.name,I.scsList===void 0&&console.log(`[${I.formation.uiInfo.name}] 対戦予想結果の作成は工事中です`);let E=0;for(const R of k.items){if(I.scsList===void 0)continue;let G=!0;(I.formationOptList===void 0||I.formationOptList!==void 0&&I.formationOptList.length<1)&&(G=!1,k.uiInfo.name===T&&console.log(`[${I.formation.uiInfo.name}] 敵編成の「スコアの自動選定」は工事中です`));const X=I.scsList[E];if(X.ns===K.None){const le=R.ch.ns;X.ns=le,console.log(`[toScoreRes] set ns (${I.formation.uiInfo.name}::${R.ch.name}) : None -> ${le}`)}let j=we.None;G&&(j=I.formationOptList[E].autoScoreType),E++;const fe=new xt;fe.chName=R.prop.comment,fe.autoScoreType=j;const V=new ss(R.ch,fe,R.isEmpty,X);V.allAvailable=X.allAvailable,M.Add(V)}return x.Add(M),x}function Ns(I){const x=new Array,M=I.formation;for(const k of M.items)k.isEmpty!==!0&&k.ch.ns!==K.None&&x.push(`${k.ch.id}`);return x}async function ws(){F.gameConfig=d;const I=bs(w),x=bs(_),M=Ns(w),k=Ns(_),E=await p.getComboKeywords(M),R=await p.getComboKeywords(k),G=new ns;G.setScoreItems(I.groupRows[0].columns),G.gmComboKeywords=E,G.boost=100;const X=new ns;X.setScoreItems(x.groupRows[0].columns),X.gmComboKeywords=R,X.boost=100;const j=new Pn;j.setPlayer(G),j.setEnemy(X),F.setPair(Rt.HiLv,j),F.calcCombatScore();for(const[fe,V]of F.combatPairs){const le=V.judge(Ne.None);console.log(`judge=[${le}]`)}}async function Ts(I,x,M){const k=Rt.HiLv;F.combatPairs.get(k),I===y&&await F.replaceChar(k,Be.Player,x,M,i),I===T&&await F.replaceChar(k,Be.Enemy,x,M,i)}async function Gt(){await ws(),await F.replaceJudge(i),await F.updateGuide()}}async function Un(h){if(!h.isWebRunning)return;const e=h.isWebRunning;console.log(`mode=${h.edit}`);const t=new Ut;async function s(){const p=ce.Resource,u=new qt;u.init(),u.setConfig(Nn()),await u.load(p,Q.none),u.uiInfo.name="ResourceEdit",u.uiInfo.left="110",u.uiInfo.top="10";const C=u.uiInfo.name,$=await u.toHTML(Tn());if(e){const S=document.createElement("div");S.id=u.uiInfo.name,S.className=u.uiInfo.name,document.body.appendChild(S);const v="文字列リソース",y=u.createEditorBox(v,C,$);u.addEventHandlers(y),u.addItemEventHandlers(),y.show(),u.enableResize();const T=new he;T.setAsDlg(y,v),t.add(T)}return u}async function n(){const p=ce.GameUI,u=new qt;u.initNumItems=5,u.canAdd=!1,u.init(),u.setConfig(Gs()),await u.load(p,Q.none),u.uiInfo.name="GameEdit",u.uiInfo.left="110",u.uiInfo.top="10",u.uiInfo.height="235";const C=u.uiInfo.name,$=await u.toHTML(kn());if(e){const S=document.createElement("div");S.id=u.uiInfo.name,S.className=u.uiInfo.name,document.body.appendChild(S);const v="ゲーム設定",y=u.createEditorBox(v,C,$);u.addEventHandlers(y),u.addItemEventHandlers(),y.show(),u.enableResize();const T=new he;T.setAsDlg(y,v),t.add(T)}return u}async function i(){const p=ce.ScoreUI,u=new qt;u.init(),u.setConfig(wn(h.gameType)),await u.load(p,h.edit),u.uiInfo.name="ScoreEdit",u.uiInfo.left="110",u.uiInfo.top="100";const C=u.uiInfo.name,$=await u.toHTML(In());if(e){const S=document.createElement("div");S.id=u.uiInfo.name,S.className=u.uiInfo.name,document.body.appendChild(S);const v="スコア設定",y=u.createEditorBox(v,C,$);u.addEventHandlers(y),u.addItemEventHandlers(),y.show(),u.enableResize();const T=new he;T.setAsDlg(y,v),t.add(T)}return u}const o=await s();o.startAutoSave();const l=await n();l.startAutoSave(),l.onSaved=async p=>{h.startBcHelper(),h.notifyGameConfigChanged()};const a=await i();a.startAutoSave();const r=document.createElement("div"),c="dockEdit";r.id=c,r.className=c,document.body.appendChild(r);let m=null;const f=await t.toHTML(c,null);if(e){const p=t.createDockBox(c,f);t.addItemClickHandlers(async u=>{t.stdApplyAction(u)}),p.show(),m=p}const d=new H;e&&(d.AddDialogs(),d.AssignIndexies(),await d.LoadAllSetting(),await d.loadSetting(m),t.InitZOrder(d),await d.ForEachAsync(p=>{const u=de.FindDialogParent(p);return u!==null&&(p!=="ResourceEdit"?u.hidden=!1:u.hidden=!0),!0}),m!==null&&(m.parentElement.hidden=!1)),o.requestActivate=g,l.requestActivate=g,a.requestActivate=g;async function g(p){console.log(`[${p.className}] requestActivate`),t.activateItem(p)}}const J=new pt,qs=J.isWebRunning;qs?(Vn(),J.parseURLParams(),J.currentUserHome===""&&J.setUser(J.user1Home)):J.setUser(J.user2Home);let gt=window.EVONA_CONFIG.isLocal;J.aslocal!==lt.Undef&&(gt=J.aslocal===lt.True);J.setPath();J.appHref=window.location.href;ie.encodeEnable=!gt;J.setImageHome(gt);const Gn=zn(gt)||J.availComing;J.currentUserHome;J.statusJsonPath;J.zipPrefix;J.chListFile;J.chStatusListFile;switch(J.admin){case!0:await Sn(J);break;case!1:if(qs)if(J.edit===Q.none){let h=!1,e=!1;const t=new be;t.CheckVisible=!0,t.CheckText="位置情報を初期化",t.SecretEnable=!0;const s=J.setBrowserTitle();await t.showWait(`「${s} 」モードで起動します`)===A.Secret&&(e=!0),h=t.Checked;let i=pe.None;if(gt)i=pe.Full;else if(i=pe.NotRun,e){let o="";t.CheckVisible=!1,t.SecretEnable=!1,t.AuthVisible=!0,t.onAuthChecking=f=>(o=f,!0),await t.showWait("認証コードを入力してください");const l=new Date,a=("0"+(l.getMonth()+1)).slice(-2),r=("0"+l.getDate()).slice(-2),m=Math.random()>.5?`${a}${r}`:`${r}${a}`;o===m?(console.log("auth success"),i=pe.Full):console.log("auth fail")}else Gn&&(i=pe.Limit);switch(h&&(await(await sn()).clear(),await(await Le()).clear()),J.evonaType=i,i){case pe.Full:window.EVONA_CONFIG.demo=!1,await Hs(J);break;case pe.Limit:window.EVONA_CONFIG.demo=!0,await Hs(J);break}}else J.setBrowserTitle(),await Un(J);break}function Vn(){const h=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.hostname.startsWith("192.168."),e=h?"./jszip_dist/jszip.min.js":"https://cdn.jsdelivr.net/npm/jszip@3.10.1/dist/jszip.min.js",t=h?"./jsstore_dist/jsstore.min.js":"https://cdn.jsdelivr.net/npm/jsstore/dist/jsstore.min.js";window.EVONA_CONFIG={isLocal:h,workerFile:"./jsstore_dist/jsstore.worker.min.js",demo:!h};function s(n,i=!1){const o=document.createElement("script");o.src=n,i&&(o.type="module"),o.async=!1,document.head.appendChild(o)}s(e),s(t)}function zn(h){if(h)return!0;const e=document.referrer;console.log(`${e}`);const t="evona_auth",s="granted";return sessionStorage.getItem(t)===s?!0:e.includes("qiita.com")?(sessionStorage.setItem(t,s),!0):!1}
